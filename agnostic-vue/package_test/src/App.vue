...
<template>
  ...
  <div class="container">
    ...
    <section>
      ...
      <div class="h4">Customize the first option's text copy</div>
      <div class="mbe16">
        <p className="mbe24">
      ...
      <div class="h4">Disabled select</div>
      <div class="mbs12 mbe16">
        <Select
          is-disabled
      ...
      <div class="h4">Vertical Tabs</div>
      ...
      <div class="h4">Disabled Tabs</div>
      <div class="mbs48 mbe16">
        <Tabs is-disabled>
          <template #tab-13>
            Tab 1
      ...
      <div class="h4">Disabled Options</div>
      <div class="mbs12 mbe16">
      ...
      <div class="mbs12 mbe16">
        ...
        <div class="h4">Switch label on right</div>
        <div>
          <Switch
            id="sw9"
        ...
        <div class="h4">Default Buttons</div>
        <section>
          <Button
            @click="(ev) => log('Button is-bordered - event: ', ev)"
            is-bordered
          >
            Go
          </Button>
          <Button
            is-blank
            @click="(ev) => log('Button is-blank - event: ', ev)"
          >
            Go
          </Button>
          <Button
            @click="(ev) => log('Button is-block - event: ', ev)"
            is-block
          >
            Go
          </Button>
          <Button
            @click="(ev) => log('Button is-rounded - event: ', ev)"
            is-rounded
          >
            Go
          </Button>
        ...
        <div class="mbs40 flex flex-column">
          <ButtonGroup ariaLabel="Appropriate label for your button group">
            <Button
              is-grouped
              @click="(ev) => log('ButtonGroup button 1 - event: ', ev)"
            >One</Button>
            <Button
              is-grouped
              @click="(ev) => log('ButtonGroup button 2 - event: ', ev)"
            >Two</Button> <Button
              is-grouped
              @click="(ev) => log('ButtonGroup button 3 - event: ', ev)"
            >Three</Button>
          </ButtonGroup>
          <div class="mbe24" />
          <ButtonGroup ariaLabel="Appropriate label for your button group">
...
.tooltips-container [aria-describedby^="tip-"] {
  width: 100px;
  height: 100px;
