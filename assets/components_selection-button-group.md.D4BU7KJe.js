var G=Object.defineProperty;var w=(r,t,n)=>t in r?G(r,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[t]=n;var f=(r,t,n)=>w(r,typeof t!="symbol"?t+"":t,n);import{A as P}from"./chunks/AlphaWarning.CKFYAqLS.js";import{a as A,E as V,x as y,i as O,z as u}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{n as T}from"./chunks/state-CovhUvdr.C-u8O0Fo.js";import{c as M}from"./chunks/face-mixin.MgCHLM8W.js";import{d as x,c as B,o as S,r as R,K as _,p as E,j as l,G as i,k as a,w as s,a as o,t as D,_ as I,ag as $}from"./chunks/framework.DmF2n0Fc.js";import{F as H}from"./chunks/FrameworkExample.Byhd3Bwz.js";import"./chunks/createLucideIcon.U6K_rCrv.js";import"./chunks/sdk.m.Dxhqq5iP.js";import"./chunks/Button.BmTmCFep.js";import"./chunks/Icon.CxPOY7rJ.js";var L=Object.defineProperty,b=(r,t,n,h)=>{for(var p=void 0,c=r.length-1,e;c>=0;c--)(e=r[c])&&(p=e(t,n,p)||p);return p&&L(t,n,p),p};const z=class extends M(A){constructor(){super(),this._handleButtonChange=t=>{t.stopPropagation();const{value:n,checked:h}=t.detail;let p;if(this.type==="radio")p=h?[n]:[];else{const e=[...this._getSelectedValues()];if(h)e.includes(n)||e.push(n);else{const v=e.indexOf(n);v>-1&&e.splice(v,1)}p=e}this._internalSelectedValues=p,this._syncFormValue(),this._syncValidity();const c=new CustomEvent("selection-change",{detail:{value:n,checked:h,selectedValues:p},bubbles:!0,composed:!0});this.dispatchEvent(c),this.onSelectionChange&&this.onSelectionChange(c)},this._handleKeyDown=t=>{const n=this._getButtons().filter(e=>!e.disabled);if(n.length===0)return;const h=n.find(e=>{var v;try{return((v=e.shadowRoot)==null?void 0:v.activeElement)||e===document.activeElement}catch{return e===document.activeElement}}),p=h?n.indexOf(h):-1;let c=null;switch(t.key){case"ArrowDown":case"ArrowRight":t.preventDefault(),c=p===-1?0:(p+1)%n.length;break;case"ArrowUp":case"ArrowLeft":t.preventDefault(),c=p===-1?n.length-1:(p-1+n.length)%n.length;break;case"Home":t.preventDefault(),c=0;break;case"End":t.preventDefault(),c=n.length-1;break}if(c!==null){const e=n[c];e.focus(),this.type==="radio"&&this._handleButtonChange(new CustomEvent("selection-button-change",{detail:{value:e.value,checked:!0}}))}},this.type="radio",this.legend="",this.legendHidden=!1,this.theme="",this.size="md",this.shape="",this.value="",this.values=[],this.disabled=!1,this.required=!1,this._internalSelectedValues=[],this.validationMessages=void 0}_getSelectedValues(){return this.type==="radio"?this.value?[this.value]:this._internalSelectedValues:this.values&&this.values.length>0?this.values:this._internalSelectedValues}_syncFormValue(){const t=this._getSelectedValues();if(this.type==="radio")this._internals.setFormValue(t.length>0?t[0]:null);else if(t.length===0)this._internals.setFormValue(null);else{const n=new FormData;t.forEach(h=>n.append(this.name,h)),this._internals.setFormValue(n)}}_syncValidity(){var n;const t=this._getSelectedValues();this.required&&t.length===0?this._internals.setValidity({valueMissing:!0},((n=this.validationMessages)==null?void 0:n.valueMissing)??"Please select an option."):this._internals.setValidity({})}formResetCallback(){this._internalSelectedValues=[],this._internals.setFormValue(null),this._syncValidity(),this._syncChildButtons(),this._syncStates()}formStateRestoreCallback(t,n){t===null?this._internalSelectedValues=[]:t instanceof FormData?this._internalSelectedValues=Array.from(t.getAll(this.name)):typeof t=="string"&&(this._internalSelectedValues=[t]),this._syncFormValue(),this._syncValidity(),this._syncChildButtons(),this._syncStates()}_syncStates(){this._setState("disabled",this.disabled),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}connectedCallback(){super.connectedCallback(),this.addEventListener("selection-button-change",this._handleButtonChange),this.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("selection-button-change",this._handleButtonChange),this.removeEventListener("keydown",this._handleKeyDown)}updated(t){super.updated(t),(t.has("type")||t.has("name")||t.has("theme")||t.has("size")||t.has("shape")||t.has("disabled")||t.has("value")||t.has("values")||t.has("_internalSelectedValues"))&&this._syncChildButtons(),t.has("value")||t.has("values")||t.has("_internalSelectedValues")?(this._syncFormValue(),this._syncValidity()):t.has("required")&&this._syncValidity(),(t.has("disabled")||t.has("required")||t.has("_internalSelectedValues"))&&this._syncStates()}firstUpdated(){this._syncChildButtons(),this._syncFormValue(),this._syncValidity(),this._syncStates()}_getButtons(){var n;const t=(n=this.shadowRoot)==null?void 0:n.querySelector("slot");return t?t.assignedElements({flatten:!0}).filter(h=>h.tagName.toLowerCase()==="ag-selection-button"):[]}_syncChildButtons(){const t=this._getButtons(),n=this._getSelectedValues();t.forEach(h=>{const p=n.includes(h.value);h._type=this.type,h._name=this.name,h._theme=this.theme,h._size=this.size,h._shape=this.shape,h.checked=p,this.disabled&&(h.disabled=!0)})}_handleSlotChange(){this._syncChildButtons()}render(){const t=["selection-button-group__legend",this.legendHidden?"selection-button-group__legend--hidden":""].filter(Boolean).join(" ");return y`
  ...
  `;let k=z;b([u({type:String,reflect:!0})],k.prototype,"type");b([u({type:String})],k.prototype,"legend");b([u({type:Boolean,attribute:"legend-hidden"})],k.prototype,"legendHidden");b([u({type:String,reflect:!0})],k.prototype,"theme");b([u({type:String,reflect:!0})],k.prototype,"size");b([u({type:String,reflect:!0})],k.prototype,"shape");b([u({type:String})],k.prototype,"value");b([u({type:Array})],k.prototype,"values");b([u({type:Boolean,reflect:!0})],k.prototype,"disabled");b([u({type:Boolean,reflect:!0})],k.prototype,"required");b([u({attribute:!1})],k.prototype,"validationMessages");b([u({attribute:!1})],k.prototype,"onSelectionChange");b([T()],k.prototype,"_internalSelectedValues");customElements.get("ag-selection-button-group")||customElements.define("ag-selection-button-group",k);const N=["type","name","legend","legend-hidden","theme","size","shape","value","values",".disabled",".required",".validationMessages"],g=x({__name:"VueSelectionButtonGroup",props:{type:{default:"radio"},name:{default:""},legend:{default:""},legendHidden:{type:Boolean,default:!1},theme:{default:""},size:{default:"md"},shape:{default:""},value:{default:""},values:{default:()=>[]},disabled:{type:Boolean,default:!1},required:{type:Boolean,default:!1},validationMessages:{}},emits:["selection-change","update:value","update:values"],setup(r,{emit:t}){const n=t,h=p=>{const c=p.detail;n("selection-change",c),c.selectedValues.length<=1&&n("update:value",c.selectedValues[0]||""),n("update:values",c.selectedValues)};return(p,c)=>(S(),B("ag-selection-button-group",_({type:r.type,name:r.name,legend:r.legend,"legend-hidden":r.legendHidden,theme:r.theme,size:r.size,shape:r.shape,value:r.value,values:r.values,".disabled":r.disabled,".required":r.required,".validationMessages":r.validationMessages,onSelectionChange:h},p.$attrs),[R(p.$slots,"default")],48,N))}});var W=Object.defineProperty,F=(r,t,n,h)=>{for(var p=void 0,c=r.length-1,e;c>=0;c--)(e=r[c])&&(p=e(t,n,p)||p);return p&&W(t,n,p),p};const q=class extends A{constructor(){super(),this.value="",this.label="",this.checked=!1,this.disabled=!1,this._type="radio",this._name="",this._theme="",this._size="md",this._shape=""}focus(){var t,n;(n=(t=this.shadowRoot)==null?void 0:t.querySelector(".selection-button"))==null||n.focus()}_handleClick(t){if(t.preventDefault(),this.disabled)return;const n=this._type==="radio"?!0:!this.checked;this.dispatchEvent(new CustomEvent("selection-button-change",{detail:{value:this.value,checked:n},bubbles:!0,composed:!0}))}_handleKeyDown(t){this.disabled||(t.key===" "||t.key==="Enter")&&(t.preventDefault(),this._handleClick(t))}_renderIndicator(){return this._type==="checkbox"?y`
    ...
    `}render(){const t=this._theme||"default",n=this._size||"md",h=this._shape||"default",p=["selection-button",`selection-button--${t}`,`selection-button--${n}`,`selection-button--shape-${h}`,this.checked?"selection-button--checked":"",this.disabled?"selection-button--disabled":""].filter(Boolean).join(" ");return y`
      <label
        class="${p}"
