...
`,de=JSON.parse('{"title":"SelectionCardGroup","description":"","frontmatter":{},"headers":[],"relativePath":"components/selection-card-group.md","filePath":"components/selection-card-group.md"}'),Y={name:"components/selection-card-group.md"},re=Object.assign(Y,{setup(d){return(e,a)=>(y(),v("div",null,[a[1]||(a[1]=i("h1",{id:"selectioncardgroup",tabindex:"-1"},[S("SelectionCardGroup "),i("a",{class:"header-anchor",href:"#selectioncardgroup","aria-label":'Permalink to "SelectionCardGroup"'},"​")],-1)),t(z),a[2]||(a[2]=i("p",null,"A card-based selection UI for single (radio) or multiple (checkbox) selection. Ideal for onboarding flows, preferences, pricing tiers, and feature opt-ins.",-1)),a[3]||(a[3]=i("h2",{id:"examples",tabindex:"-1"},[S("Examples "),i("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),t(R,{component:"selection-card-group","vue-code":F(K),"lit-code":F(U),"react-code":F(J)},{vue:s(()=>[t(H)]),lit:s(()=>[...a[0]||(a[0]=[i("selection-card-group-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[4]||(a[4]=q(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
