import{A as f}from"./chunks/AlphaWarning.D199zhtu.js";import{i as C,z as m,a as u,x as F,F as x}from"./chunks/FrameworkExample.DQckTML-.js";import{s as L}from"./chunks/plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as y,c as p,o as h,r as E,K as S,p as A,v as z,P as D,s as w,_ as P,C as _,j as e,G as l,ae as B,a as k,w as g,k as d}from"./chunks/framework.CdHt8f9T.js";var V=Object.defineProperty,b=(i,s,a,r)=>{for(var t=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(t=n(s,a,t)||t);return t&&V(s,a,t),t};const v=class extends u{constructor(){super(...arguments),this.size="default",this.ariaLabel="Loading..."}render(){return F`
      <div
        class="loader"
        part="ag-loader"
        aria-busy="true"
  ...
  `;let c=v;b([m({type:String,reflect:!0})],c.prototype,"size");b([m({type:String,reflect:!0,attribute:"aria-label"})],c.prototype,"ariaLabel");customElements.get("ag-loader")||customElements.define("ag-loader",c);const R=y({name:"VueLoader",props:{size:{type:String,default:"default"},ariaLabel:{type:String,default:"Loading..."}},setup(i){const s=A(null),a=()=>{const r=s.value;r&&(r.size=i.size,r.ariaLabel=i.ariaLabel)};return z(async()=>{await customElements.whenDefined("ag-loader"),await D(),a()}),w(()=>{s.value&&a()}),{agComponent:s}}});function T(i,s,a,r,t,o){return h(),p("ag-loader",S({ref:"agComponent"},i.$attrs),[E(i.$slots,"default")],16)}const q=L(R,[["render",T]]),N=y({name:"LoaderExamples",components:{VueLoader:q}}),$={class:"mbe4"},I={class:"mbe4"},U={class:"flex flex-col items-center",style:{gap:"24px"}},M={class:"mbe4"};function j(i,s,a,r,t,o){const n=_("VueLoader");return h(),p("section",null,[e("div",$,[s[0]||(s[0]=e("h2",null,"Default",-1)),l(n)]),e("div",I,[s[1]||(s[1]=e("h2",null,"Sizes",-1)),e("div",U,[l(n,{size:"small"}),l(n),l(n,{size:"large"})])]),e("div",M,[s[2]||(s[2]=e("h2",null,"CSS Shadow Parts Customization",-1)),s[3]||(s[3]=e("p",{class:"mbs2 mbe3"}," Use CSS Shadow Parts to customize the loader's appearance. ",-1)),l(n,{class:"custom-loader"})])])}const O=P(N,[["render",j]]);class W extends u{createRenderRoot(){return this}render(){return F`
      <section>
        <div class="mbe4">
          <h2>Default</h2>
          <ag-loader></ag-loader>
