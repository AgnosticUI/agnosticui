import{A as v}from"./chunks/AlphaWarning.yC7ZufpQ.js";import{i as f,z as F,a as m,x as u}from"./chunks/Button.CFkPNK98.js";import{d as C,c as d,o,r as A,af as x,ag as B,_ as w,j as a,ae as E,G as k,a as e,w as y,k as r}from"./chunks/framework.NAAYCHZu.js";import{F as D}from"./chunks/FrameworkExample.Cm-JbUj-.js";import"./chunks/createLucideIcon.B61Wqv9x.js";import"./chunks/state-CovhUvdr.DWhhlYib.js";import"./chunks/sdk.m.DhOmSlC9.js";import"./chunks/Icon.DjToxxjJ.js";var R=Object.defineProperty,g=(n,t,s,p)=>{for(var i=void 0,h=n.length-1,c;h>=0;h--)(c=n[h])&&(i=c(t,s,i)||i);return i&&R(t,s,i),i};const b=class extends m{constructor(){super(),this.width=1,this.height=1,this.maxWidth=void 0}get _aspectStyle(){const t=this.width||1,s=this.height||1,p=`${t} / ${s}`,i=[];return i.push(`aspect-ratio: ${p};`),this.maxWidth!==void 0&&this.maxWidth!==null&&(i.push(`max-inline-size: ${this.maxWidth}px;`),i.push("margin-inline-start: auto; margin-inline-end: auto;")),i.join(" ")}render(){return u`
