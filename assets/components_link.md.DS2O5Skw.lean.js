...
`,xi=JSON.parse('{"title":"Link","description":"","frontmatter":{},"headers":[],"relativePath":"components/link.md","filePath":"components/link.md"}'),gi={name:"components/link.md"},Di=Object.assign(gi,{setup(l){return(i,r)=>(v(),b("div",null,[r[1]||(r[1]=e("h1",{id:"link",tabindex:"-1"},[n("Link "),e("a",{class:"header-anchor",href:"#link","aria-label":'Permalink to "Link"'},"​")],-1)),a(f),r[2]||(r[2]=e("p",null,[n("The Link component is a semantic, accessible wrapper around the native HTML "),e("code",null,"<a>"),n(" element that provides consistent styling, variants, and states while preserving native browser accessibility features.")],-1)),r[3]||(r[3]=e("h2",{id:"examples",tabindex:"-1"},[n("Examples "),e("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),a(V,{component:"link","vue-code":g(ui),"lit-code":g(pi),"react-code":g(ci)},{vue:s(()=>[a(di)]),lit:s(()=>[...r[0]||(r[0]=[e("link-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),r[4]||(r[4]=R("",38))]))}});export{xi as __pageData,Di as default};
