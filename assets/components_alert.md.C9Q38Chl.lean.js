...
`,os=JSON.parse('{"title":"Alert","description":"","frontmatter":{},"headers":[],"relativePath":"components/alert.md","filePath":"components/alert.md"}'),H={name:"components/alert.md"},ys=Object.assign(H,{setup(h){return(s,e)=>(r(),g("div",null,[e[1]||(e[1]=l("h1",{id:"alert",tabindex:"-1"},[n("Alert "),l("a",{class:"header-anchor",href:"#alert","aria-label":'Permalink to "Alert"'},"​")],-1)),i(v),e[2]||(e[2]=l("p",null,"Alerts are used to provide timely feedback to the user.",-1)),e[3]||(e[3]=l("h2",{id:"examples",tabindex:"-1"},[n("Examples "),l("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(w,{component:"alert","vue-code":o(_),"lit-code":o(J),"react-code":o(K)},{vue:a(()=>[i(G)]),lit:a(()=>[...e[0]||(e[0]=[l("alert-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),e[4]||(e[4]=q("",31))]))}});export{os as __pageData,ys as default};
