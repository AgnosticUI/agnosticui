...
`,Re=JSON.parse('{"title":"SelectionButtonGroup","description":"","frontmatter":{},"headers":[],"relativePath":"components/selection-button-group.md","filePath":"components/selection-button-group.md"}'),be={name:"components/selection-button-group.md"},_e=Object.assign(be,{setup(r){return(t,n)=>(f(),S("div",null,[n[1]||(n[1]=l("h1",{id:"selectionbuttongroup",tabindex:"-1"},[o("SelectionButtonGroup "),l("a",{class:"header-anchor",href:"#selectionbuttongroup","aria-label":'Permalink to "SelectionButtonGroup"'},"​")],-1)),i(M),n[2]||(n[2]=l("p",null,"A button-styled selection UI for single (radio) or multiple (checkbox) selection. Ideal for compact option toggles, filter controls, and inline selections.",-1)),n[3]||(n[3]=l("h2",{id:"examples",tabindex:"-1"},[o("Examples "),l("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(W,{component:"selection-button-group","vue-code":a(he),"lit-code":a(ge),"react-code":a(ke)},{vue:s(()=>[i(ue)]),lit:s(()=>[...n[0]||(n[0]=[l("selection-button-group-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),n[4]||(n[4]=H(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
