var T=Object.defineProperty;var J=(r,a,e)=>a in r?T(r,a,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[a]=e;var E=(r,a,e)=>J(r,typeof a!="symbol"?a+"":a,e);import{c as D,A as U}from"./chunks/AlphaWarning.D199zhtu.js";import{i as A,z as v,a as O,x as $,F as X}from"./chunks/FrameworkExample.DQckTML-.js";import{t as q}from"./chunks/IconButton.CtiKGjPT.js";import{r as Z}from"./chunks/motion.styles.CHMp5t9P.js";import{d as I,p as Q,c as C,o as w,r as K,K as Y,_ as ss,C as h,j as n,a as o,G as s,w as t,ae as L,k as B}from"./chunks/framework.CdHt8f9T.js";import{B as ns}from"./chunks/VueAlert.vue_vue_type_script_setup_true_lang-BSEoqQWL.D4go-3uQ.js";import{S as is}from"./chunks/settings.CFark3T7.js";import{P as as}from"./chunks/plus.C2eZngoA.js";import{C as ts}from"./chunks/check.BKHGEuV_.js";import{S as es}from"./chunks/star.BnywctwD.js";import{S as ls}from"./chunks/send.DxLhcEKt.js";import{M as os}from"./chunks/message-circle.BQYA-aHJ.js";import{B as rs,S as hs}from"./chunks/square-pen.Cw1F9sY-.js";import{S as ps}from"./chunks/search.KKpJqi6p.js";import{H as ks}from"./chunks/house.RYE15Wpj.js";import{M as ds}from"./chunks/menu.bMxGXwhN.js";import{T as cs}from"./chunks/trash-2.DfHjdvMq.js";import{B as us}from"./chunks/bell.Dt8PnUcq.js";import{D as Fs}from"./chunks/download.fjN6RXXS.js";import{H as gs}from"./chunks/heart.MO_4TLQY.js";import"./chunks/Alert.3j4K7z__.js";import"./chunks/CloseButton.B4KJOgyi.js";/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xs=D("minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]);/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fs=D("thumbs-up",[["path",{d:"M7 10v12",key:"1qc93n"}],["path",{d:"M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z",key:"emmmcr"}]]);var ys=Object.defineProperty,b=(r,a,e,F)=>{for(var k=void 0,g=r.length-1,l;g>=0;g--)(l=r[g])&&(k=l(a,e,k)||k);return k&&ys(a,e,k),k};const S=class extends q{constructor(){super(),this.fxSpeed="md",this.fxEase="ease",this.fxDisabled=!1}firstUpdated(a){var e;(e=super.firstUpdated)==null||e.call(this,a),this._applyFxClasses(),this._applyFxCustomProperties()}updated(a){super.updated(a),(a.has("fx")||a.has("fxDisabled"))&&this._applyFxClasses(),(a.has("fxSpeed")||a.has("fxEase"))&&this._applyFxCustomProperties()}_applyFxClasses(){var e;const a=(e=this.shadowRoot)==null?void 0:e.querySelector("button");a&&(a.classList.forEach(F=>{F.startsWith("ag-fx-")&&a.classList.remove(F)}),this.fx&&a.classList.add(`ag-fx-${this.fx}`),this.fxDisabled&&a.classList.add("ag-fx-disabled"))}_applyFxCustomProperties(){var e;const a=(e=this.shadowRoot)==null?void 0:e.querySelector("button");a instanceof HTMLElement&&(a.style.setProperty("--ag-fx-duration",`var(--ag-fx-duration-${this.fxSpeed})`),a.style.setProperty("--ag-fx-ease",`var(--ag-fx-ease-${this.fxEase})`))}};S.styles=[q.styles,Z,A`
      /* ========================================
...
`,Wn=JSON.parse('{"title":"IconButtonFx","description":"","frontmatter":{},"headers":[],"relativePath":"components/icon-button-fx.md","filePath":"components/icon-button-fx.md"}'),cn={name:"components/icon-button-fx.md"},_n=Object.assign(cn,{setup(r){return(a,e)=>(w(),C("div",null,[e[1]||(e[1]=n("h1",{id:"iconbuttonfx",tabindex:"-1"},[o("IconButtonFx "),n("a",{class:"header-anchor",href:"#iconbuttonfx","aria-label":'Permalink to "IconButtonFx"'},"​")],-1)),s(U),e[2]||(e[2]=n("p",null,"An icon button component with customizable animation effects that trigger on hover, click, or mount. IconButtonFx extends the base IconButton component with a rich set of visual effects to create engaging, interactive UI elements.",-1)),e[3]||(e[3]=n("div",{class:"info custom-block"},[n("p",{class:"custom-block-title"},"Opt-in Component"),n("p",null,"IconButtonFx adds a few hundred lines of CSS for animation effects. It's ideal for marketing sites, landing pages, or when visual polish is a priority.")],-1)),e[4]||(e[4]=n("h2",{id:"examples",tabindex:"-1"},[o("Examples "),n("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),s(X,{component:"icon-button-fx","vue-code":B(pn),"lit-code":B(kn),"react-code":B(dn)},{vue:t(()=>[s(hn)]),lit:t(()=>[...e[0]||(e[0]=[n("icon-button-fx-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),e[5]||(e[5]=L(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
