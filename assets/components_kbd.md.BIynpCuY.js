...
`,Ba=JSON.parse('{"title":"Kbd","description":"","frontmatter":{},"headers":[],"relativePath":"components/kbd.md","filePath":"components/kbd.md"}'),Ka={name:"components/kbd.md"},Ca=Object.assign(Ka,{setup(l){return(r,a)=>(p(),u("div",null,[a[1]||(a[1]=t("h1",{id:"kbd",tabindex:"-1"},[s("Kbd "),t("a",{class:"header-anchor",href:"#kbd","aria-label":'Permalink to "Kbd"'},"​")],-1)),i(f),a[2]||(a[2]=t("p",null,"Keyboard key components are used to represent keyboard shortcuts, hotkeys, or user input instructions in a visually distinct way. They mimic the appearance of physical keyboard keys.",-1)),a[3]||(a[3]=t("div",{class:"tip custom-block"},[t("p",{class:"custom-block-title"},"TIP"),t("p",null,[s("Note that single character content within an "),t("i",null,"<ag-kbd>"),s(" tag is bumped up by a single font size scale for readability.")])],-1)),a[4]||(a[4]=t("h2",{id:"examples",tabindex:"-1"},[s("Examples "),t("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(R,{component:"kbd","vue-code":n(ha),"lit-code":n(Fa),"react-code":n(ya)},{vue:e(()=>[i(pa)]),lit:e(()=>[...a[0]||(a[0]=[t("kbd-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[5]||(a[5]=N(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
