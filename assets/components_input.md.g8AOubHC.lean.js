var D=Object.defineProperty;var f=(l,s,p)=>s in l?D(l,s,{enumerable:!0,configurable:!0,writable:!0,value:p}):l[s]=p;var g=(l,s,p)=>f(l,typeof s!="symbol"?s+"":s,p);import{c as y,A}from"./chunks/AlphaWarning.D199zhtu.js";import{C as x}from"./chunks/VueInput.vue_vue_type_script_setup_true_lang-Dsxo7DuX.4O-G8wU_.js";import{_ as q,C as o,c as v,o as b,j as n,G as e,w as r,a as h,t as d,N as S,ae as w,k as u}from"./chunks/framework.CdHt8f9T.js";import{S as I}from"./chunks/search.KKpJqi6p.js";import{G as T}from"./chunks/globe.DRcu4sC8.js";import{a as R,i as U,x as z,F as L}from"./chunks/FrameworkExample.DQckTML-.js";import"./chunks/query-BykXNUlT.Pm7lu9c1.js";import"./chunks/slot.B17U6J5C.js";import"./chunks/form-control-utils.C4mpKouh.js";/**
...
`,vs=JSON.parse('{"title":"Input","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md"}'),hs={name:"components/input.md"},bs=Object.assign(hs,{setup(l){return(s,p)=>(b(),v("div",null,[p[1]||(p[1]=n("h1",{id:"input",tabindex:"-1"},[h("Input "),n("a",{class:"header-anchor",href:"#input","aria-label":'Permalink to "Input"'},"​")],-1)),e(A),p[2]||(p[2]=n("p",null,"A flexible, accessible form input component that supports text inputs, textareas, various styling variants, validation states, and input addons.",-1)),p[3]||(p[3]=n("h2",{id:"examples",tabindex:"-1"},[h("Examples "),n("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),e(L,{component:"input","vue-code":u(es),"lit-code":u(ts),"react-code":u(ls)},{vue:r(()=>[e(ns)]),lit:r(()=>[...p[0]||(p[0]=[n("input-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),p[4]||(p[4]=w("",68))]))}});export{vs as __pageData,bs as default};
