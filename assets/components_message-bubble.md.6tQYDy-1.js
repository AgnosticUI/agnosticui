var T=Object.defineProperty;var U=(n,s,i)=>s in n?T(n,s,{enumerable:!0,configurable:!0,writable:!0,value:i}):n[s]=i;var A=(n,s,i)=>U(n,typeof s!="symbol"?s+"":s,i);import{c as $,A as P}from"./chunks/AlphaWarning.D199zhtu.js";import{i as z,z as F,a as D,E as u,x as l}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{n as N}from"./chunks/state-CovhUvdr.DnzyR2fh.js";import{d as E,p as _,c as m,o as k,r as v,e as y,K as L,_ as H,C as d,j as a,G as e,w as o,F as J,B as W,b as G,ak as Y,X as j,ae as K,a as M,k as B}from"./chunks/framework.CdHt8f9T.js";import{$ as O}from"./chunks/VueAvatar.Oio9YFU5.js";import{C as Q}from"./chunks/VueInput.vue_vue_type_script_setup_true_lang-Dsxo7DuX.0TR12KbM.js";import{v as X}from"./chunks/VueButton.vue_vue_type_script_setup_true_lang-Bq8IPXqd.D9h_5OJF.js";import{T as Z}from"./chunks/trash-2.DfHjdvMq.js";import{S as ss}from"./chunks/send.DxLhcEKt.js";import{M as as}from"./chunks/message-circle.BQYA-aHJ.js";import{F as is}from"./chunks/FrameworkExample.Cu0hWhnk.js";import"./chunks/Button.yxJuDTTi.js";import"./chunks/plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import"./chunks/query-BykXNUlT.Pm7lu9c1.js";import"./chunks/if-defined-C8i28hSj.CfeO1FY9.js";import"./chunks/slot.B17U6J5C.js";import"./chunks/form-control-utils.B793yZMR.js";import"./chunks/unique-id.CpwMFgRD.js";import"./chunks/zap.-Jsm5uUC.js";/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const es=$("bot",[["path",{d:"M12 8V4H8",key:"hb8ula"}],["rect",{width:"16",height:"12",x:"4",y:"8",rx:"2",key:"enze0r"}],["path",{d:"M2 14h2",key:"vft8re"}],["path",{d:"M20 14h2",key:"4cs60a"}],["path",{d:"M15 13v2",key:"1xurst"}],["path",{d:"M9 13v2",key:"rq6x2g"}]]);var ns=Object.defineProperty,c=(n,s,i,r)=>{for(var h=void 0,b=n.length-1,t;b>=0;b--)(t=n[b])&&(h=t(s,i,h)||h);return h&&ns(s,i,h),h};const w=class extends D{constructor(){super(),this._avatarError=!1,this.from="them",this.message="",this.time="",this.author="",this.avatarUrl="",this.footer="",this.variant="default"}willUpdate(s){super.willUpdate(s),s.has("avatarUrl")&&(this._avatarError=!1)}_handleAvatarError(){this._avatarError=!0}_formatDateTime(s){const i=new Date(s);return!isNaN(i.getTime())&&s.includes("T")?new Intl.DateTimeFormat("default",{hour:"numeric",minute:"numeric"}).format(i):s}_getAriaLabel(){const s=[];if(this.author?s.push(`Message from ${this.author}`):s.push("Message"),this.time){const i=this._formatDateTime(this.time);s.push(`at ${i}`)}return s.join(" ")}_renderAvatar(){return this.querySelector('[slot="avatar"]')?l`
...
`,aa=JSON.parse('{"title":"MessageBubble","description":"","frontmatter":{},"headers":[],"relativePath":"components/message-bubble.md","filePath":"components/message-bubble.md"}'),Rs={name:"components/message-bubble.md"},ia=Object.assign(Rs,{setup(n){return(s,i)=>(k(),m("div",null,[i[1]||(i[1]=a("h1",{id:"messagebubble",tabindex:"-1"},[M("MessageBubble "),a("a",{class:"header-anchor",href:"#messagebubble","aria-label":'Permalink to "MessageBubble"'},"​")],-1)),e(P),i[2]||(i[2]=a("p",null,"A versatile message bubble component for building chat interfaces and messaging UIs. MessageBubble supports different sender types, delivery statuses, avatars, color variants, and custom styling through CSS Shadow Parts.",-1)),i[3]||(i[3]=a("h2",{id:"examples",tabindex:"-1"},[M("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),e(is,{component:"message-bubble","vue-code":B(xs),"lit-code":B(Ss),"react-code":B(Is)},{vue:o(()=>[e(qs)]),lit:o(()=>[...i[0]||(i[0]=[a("message-bubble-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),i[4]||(i[4]=K(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
...
<span class="line"><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">    /&gt;</span></span>
<span class="line"><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">  &lt;/</span><span style="--shiki-light:#024C1A;--shiki-dark:#72F088;">div</span><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&lt;/</span><span style="--shiki-light:#024C1A;--shiki-dark:#72F088;">template</span><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&gt;</span></span></code></pre></div></details>`,29))]))}});export{aa as __pageData,ia as default};
