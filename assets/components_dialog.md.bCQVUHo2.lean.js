...
`,gs=JSON.parse('{"title":"Dialog","description":"","frontmatter":{},"headers":[],"relativePath":"components/dialog.md","filePath":"components/dialog.md"}'),ls={name:"components/dialog.md"},rs=Object.assign(ls,{setup(e){return(s,a)=>(r(),g("div",null,[a[1]||(a[1]=i("h1",{id:"dialog",tabindex:"-1"},[k("Dialog "),i("a",{class:"header-anchor",href:"#dialog","aria-label":'Permalink to "Dialog"'},"​")],-1)),t(A),a[2]||(a[2]=i("p",null,"A dialog is a modal window that overlays the main content and requires user interaction before returning to the application. Dialogs are useful for confirmations, alerts, forms, and presenting focused content.",-1)),a[3]||(a[3]=i("h2",{id:"examples",tabindex:"-1"},[k("Examples "),i("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),t(R,{component:"dialog","vue-code":y(as),"lit-code":y(ns),"react-code":y(ts)},{vue:l(()=>[t(is)]),lit:l(()=>[...a[0]||(a[0]=[i("dialog-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[4]||(a[4]=V("",37))]))}});export{gs as __pageData,rs as default};
