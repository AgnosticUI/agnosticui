import{c as h,A as g}from"./chunks/AlphaWarning.D199zhtu.js";import{u as a}from"./chunks/VueIcon.vue_vue_type_script_setup_true_lang-kC-nzMyu.Cr3hFrsB.js";import{S as o}from"./chunks/star.BnywctwD.js";import{Z as F,F as u}from"./chunks/FrameworkExample.DHJHO-gg.js";import{d as y,c as k,o as d,j as e,G as i,k as s,w as t,_ as m,ae as v,a as r}from"./chunks/framework.CdHt8f9T.js";import{a as b,x as C}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import"./chunks/state-CovhUvdr.DnzyR2fh.js";import"./chunks/if-defined-C8i28hSj.cIUcEGoF.js";/**
...
`,$=JSON.parse('{"title":"Icon","description":"","frontmatter":{},"headers":[],"relativePath":"components/icon.md","filePath":"components/icon.md"}'),P={name:"components/icon.md"},J=Object.assign(P,{setup(l){return(c,n)=>(d(),k("div",null,[n[1]||(n[1]=e("h1",{id:"icon",tabindex:"-1"},[r("Icon "),e("a",{class:"header-anchor",href:"#icon","aria-label":'Permalink to "Icon"'},"​")],-1)),i(g),n[2]||(n[2]=e("p",null,"Icon is used to visually represent an action, object, or state within the UI.",-1)),n[3]||(n[3]=e("h2",{id:"examples",tabindex:"-1"},[r("Examples "),e("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(u,{component:"icon","vue-code":s(R),"lit-code":s(q),"react-code":s(_)},{vue:t(()=>[i(L)]),lit:t(()=>[...n[0]||(n[0]=[e("icon-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),n[4]||(n[4]=v(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
