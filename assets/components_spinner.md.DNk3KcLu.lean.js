...
`,H=JSON.parse('{"title":"Spinner","description":"","frontmatter":{},"headers":[],"relativePath":"components/spinner.md","filePath":"components/spinner.md"}'),$={name:"components/spinner.md"},J=Object.assign($,{setup(t){return(i,s)=>(k(),p("div",null,[s[1]||(s[1]=a("h1",{id:"spinner",tabindex:"-1"},[r("Spinner "),a("a",{class:"header-anchor",href:"#spinner","aria-label":'Permalink to "Spinner"'},"​")],-1)),n(c),s[2]||(s[2]=a("p",null,"A spinner component displays a circular rotating animation to indicate loading state or ongoing activity. Use spinners to provide visual feedback when content is loading, processing, or waiting for a response.",-1)),s[3]||(s[3]=a("h2",{id:"examples",tabindex:"-1"},[r("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),n(x,{component:"spinner","vue-code":h(U),"lit-code":h(O),"react-code":h(M)},{vue:F(()=>[n(N)]),lit:F(()=>[...s[0]||(s[0]=[a("spinner-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),s[4]||(s[4]=f("",35))]))}});export{H as __pageData,J as default};
