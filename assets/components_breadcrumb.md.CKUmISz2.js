import{A as B}from"./chunks/AlphaWarning.BNPjaonO.js";import{i as E,z as d,a as b,x as r}from"./chunks/Button.D5k6BRt0.js";import{d as v,p as D,c as y,q as A,v as f,o as m,K as q,_ as x,C as w,j as a,G as p,a as k,ae as S,w as u,k as o}from"./chunks/framework.CdHt8f9T.js";import{F as _}from"./chunks/FrameworkExample.loPfkzmf.js";import"./chunks/createLucideIcon.BZxhvBdy.js";var P=Object.defineProperty,c=(t,s,i,h)=>{for(var n=void 0,e=t.length-1,l;e>=0;e--)(l=t[e])&&(n=l(s,i,n)||n);return n&&P(s,i,n),n};const C=class extends b{constructor(){super(),this._handleItemClick=(s,i,h)=>{const n=new CustomEvent("breadcrumb-click",{detail:{item:i,index:h,event:s},bubbles:!0,composed:!0});this.dispatchEvent(n),this.onBreadcrumbClick&&this.onBreadcrumbClick(n)},this.items=[],this.type="default",this.primary=!1,this.ariaLabel="Breadcrumb"}_renderBreadcrumbItem(s,i){const h=i===this.items.length-1,n=s.current||h;return r`
