import{A as C}from"./chunks/AlphaWarning.BkRV4LZN.js";import{i as E,a as m,x as f}from"./chunks/lit-element.B0TUrqGF.js";import{z as F}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{o as A}from"./chunks/slot.B17U6J5C.js";import{s as B}from"./chunks/plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as u,c as o,o as y,r as b,K as D,p as x,v as q,P as c,s as S,_ as w,C as V,j as i,G as t,w as l,a as n,ae as z}from"./chunks/framework.BoyT2Jkt.js";var P=Object.defineProperty,g=(h,s,e,k)=>{for(var p=void 0,r=h.length-1,a;r>=0;r--)(a=h[r])&&(p=a(s,e,p)||p);return p&&P(s,e,p),p};const v=class extends m{constructor(){super(),this.vertical=!1,this.justify="center",this.size="default",this.variant="default",this.hasContent=!1}handleSlotChange(s){this.hasContent=A(s.target)}getClasses(){const s=["divider"];return this.vertical&&s.push("divider-vertical"),this.justify!=="center"&&!this.vertical&&s.push(`divider-justify-${this.justify}`),this.size!=="default"&&s.push(`divider-${this.size}`),this.variant!=="default"&&s.push(`divider-${this.variant}`),s.join(" ")}render(){const s=this.vertical?"vertical":"horizontal",e=this.hasContent?"divider-content divider-has-content":"divider-content";return f`
      <div
