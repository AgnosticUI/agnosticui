import{c as q,A as x}from"./chunks/AlphaWarning.D199zhtu.js";import{a as D,x as B,z as o,F as O}from"./chunks/FrameworkExample.DQckTML-.js";import"./chunks/Dialog.BUebDu-L.js";import{d as S,p as R,c as C,o as w,r as V,K as T,_ as N,C as c,j as i,G as t,w as l,a as e,Z as u,ae as P,k as m}from"./chunks/framework.CdHt8f9T.js";import{v as I}from"./chunks/VueButton.vue_vue_type_script_setup_true_lang-Bq8IPXqd.Dgbr55RT.js";import{S as U}from"./chunks/share-2.CRgCaFaN.js";import{D as _}from"./chunks/download.fjN6RXXS.js";import{U as L}from"./chunks/upload.Du9GV14o.js";import{P as z}from"./chunks/plus.C2eZngoA.js";import"./chunks/CloseButton.B4KJOgyi.js";/**
...
`,Rs=JSON.parse('{"title":"Drawer","description":"","frontmatter":{},"headers":[],"relativePath":"components/drawer.md","filePath":"components/drawer.md"}'),Es={name:"components/drawer.md"},Vs=Object.assign(Es,{setup(p){return(s,n)=>(w(),C("div",null,[n[1]||(n[1]=i("h1",{id:"drawer",tabindex:"-1"},[e("Drawer "),i("a",{class:"header-anchor",href:"#drawer","aria-label":'Permalink to "Drawer"'},"​")],-1)),t(x),n[2]||(n[2]=i("p",null,"A drawer is a panel that slides in from the edge of the screen, typically used for navigation menus, filters, settings, or other supplementary content. Drawers can slide in from any of the four edges: start (left), end (right), top, or bottom.",-1)),n[3]||(n[3]=i("h2",{id:"examples",tabindex:"-1"},[e("Examples "),i("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),t(O,{component:"drawer","vue-code":m(ms),"lit-code":m(Cs),"react-code":m(ws)},{vue:l(()=>[t(cs)]),lit:l(()=>[...n[0]||(n[0]=[i("drawer-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),n[4]||(n[4]=P(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
