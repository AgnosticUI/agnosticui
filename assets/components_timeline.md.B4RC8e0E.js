import{A as L}from"./chunks/AlphaWarning.D199zhtu.js";import{i as M,z as g,a as q,E as z,x as T}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{d as I,p as H,c,o as v,r as f,e as B,_ as j,C as h,j as s,G as n,w as a,a as t,N as k,ae as $,k as D}from"./chunks/framework.CdHt8f9T.js";import{u as O}from"./chunks/VueIcon.vue_vue_type_script_setup_true_lang-kC-nzMyu.BMHQVIJ7.js";import{v as N}from"./chunks/VueCard.CVJ4nhpC.js";import{v as W}from"./chunks/VueButton.vue_vue_type_script_setup_true_lang-Bq8IPXqd.D9h_5OJF.js";import{v as U}from"./chunks/VueBadge.vue_vue_type_script_setup_true_lang-DAPP5_-i.dgqkc4dR.js";import{k as G}from"./chunks/VueIconButton.vue_vue_type_script_setup_true_lang-DKCTvvr9.D1JN8Mlk.js";import{F as Y}from"./chunks/FrameworkExample.BH6ADiPw.js";import"./chunks/Icon.CxPOY7rJ.js";import"./chunks/Button.yxJuDTTi.js";import"./chunks/Badge.D1NjnldS.js";import"./chunks/IconButton.DTGeb34c.js";import"./chunks/Spinner.B9WOMGnk.js";import"./chunks/slot.B17U6J5C.js";import"./chunks/plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import"./chunks/VueTabPanel.vue_vue_type_script_setup_true_lang-BnQoc7fo.CI0KxhKC.js";import"./chunks/state-CovhUvdr.DnzyR2fh.js";import"./chunks/unique-id.CpwMFgRD.js";import"./chunks/zap.-Jsm5uUC.js";import"./chunks/if-defined-C8i28hSj.CfeO1FY9.js";import"./chunks/Badge.BrFYW107.js";import"./chunks/IconButton.CfyrYLhy.js";var K=Object.defineProperty,d=(e,i,r,C)=>{for(var p=void 0,F=e.length-1,m;F>=0;F--)(m=e[F])&&(p=m(i,r,p)||p);return p&&K(i,r,p),p};const R=class extends q{constructor(){super(),this.orientation="horizontal",this.variant="",this.compact=!1}updated(i){super.updated(i),(i.has("orientation")||i.has("variant"))&&this._updateChildItems()}_updateChildItems(){var C;const i=(C=this.shadowRoot)==null?void 0:C.querySelector("slot");if(!i)return;const r=i.assignedElements({flatten:!0}).filter(p=>p.tagName.toLowerCase()==="ag-timeline-item");r.forEach((p,F)=>{p.setAttribute("orientation",this.orientation),this.variant&&p.setAttribute("variant",this.variant),p.toggleAttribute("first",F===0),p.toggleAttribute("last",F===r.length-1)})}render(){return T`
      <ul 
...
}`,Xi=JSON.parse('{"title":"Timeline","description":"","frontmatter":{},"headers":[],"relativePath":"components/timeline.md","filePath":"components/timeline.md"}'),xi={name:"components/timeline.md"},Zi=Object.assign(xi,{setup(e){return(i,r)=>(v(),c("div",null,[r[1]||(r[1]=s("h1",{id:"timeline",tabindex:"-1"},[t("Timeline "),s("a",{class:"header-anchor",href:"#timeline","aria-label":'Permalink to "Timeline"'},"​")],-1)),n(L),r[2]||(r[2]=s("p",null,"Timeline is a semantic component for displaying chronological events, processes, or activities in either horizontal or vertical orientation. It provides flexible slots for dates, markers, and descriptions with support for rich content including cards, badges, and interactive elements.",-1)),r[3]||(r[3]=s("h2",{id:"examples",tabindex:"-1"},[t("Examples "),s("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),n(Y,{component:"timeline","vue-code":D(Ci),"lit-code":D(Ei),"react-code":D(fi)},{vue:a(()=>[n(bi)]),lit:a(()=>[...r[0]||(r[0]=[s("timeline-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),r[4]||(r[4]=$(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
