import{A as H}from"./chunks/AlphaWarning.CKFYAqLS.js";import{i as S,z as g,a as T,E as z,x as q}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{d as M,p as j,c,o as v,r as f,e as B,_ as O,C as d,j as s,G as n,w as a,a as t,N as h,ag as N,k as D}from"./chunks/framework.DmF2n0Fc.js";import{m as W}from"./chunks/VueIcon.vue_vue_type_script_setup_true_lang-C2Sky3bU.BndYKofP.js";import{y as U}from"./chunks/VueCard.C-NlLc2M.js";import{v as G}from"./chunks/VueButton.vue_vue_type_script_setup_true_lang-D1jGatE9.Cl3S9w1o.js";import{v as Y}from"./chunks/VueBadge.vue_vue_type_script_setup_true_lang-DAPP5_-i.BzP4C0fs.js";import{k as K}from"./chunks/VueIconButton.vue_vue_type_script_setup_true_lang-DKCTvvr9.mUcDfEUP.js";import{F as Q}from"./chunks/FrameworkExample.Byhd3Bwz.js";import"./chunks/Icon.CxPOY7rJ.js";import"./chunks/Button.BmTmCFep.js";import"./chunks/Badge.NomNrVJa.js";import"./chunks/IconButton.CQaD6hOj.js";import"./chunks/Spinner.B9WOMGnk.js";import"./chunks/createLucideIcon.U6K_rCrv.js";import"./chunks/slot.CsrcmCtp.js";import"./chunks/plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import"./chunks/state-CovhUvdr.C-u8O0Fo.js";import"./chunks/sdk.m.Dxhqq5iP.js";import"./chunks/Badge.D2WpDLhx.js";import"./chunks/VisuallyHidden.CGw79oCK.js";import"./chunks/IconButton.Dv25zuPv.js";var J=Object.defineProperty,k=(e,i,r,A)=>{for(var p=void 0,m=e.length-1,y;m>=0;m--)(y=e[m])&&(p=y(i,r,p)||p);return p&&J(i,r,p),p};const P=class extends T{constructor(){super(),this.orientation="horizontal",this.variant="",this.compact=!1}updated(i){super.updated(i),(i.has("orientation")||i.has("variant"))&&this._updateChildItems()}_updateChildItems(){var A;const i=(A=this.shadowRoot)==null?void 0:A.querySelector("slot");if(!i)return;const r=i.assignedElements({flatten:!0}).filter(p=>p.tagName.toLowerCase()==="ag-timeline-item");r.forEach((p,m)=>{p.setAttribute("orientation",this.orientation),this.variant&&p.setAttribute("variant",this.variant),p.toggleAttribute("first",m===0),p.toggleAttribute("last",m===r.length-1)})}render(){return q`
      <ul 
...
}`,es=JSON.parse('{"title":"Timeline","description":"","frontmatter":{},"headers":[],"relativePath":"components/timeline.md","filePath":"components/timeline.md"}'),Ri={name:"components/timeline.md"},ls=Object.assign(Ri,{setup(e){return(i,r)=>(v(),c("div",null,[r[1]||(r[1]=s("h1",{id:"timeline",tabindex:"-1"},[t("Timeline "),s("a",{class:"header-anchor",href:"#timeline","aria-label":'Permalink to "Timeline"'},"​")],-1)),n(H),r[2]||(r[2]=s("p",null,"Timeline is a semantic component for displaying chronological events, processes, or activities in either horizontal or vertical orientation. It provides flexible slots for dates, markers, and descriptions with support for rich content including cards, badges, and interactive elements.",-1)),r[3]||(r[3]=s("h2",{id:"examples",tabindex:"-1"},[t("Examples "),s("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),n(Q,{component:"timeline","vue-code":D(qi),"lit-code":D(Mi),"react-code":D(Ii)},{vue:a(()=>[n(wi)]),lit:a(()=>[...r[0]||(r[0]=[s("timeline-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),r[4]||(r[4]=N(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
