import{A as is}from"./chunks/AlphaWarning.BkRV4LZN.js";import{i as as,a as ts,E as D,x as B}from"./chunks/lit-element.B0TUrqGF.js";import{z as o}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{n as f}from"./chunks/state-CovhUvdr.BllWkzJh.js";import{f as L}from"./chunks/query-BykXNUlT.Pm7lu9c1.js";import{a as es,i as ns,u as ls,t as Y}from"./chunks/form-control-utils.DRSK-DHo.js";import"./chunks/CloseButton.JmCUmSqr.js";import"./chunks/Checkbox.CP_GTKDV.js";import"./chunks/Tag.M_RNKiVZ.js";import{d as K,p as y,c as V,o as z,r as hs,j as t,G as r,k as F,t as S,e as ps,a as x,_ as ks,ae as os}from"./chunks/framework.BoyT2Jkt.js";import"./chunks/unique-id.CpwMFgRD.js";var rs=Object.defineProperty,ds=Object.getOwnPropertyDescriptor,p=(d,s,i,e)=>{for(var l=e>1?void 0:e?ds(s,i):s,u=d.length-1,b;u>=0;u--)(b=d[u])&&(l=(e?b(s,i,l):b(l))||l);return e&&l&&rs(s,i,l),l};const G=class extends ts{constructor(){super(),this._value="",this.labelPosition="top",this._open=!1,this._searchTerm="",this._filteredOptions=[],this._activeIndex=-1,this._selectedOptions=[],this._displayLabel="",this._comboboxId="",this._listboxId="",this._labelId="",this._helpTextId="",this._errorTextId="",this._justSelected=!1,this._isDefaultValueInitialized=!1,this.options=[],this.placeholder="",this.labelHidden=!1,this.noLabel=!1,this.ariaLabel=null,this.id="",this.autocomplete="list",this.filterMode="startsWith",this.clearable=!1,this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.size="default",this.variant="default",this.maxVisibleOptions=10,this.closeOnSelect=!0,this.multiple=!1,this.maxOptionsVisible=3,this.loading=!1,this.loadingText="Loading...",this.noResultsText="No results found"}get value(){return this._value}set value(s){const i=this._value;this.multiple?this._value=Array.isArray(s)?s:s?s.split(" "):[]:this._value=Array.isArray(s)?s.join(" "):s,this.requestUpdate("value",i)}connectedCallback(){super.connectedCallback();const s=ns("combobox");this._comboboxId=this.id||s.inputId,this._listboxId=`${this._comboboxId}-listbox`,this._labelId=s.labelId,this._helpTextId=s.helperId,this._errorTextId=s.errorId,this._clickOutsideHandler=i=>{this._open&&(i.composedPath().includes(this)||this.close())},document.addEventListener("click",this._clickOutsideHandler)}disconnectedCallback(){super.disconnectedCallback(),this._clickOutsideHandler&&document.removeEventListener("click",this._clickOutsideHandler)}willUpdate(s){if(super.willUpdate(s),!this._isDefaultValueInitialized&&this.defaultValue&&this.options.length>0){const i=Array.isArray(this.defaultValue)?this.defaultValue:[this.defaultValue];this._selectedOptions=this.options.filter(e=>i.includes(e.value)),this._selectionChanged(),this._isDefaultValueInitialized=!0;return}if(s.has("value")&&(this._isDefaultValueInitialized||!this.defaultValue)){const i=this.value,e=Array.isArray(i)?i:i?[i]:[];this._selectedOptions=this.options.filter(l=>e.includes(l.value)),this._selectionChanged()}s.has("errorMessage")&&(this.invalid=!!this.errorMessage)}focus(){var s;(s=this._inputElement)==null||s.focus()}blur(){var s;(s=this._inputElement)==null||s.blur()}open(){var i,e;if(this.disabled||this.readonly||this._open)return;this._open=!0,this._filterOptions(),this.setAttribute("open","");const s=new CustomEvent("open",{detail:{open:!0},bubbles:!0,composed:!0});this.dispatchEvent(s),(i=this.onOpen)==null||i.call(this,s),(e=this._inputElement)==null||e.setAttribute("aria-expanded","true")}close(){var i,e,l;if(!this._open)return;if(this._open=!1,this._activeIndex=-1,this.multiple)this._searchTerm=this._displayLabel;else if(!this.options.some(u=>u.label===this._searchTerm)){const u=this._selectedOptions[0];u?this._searchTerm=u.label:this._searchTerm=""}this.removeAttribute("open");const s=new CustomEvent("close",{detail:{open:!1},bubbles:!0,composed:!0});this.dispatchEvent(s),(i=this.onClose)==null||i.call(this,s),(e=this._inputElement)==null||e.setAttribute("aria-expanded","false"),(l=this._inputElement)==null||l.removeAttribute("aria-activedescendant")}toggle(){this._open?this.close():this.open()}selectOption(s){var u,b,C;let i;if(typeof s=="string"){if(i=this.options.find(m=>m.value===s),!i)return}else i=s;if(i.disabled)return;this.multiple?(this._selectedOptions.findIndex(m=>m.value===i.value)>-1?this._selectedOptions=this._selectedOptions.filter(m=>m.value!==i.value):this._selectedOptions=[...this._selectedOptions,i],this._selectionChanged()):(this._selectedOptions=[i],this._selectionChanged(),this.closeOnSelect&&this.close()),this._inputElement&&(this._inputElement.value=this._searchTerm);const e=new CustomEvent("select",{detail:{option:i,value:i.value},bubbles:!0,composed:!0});this.dispatchEvent(e),(u=this.onSelect)==null||u.call(this,e);const l=new CustomEvent("change",{detail:{value:this.value,option:i},bubbles:!0,composed:!0});this.dispatchEvent(l),(b=this.onChange)==null||b.call(this,l),this._justSelected=!0,(C=this._inputElement)==null||C.focus(),requestAnimationFrame(()=>{const m=this._inputElement;if(m){const v=m.value.length;m.setSelectionRange(v,v)}}),setTimeout(()=>{this._justSelected=!1},100)}clearSelection(){var i;this._selectedOptions=[],this._selectionChanged(),this._activeIndex=-1;const s=new CustomEvent("change",{detail:{value:this.value,option:null},bubbles:!0,composed:!0});this.dispatchEvent(s),(i=this.onChange)==null||i.call(this,s)}_selectionChanged(){if(this.multiple)this.value=this._selectedOptions.map(s=>s.value),this._searchTerm="";else{const s=this._selectedOptions[0];this.value=(s==null?void 0:s.value)??"",this._displayLabel=(s==null?void 0:s.label)??"",this._searchTerm=this._displayLabel}}_renderSelectedTags(){if(!this.multiple||this._selectedOptions.length===0)return D;const s=this._selectedOptions.slice(0,this.maxOptionsVisible),i=this._selectedOptions.length-this.maxOptionsVisible;return B`
      <div class="combobox-tags-wrapper" part="ag-combobox-tags-wrapper">
        ${s.map(e=>B`
          <ag-tag
            removable
            .value=${e.value}
            @tag-remove=${()=>this._handleTagRemove(e)}
          >
            ${e.label}
          </ag-tag>
        `)}
    ...
    `}_handleTagRemove(s){var i;this._selectedOptions=this._selectedOptions.filter(e=>e.value!==s.value),this._selectionChanged(),(i=this._inputElement)==null||i.focus()}_filterOptions(){var l;const s=this._searchTerm.trim();if(!this.multiple&&this._selectedOptions.length>0&&s===this._selectedOptions[0].label){this._filteredOptions=this.options.slice(0,this.maxVisibleOptions),this._activeIndex!==-1&&(this._activeIndex=this.options.findIndex(u=>{var b;return u.value===((b=this._selectedOptions[0])==null?void 0:b.value)}));return}if(!s||this.filterMode==="none"){this._filteredOptions=this.options.slice(0,this.maxVisibleOptions);return}let i;switch(this.filterMode){case"startsWith":i=this._filterStartsWith(this.options,s);break;case"contains":i=this._filterContains(this.options,s);break;default:i=this.options}this._filteredOptions=i.slice(0,this.maxVisibleOptions),this._filteredOptions.length>0?(this._activeIndex=0,this._updateAriaActivedescendant(),this._announceOption(this._filteredOptions[0])):(this._activeIndex=-1,this._announceNoResults());const e=new CustomEvent("search",{detail:{searchTerm:s},bubbles:!0,composed:!0});this.dispatchEvent(e),(l=this.onSearch)==null||l.call(this,e)}_filterStartsWith(s,i){const e=i.toLowerCase();return s.filter(l=>l.label.toLowerCase().startsWith(e))}_filterContains(s,i){const e=i.toLowerCase();return s.filter(l=>l.label.toLowerCase().includes(e))}_handleInputChange(s){const i=s.target.value;this._justSelected||i!==this._searchTerm&&(this._searchTerm=i,this.multiple||(this._selectedOptions=[],this.value=""),this._open||this.open(),this._filterOptions())}_handleInputKeyDown(s){var i;switch(s.key){case"ArrowDown":s.preventDefault(),this._open?this._updateActiveIndex(1):(this.open(),this._filteredOptions.length>0&&(this._activeIndex=0,this._updateAriaActivedescendant(),this._scrollOptionIntoView(this._activeIndex),this._announceOption(this._filteredOptions[this._activeIndex])));break;case"ArrowUp":s.preventDefault(),this._open?this._updateActiveIndex(-1):(this.open(),this._filteredOptions.length>0&&(this._activeIndex=this._filteredOptions.length-1,this._updateAriaActivedescendant(),this._scrollOptionIntoView(this._activeIndex),this._announceOption(this._filteredOptions[this._activeIndex])));break;case"Enter":s.preventDefault(),this._open&&this._activeIndex>=0&&this._activeIndex<this._filteredOptions.length&&this.selectOption(this._filteredOptions[this._activeIndex]);break;case"Escape":s.preventDefault(),this._open?this.close():this._searchTerm&&this.clearSelection();break;case"Backspace":if(this.multiple&&this._searchTerm===""&&this._selectedOptions.length>0){s.preventDefault();const e=this._selectedOptions[this._selectedOptions.length-1];this._selectedOptions=this._selectedOptions.slice(0,-1),this._selectionChanged();const l=new CustomEvent("change",{detail:{value:this.value,option:e},bubbles:!0,composed:!0});this.dispatchEvent(l),(i=this.onChange)==null||i.call(this,l)}break;case"Tab":this._open&&this.close();break;case"Home":s.preventDefault(),this._inputElement&&this._inputElement.setSelectionRange(0,0),this._open&&this._filteredOptions.length>0&&(this._activeIndex=0,this._updateAriaActivedescendant(),this._scrollOptionIntoView(this._activeIndex),this._announceOption(this._filteredOptions[this._activeIndex]));break;case"End":if(s.preventDefault(),this._inputElement){const e=this._inputElement.value.length;this._inputElement.setSelectionRange(e,e)}this._open&&this._filteredOptions.length>0&&(this._activeIndex=this._filteredOptions.length-1,this._updateAriaActivedescendant(),this._scrollOptionIntoView(this._activeIndex),this._announceOption(this._filteredOptions[this._activeIndex]));break}}_handleInputFocus(s){var i,e;if(this._justSelected){(i=this.onFocus)==null||i.call(this,s);return}!this._open&&!this.disabled&&!this.readonly&&this.open(),(e=this.onFocus)==null||e.call(this,s)}_handleInputBlur(s){var i;(i=this.onBlur)==null||i.call(this,s)}_handleInputClick(){this._open||(this._activeIndex=-1,this.open())}_handleOptionClick(s,i){i.preventDefault(),s.disabled||this.selectOption(s)}_handleToggleClick(s){var i;s.preventDefault(),this.toggle(),(i=this._inputElement)==null||i.focus()}_handleClearClick(s){var i;s.preventDefault(),s.stopPropagation(),this.clearSelection(),(i=this._inputElement)==null||i.focus()}_updateActiveIndex(s){if(this._filteredOptions.length===0)return;let i=this._activeIndex+s,e=0;const l=this._filteredOptions.length;for(;e<l&&(i<0?i=this._filteredOptions.length-1:i>=this._filteredOptions.length&&(i=0),!!this._filteredOptions[i].disabled);)i+=s,e++;e<l&&!this._filteredOptions[i].disabled&&(this._activeIndex=i,this._updateAriaActivedescendant(),this._scrollOptionIntoView(i),this._announceOption(this._filteredOptions[i]))}_updateAriaActivedescendant(){var s,i;if(this._activeIndex>=0&&this._activeIndex<this._filteredOptions.length){const e=this._getOptionId(this._activeIndex);(s=this._inputElement)==null||s.setAttribute("aria-activedescendant",e)}else(i=this._inputElement)==null||i.removeAttribute("aria-activedescendant")}_scrollOptionIntoView(s){s<0||s>=this._filteredOptions.length||requestAnimationFrame(()=>{var l;const i=this._getOptionId(s),e=(l=this.shadowRoot)==null?void 0:l.getElementById(i);if(e&&this._listboxElement){const u=this._listboxElement.getBoundingClientRect(),b=e.getBoundingClientRect();b.bottom>u.bottom?e.scrollIntoView({block:"nearest",behavior:"smooth"}):b.top<u.top&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}})}_announceOption(s){const i=this._filteredOptions.indexOf(s),e=this._filteredOptions.length,l=`${s.label}, ${i+1} of ${e}`;this._srAnnouncer&&(this._srAnnouncer.textContent=l)}_announceNoResults(){this._srAnnouncer&&(this._srAnnouncer.textContent=this.noResultsText)}_getOptionId(s){return`${this._listboxId}-option-${s}`}_getDescribedBy(){return ls({helperId:this._helpTextId,errorId:this._errorTextId,hasHelper:!!this.helpText&&!this.invalid,hasError:!!this.invalid&&!!this.errorMessage})}renderLabel(){if(!this.label||this.noLabel)return"";const s=[];return Y(this.labelPosition)?(s.push("ag-form-control__label--horizontal"),s.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&s.push(`ag-form-control__label--${this.labelPosition}`),B`
      <label
        id=${this._labelId}
    ...
    `}render(){const s=!this.noLabel&&this.label,i=this._getDescribedBy(),e=Y(this.labelPosition),l=B`

        <div
          class="combobox-input-wrapper"
          part="ag-combobox-input-wrapper"
          @click=${()=>{var C;return(C=this._inputElement)==null?void 0:C.focus()}}
        >
          ${this.multiple?this._renderSelectedTags():D}
          <input
            id=${this._comboboxId}
            ...
            aria-labelledby=${s?this._labelId:D}
          ...
          ${this.clearable&&this._selectedOptions.length>0?B`
            <div
        ...
        >
          ...
          `:this._filteredOptions.length===0?B`
            <div class="ag-combobox__no-results combobox-no-results" part="ag-combobox-no-results">
              ${this.noResultsText}
            </div>
          `:B`
            ${this._filteredOptions.map((C,m)=>B`
              <div
                id=${this._getOptionId(m)}
                class="combobox-option ${m===this._activeIndex?"option-active":""}"
                part="ag-combobox-option"
                role="option"
                aria-selected=${this._selectedOptions.some(v=>v.value===C.value)?"true":"false"}
                aria-disabled=${C.disabled?"true":"false"}
                @click=${v=>this._handleOptionClick(C,v)}
              >
                ${this.multiple?B`
                  <ag-checkbox
                    .checked=${this._selectedOptions.some(v=>v.value===C.value)}
                    .size=${this.size==="default"?"medium":this.size}
                    .value=${C.value}
                    .name=${this._comboboxId}
                    .disabled=${C.disabled}
                    @change=${v=>{v.stopPropagation(),this._handleOptionClick(C,v)}}
                  >
                    ${C.label}
                  </ag-checkbox>
                `:B`
        ...
        <div
          ...
          aria-atomic="true"
        ></div>
    `,u=this.helpText&&!this.invalid?B`<div id=${this._helpTextId} class="ag-form-control__helper">
          ${this.helpText}
        </div>`:"",b=this.invalid&&this.errorMessage?B`<div id=${this._errorTextId} class="ag-form-control__error">
          ${this.errorMessage}
        </div>`:"";return e?B`
  ...
  `];let h=G;p([o({type:Array})],h.prototype,"options",2);p([o({type:[String,Array]})],h.prototype,"value",1);p([o({type:[String,Array],attribute:"default-value"})],h.prototype,"defaultValue",2);p([o({type:String})],h.prototype,"placeholder",2);p([o({type:String})],h.prototype,"label",2);p([o({type:String,attribute:"label-position"})],h.prototype,"labelPosition",2);p([o({type:Boolean,attribute:"label-hidden"})],h.prototype,"labelHidden",2);p([o({type:Boolean,attribute:"no-label"})],h.prototype,"noLabel",2);p([o({type:String,attribute:"aria-label"})],h.prototype,"ariaLabel",2);p([o({type:String,attribute:"help-text"})],h.prototype,"helpText",2);p([o({type:String,attribute:"error-message"})],h.prototype,"errorMessage",2);p([o({type:String})],h.prototype,"id",2);p([o({type:String})],h.prototype,"autocomplete",2);p([o({type:String,attribute:"filter-mode"})],h.prototype,"filterMode",2);p([o({type:Boolean})],h.prototype,"clearable",2);p([o({type:Boolean,reflect:!0})],h.prototype,"disabled",2);p([o({type:Boolean})],h.prototype,"readonly",2);p([o({type:Boolean})],h.prototype,"required",2);p([o({type:Boolean,reflect:!0})],h.prototype,"invalid",2);p([o({type:String,reflect:!0})],h.prototype,"size",2);p([o({type:String,reflect:!0})],h.prototype,"variant",2);p([o({type:Number,attribute:"max-visible-options"})],h.prototype,"maxVisibleOptions",2);p([o({type:Boolean})],h.prototype,"closeOnSelect",2);p([o({type:Boolean})],h.prototype,"multiple",2);p([o({type:Number,attribute:"max-options-visible"})],h.prototype,"maxOptionsVisible",2);p([o({type:Boolean})],h.prototype,"loading",2);p([o({type:String,attribute:"loading-text"})],h.prototype,"loadingText",2);p([o({type:String,attribute:"no-results-text"})],h.prototype,"noResultsText",2);p([o({attribute:!1})],h.prototype,"onChange",2);p([o({attribute:!1})],h.prototype,"onSelect",2);p([o({attribute:!1})],h.prototype,"onSearch",2);p([o({attribute:!1})],h.prototype,"onOpen",2);p([o({attribute:!1})],h.prototype,"onClose",2);p([o({attribute:!1})],h.prototype,"onFocus",2);p([o({attribute:!1})],h.prototype,"onBlur",2);p([f()],h.prototype,"_open",2);p([f()],h.prototype,"_searchTerm",2);p([f()],h.prototype,"_filteredOptions",2);p([f()],h.prototype,"_activeIndex",2);p([f()],h.prototype,"_selectedOptions",2);p([f()],h.prototype,"_displayLabel",2);p([L(".combobox-input")],h.prototype,"_inputElement",2);p([L(".combobox-listbox")],h.prototype,"_listboxElement",2);p([L(".combobox-sr-announcer")],h.prototype,"_srAnnouncer",2);customElements.get("ag-combobox")||customElements.define("ag-combobox",h);const Fs=[".labelHidden",".labelPosition",".noLabel",".disabled",".invalid",".clearable",".readonly",".required",".loading",".multiple",".closeOnSelect",".options",".value",".defaultValue",".maxOptionsVisible","placeholder","label","ariaLabel","helpText","errorMessage","autocomplete","filterMode","size","variant","loadingText","noResultsText"],g=K({__name:"VueCombobox",props:{options:{default:()=>[]},value:{default:void 0},defaultValue:{default:void 0},placeholder:{default:""},label:{default:""},labelPosition:{default:"top"},labelHidden:{type:Boolean,default:!1},noLabel:{type:Boolean,default:!1},ariaLabel:{default:null},helpText:{default:""},errorMessage:{default:""},id:{},autocomplete:{default:"list"},filterMode:{default:"startsWith"},clearable:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},required:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},size:{default:"default"},maxVisibleOptions:{},closeOnSelect:{type:Boolean,default:!0},variant:{default:"default"},multiple:{type:Boolean,default:!1},maxOptionsVisible:{default:3},loading:{type:Boolean,default:!1},loadingText:{default:"Loading..."},noResultsText:{default:"No results found"}},emits:["change","select","search","open","close","focus","blur","update:value"],setup(d,{expose:s,emit:i}){const e=i,l=y(),u=n=>{const c=n;e("change",c.detail),e("update:value",c.detail.value)},b=n=>{e("select",n.detail)},C=n=>{e("search",n.detail)},m=n=>{e("open",n.detail)},v=n=>{e("close",n.detail)},w=n=>{e("focus",n)},O=n=>{e("blur",n)};return s({focus:()=>{var n,c;return(c=(n=l.value)==null?void 0:n.focus)==null?void 0:c.call(n)},blur:()=>{var n,c;return(c=(n=l.value)==null?void 0:n.blur)==null?void 0:c.call(n)},open:()=>{var n,c;return(c=(n=l.value)==null?void 0:n.open)==null?void 0:c.call(n)},close:()=>{var n,c;return(c=(n=l.value)==null?void 0:n.close)==null?void 0:c.call(n)},toggle:()=>{var n,c;return(c=(n=l.value)==null?void 0:n.toggle)==null?void 0:c.call(n)},selectOption:n=>{var c,_;return(_=(c=l.value)==null?void 0:c.selectOption)==null?void 0:_.call(c,n)},clearSelection:()=>{var n,c;return(c=(n=l.value)==null?void 0:n.clearSelection)==null?void 0:c.call(n)}}),(n,c)=>(z(),V("ag-combobox",{ref_key:"comboboxRef",ref:l,".labelHidden":d.labelHidden,".labelPosition":d.labelPosition,".noLabel":d.noLabel,".disabled":d.disabled,".invalid":d.invalid,".clearable":d.clearable,".readonly":d.readonly,".required":d.required,".loading":d.loading,".multiple":d.multiple,".closeOnSelect":d.closeOnSelect,".options":d.options,".value":d.value,".defaultValue":d.defaultValue,".maxOptionsVisible":d.maxOptionsVisible,placeholder:d.placeholder,label:d.label,ariaLabel:d.ariaLabel,helpText:d.helpText,errorMessage:d.errorMessage,autocomplete:d.autocomplete,filterMode:d.filterMode,size:d.size,variant:d.variant,loadingText:d.loadingText,noResultsText:d.noResultsText,onChange:u,onSelect:b,onSearch:C,onOpen:m,onClose:v,onFocus:w,onBlur:O},[hs(n.$slots,"default")],40,Fs))}}),gs={class:"stacked mbe4"},cs={class:"text-sm text-secondary"},ys={class:"stacked mbe4"},us={class:"stacked mbe4"},bs={class:"stacked mbe4"},Cs={class:"text-sm text-secondary"},ms={class:"stacked mbe4"},vs={class:"stacked mbe4"},Bs={class:"stacked mbe4"},As={class:"stacked mbe4"},Ds={class:"stacked mbe4"},Es={class:"stacked mbe4"},xs={class:"stacked mbe4"},fs={class:"stacked mbe4"},_s={class:"text-sm text-secondary"},qs={class:"stacked mbe4"},Ss={class:"stacked mbe4"},ws={class:"stacked mbe4"},Os={class:"stacked mbe4"},Ts={class:"stacked mbe4"},Is={class:"flex-inline items-center",style:{gap:"10px"}},$s={key:0},Vs={class:"mbe4",style:{"max-width":"600px"}},zs={class:"mbe3"},Ls={class:"mbe3"},Ps={class:"mbe3"},Rs={class:"mbe3"},Ms={class:"mbe4",style:{"max-width":"600px"}},Us={class:"mbe3"},Ws={class:"mbe3"},Ns={class:"mbe3"},Hs={class:"mbe3"},js=K({__name:"ComboboxExamples",setup(d){const s=[{value:"al",label:"Alabama"},{value:"ak",label:"Alaska"},{value:"az",label:"Arizona"},{value:"ar",label:"Arkansas"},{value:"ca",label:"California"},{value:"co",label:"Colorado"},{value:"ct",label:"Connecticut"},{value:"de",label:"Delaware"},{value:"fl",label:"Florida"},{value:"ga",label:"Georgia"}],i=[{value:"ca",label:"California"},{value:"co",label:"Colorado",disabled:!0},{value:"ct",label:"Connecticut"},{value:"fl",label:"Florida",disabled:!0},{value:"ny",label:"New York"}],e=y(""),l=y(""),u=y(""),b=y(""),C=y(""),m=y(""),v=y("ca"),w=y("ca"),O=y("co"),n=y(""),c=y(""),_=y(""),P=y(""),T=y([]),E=y(!1),R=y(""),M=y(""),U=y(""),W=y(""),I=y([]),N=y(["ny","co"]),H=y([]),j=y(""),q=y(null),$=y(null),J=A=>{$.value=A.value;const a=A.option?A.option.label:"cleared";q.value=`change (value: ${A.value||"none"}, option: ${a})`},Q=A=>{$.value=A.value,q.value=`select (value: ${A.value}, label: ${A.option.label})`},X=A=>{const a=$.value?`, selected: ${$.value}`:"";q.value=`search (searchTerm: "${A.searchTerm}"${a})`},Z=A=>{console.log("State changed:",A)},ss=()=>{E.value=!E.value,E.value?(T.value=[],setTimeout(()=>{T.value=s,E.value=!1},2e3)):T.value=s};return(A,a)=>(z(),V("section",null,[a[22]||(a[22]=t("div",{class:"mbe4"},[t("h2",null,"Basic Combobox")],-1)),t("div",gs,[r(F(g),{value:e.value,"onUpdate:value":a[0]||(a[0]=k=>e.value=k),options:s,label:"Select State",placeholder:"Choose a state...",class:"mbe2",onChange:Z},null,8,["value"]),t("p",cs,"Selected: "+S(e.value||"None"),1)]),a[23]||(a[23]=t("div",{class:"mbe4"},[t("h2",null,"Sizes")],-1)),t("div",ys,[r(F(g),{value:l.value,"onUpdate:value":a[1]||(a[1]=k=>l.value=k),options:s,label:"Small Combobox",size:"small",placeholder:"Small size",class:"mbe2"},null,8,["value"]),r(F(g),{value:u.value,"onUpdate:value":a[2]||(a[2]=k=>u.value=k),options:s,label:"Default Combobox",size:"default",placeholder:"Default size",class:"mbe2"},null,8,["value"]),r(F(g),{value:b.value,"onUpdate:value":a[3]||(a[3]=k=>b.value=k),options:s,label:"Large Combobox",size:"large",placeholder:"Large size",class:"mbe2"},null,8,["value"])]),a[24]||(a[24]=t("div",{class:"mbe4"},[t("h2",null,"Filter Modes")],-1)),t("div",us,[r(F(g),{value:C.value,"onUpdate:value":a[4]||(a[4]=k=>C.value=k),options:s,label:"Starts With Filter","filter-mode":"startsWith",placeholder:"Type to filter...","help-text":"Try typing 'Ca' to see California",class:"mbe2"},null,8,["value"]),r(F(g),{value:m.value,"onUpdate:value":a[5]||(a[5]=k=>m.value=k),options:s,label:"Contains Filter","filter-mode":"contains",placeholder:"Type to search...","help-text":"Try typing 'or' to see multiple matches",class:"mbe2"},null,8,["value"])]),a[25]||(a[25]=t("div",{class:"mbe4"},[t("h2",null,"Clearable")],-1)),t("div",bs,[r(F(g),{value:v.value,"onUpdate:value":a[6]||(a[6]=k=>v.value=k),options:s,label:"Clearable Combobox",clearable:!0,placeholder:"Select and clear...","help-text":"Clear button appears when a value is selected",class:"mbe2"},null,8,["value"]),t("p",Cs,"Selected: "+S(v.value||"None"),1)]),a[26]||(a[26]=t("div",{class:"mbe4"},[t("h2",null,"States")],-1)),t("div",ms,[r(F(g),{value:w.value,"onUpdate:value":a[7]||(a[7]=k=>w.value=k),options:s,label:"Disabled Combobox",disabled:!0,placeholder:"This is disabled",class:"mbe2"},null,8,["value"]),r(F(g),{value:O.value,"onUpdate:value":a[8]||(a[8]=k=>O.value=k),options:s,label:"Readonly Combobox",readonly:!0,placeholder:"This is readonly",class:"mbe2"},null,8,["value"]),r(F(g),{value:n.value,"onUpdate:value":a[9]||(a[9]=k=>n.value=k),options:s,label:"Required Combobox",required:!0,placeholder:"This is required","help-text":"This field is required",class:"mbe2"},null,8,["value"]),r(F(g),{value:c.value,"onUpdate:value":a[10]||(a[10]=k=>c.value=k),options:s,label:"Invalid Combobox",invalid:!0,"error-message":"Please select a valid state",placeholder:"This has an error",class:"mbe2"},null,8,["value"])]),a[27]||(a[27]=t("div",{class:"mbe4"},[t("h2",null,"With Help Text")],-1)),t("div",vs,[r(F(g),{value:_.value,"onUpdate:value":a[11]||(a[11]=k=>_.value=k),options:s,label:"State of Residence",placeholder:"Select your state...","help-text":"Choose the state where you currently reside",class:"mbe2"},null,8,["value"])]),a[28]||(a[28]=t("div",{class:"mbe4"},[t("h2",null,"Loading State")],-1)),t("div",Bs,[r(F(g),{value:P.value,"onUpdate:value":a[12]||(a[12]=k=>P.value=k),options:T.value,label:"Loading Combobox",loading:E.value,"loading-text":"Fetching states...",placeholder:"Loading...",class:"mbe2"},null,8,["value","options","loading"]),t("button",{onClick:ss,class:"btn btn-primary"},S(E.value?"Stop Loading":"Start Loading"),1)]),a[29]||(a[29]=t("div",{class:"mbe4"},[t("h2",null,"With Disabled Options")],-1)),t("div",As,[r(F(g),{value:R.value,"onUpdate:value":a[13]||(a[13]=k=>R.value=k),options:i,label:"Select State",placeholder:"Some options are disabled...","help-text":"Colorado and Florida are disabled",class:"mbe2"},null,8,["value"])]),a[30]||(a[30]=t("div",{class:"mbe4"},[t("h2",null,"Custom No Results Text")],-1)),t("div",Ds,[r(F(g),{value:M.value,"onUpdate:value":a[14]||(a[14]=k=>M.value=k),options:s,label:"Search States",placeholder:"Type to search...","no-results-text":"No states match your search","help-text":"Try typing 'xyz' to see custom no results message",class:"mbe2"},null,8,["value"])]),a[31]||(a[31]=t("div",{class:"mbe4"},[t("h2",null,"Hidden Label")],-1)),t("div",Es,[r(F(g),{value:U.value,"onUpdate:value":a[15]||(a[15]=k=>U.value=k),options:s,label:"State (Hidden)","label-hidden":!0,placeholder:"Label is visually hidden but accessible","help-text":"The label is hidden visually but still accessible to screen readers",class:"mbe2"},null,8,["value"])]),a[32]||(a[32]=t("div",{class:"mbe4"},[t("h2",null,"Monochrome Variant (Single Select)")],-1)),t("div",xs,[r(F(g),{value:W.value,"onUpdate:value":a[16]||(a[16]=k=>W.value=k),options:s,label:"Select State",variant:"monochrome",placeholder:"Choose a state...","help-text":"Monochrome variant with inverted colors for selected items",class:"mbe2"},null,8,["value"])]),a[33]||(a[33]=t("div",{class:"mbe4"},[t("h2",null,"Multiple Select")],-1)),t("div",fs,[r(F(g),{value:I.value,"onUpdate:value":a[17]||(a[17]=k=>I.value=k),options:s,label:"Select States",multiple:!0,"close-on-select":!1,placeholder:"Choose one or more states...","help-text":"Select multiple states with checkboxes",class:"mbe2"},null,8,["value"]),t("p",_s,"Selected: "+S(Array.isArray(I.value)?I.value.join(", "):"None"),1)]),a[34]||(a[34]=t("div",{class:"mbe4"},[t("h2",null,"Multiple with Defaults")],-1)),t("div",qs,[r(F(g),{options:s,label:"Pre-selected States",multiple:!0,"close-on-select":!1,"default-value":["ca","fl"],"help-text":"California and Florida are pre-selected",class:"mbe2"})]),a[35]||(a[35]=t("div",{class:"mbe4"},[t("h2",null,"Multiple Clearable")],-1)),t("div",Ss,[r(F(g),{value:N.value,"onUpdate:value":a[18]||(a[18]=k=>N.value=k),options:s,label:"Select States",multiple:!0,clearable:!0,"close-on-select":!1,placeholder:"Select and clear multiple...","help-text":"Clear button removes all selections",class:"mbe2"},null,8,["value"])]),a[36]||(a[36]=t("div",{class:"mbe4"},[t("h2",null,"Multiple with Max Visible Tags")],-1)),t("div",ws,[r(F(g),{options:s,label:"Select States",multiple:!0,"close-on-select":!1,"default-value":["al","ak","az","ar","ca"],"max-options-visible":2,"help-text":"Shows only 2 tags, with a +3 summary",class:"mbe2"})]),a[37]||(a[37]=t("div",{class:"mbe4"},[t("h2",null,"Multiple Monochrome")],-1)),t("div",Os,[r(F(g),{value:H.value,"onUpdate:value":a[19]||(a[19]=k=>H.value=k),options:s,label:"Select States",multiple:!0,variant:"monochrome","close-on-select":!1,placeholder:"Choose one or more states...","help-text":"Multiple select with monochrome variant",class:"mbe2"},null,8,["value"])]),a[38]||(a[38]=t("div",{class:"mbe4"},[t("h2",null,"Event Handling")],-1)),t("div",Ts,[t("div",Is,[r(F(g),{value:j.value,"onUpdate:value":a[20]||(a[20]=k=>j.value=k),options:s,label:"Event Test",placeholder:"Type or select...",onChange:J,onSelect:Q,onSearch:X,class:"mbe2"},null,8,["value"]),q.value?(z(),V("p",$s,[a[21]||(a[21]=x(" Last event: ",-1)),t("strong",null,S(q.value),1)])):ps("",!0)])]),a[39]||(a[39]=t("div",{class:"mbe4"},[t("h2",null,"External Label Support"),t("p",{class:"mbs2 mbe3"}," The Combobox component supports external labels with helper text, required fields, and validation states. ")],-1)),t("div",Vs,[t("div",zs,[r(F(g),{options:s,label:"Favorite State",name:"favorite",placeholder:"Choose a state..."})]),t("div",Ls,[r(F(g),{options:s,label:"Home State","help-text":"Select the state where you currently reside",name:"home",placeholder:"Choose your home state..."})]),t("div",Ps,[r(F(g),{options:s,label:"Required State",required:!0,"help-text":"This field is required",name:"required",placeholder:"Choose a state..."})]),t("div",Rs,[r(F(g),{options:s,label:"State Selection",required:!0,invalid:!0,"error-message":"Please select a valid state to continue",name:"validation",placeholder:"Choose a state..."})])]),a[40]||(a[40]=t("div",{class:"mbe4"},[t("h2",null,"Label Positioning"),t("p",{class:"mbs2 mbe3"},[x(" Control label position with "),t("code",null,"label-position"),x(": 'top' (default), 'start', 'end', or 'bottom'. "),t("strong",null,"Note:"),x(" 'bottom' is not recommended as the dropdown will cover the label when opened. ")])],-1)),t("div",Ms,[t("div",Us,[r(F(g),{options:s,label:"Top Label (Default)","label-position":"top",name:"pos-top",placeholder:"Choose a state..."})]),t("div",Ws,[r(F(g),{options:s,label:"Start Position","label-position":"start",name:"pos-start",placeholder:"Choose a state..."})]),t("div",Ns,[r(F(g),{options:s,label:"End Position","label-position":"end",name:"pos-end",placeholder:"Choose a state..."})]),t("div",Hs,[r(F(g),{options:s,label:"Bottom Position (Not Recommended)","label-position":"bottom",name:"pos-bottom","help-text":"The dropdown will cover this label when opened",placeholder:"Choose a state..."})])])]))}}),Ys=ks(js,[["__scopeId","data-v-489d8b36"]]),hi=JSON.parse('{"title":"Combobox","description":"","frontmatter":{},"headers":[],"relativePath":"components/combobox.md","filePath":"components/combobox.md"}'),Ks={name:"components/combobox.md"},pi=Object.assign(Ks,{setup(d){return(s,i)=>(z(),V("div",null,[i[0]||(i[0]=t("h1",{id:"combobox",tabindex:"-1"},[x("Combobox "),t("a",{class:"header-anchor",href:"#combobox","aria-label":'Permalink to "Combobox"'},"​")],-1)),r(is),i[1]||(i[1]=t("p",null,"An accessible autocomplete widget that combines a text input with a filterable dropdown list. Perfect for searchable select inputs with keyboard navigation support.",-1)),i[2]||(i[2]=t("h2",{id:"examples",tabindex:"-1"},[x("Examples "),t("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),r(Ys),i[3]||(i[3]=os(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
