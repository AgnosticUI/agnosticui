import{c as B,A as q}from"./chunks/AlphaWarning.D199zhtu.js";import{c as E,i as A,z as k,a as P,x as R,F as M}from"./chunks/FrameworkExample.DQckTML-.js";import{r as W}from"./chunks/motion.styles.CHMp5t9P.js";import{d as w,p as z,c as m,q as L,o as y,r as T,K as I,_ as H,C as h,j as n,G as s,w as t,a,ae as X,k as F}from"./chunks/framework.CdHt8f9T.js";import{u as j}from"./chunks/VueIcon.vue_vue_type_script_setup_true_lang-kC-nzMyu.DgLBNH8W.js";import{B as G}from"./chunks/VueAlert.vue_vue_type_script_setup_true_lang-BSEoqQWL.D4go-3uQ.js";import{p as N}from"./chunks/VueVisuallyHidden.vue_vue_type_script_setup_true_lang-C_9Tq_M2.BD379Jx2.js";import{S as _}from"./chunks/shopping-cart.CscnW6CX.js";import{T as O}from"./chunks/trash-2.DfHjdvMq.js";import{M as $}from"./chunks/mail.vQRIGu8E.js";import"./chunks/Alert.3j4K7z__.js";import"./chunks/CloseButton.B4KJOgyi.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q=B("database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]);var U=Object.defineProperty,x=(l,e,o,p)=>{for(var d=void 0,g=l.length-1,i;g>=0;g--)(i=l[g])&&(d=i(e,o,d)||d);return d&&U(e,o,d),d};const C=class extends E{constructor(){super(),this.fxSpeed="md",this.fxEase="ease",this.fxDisabled=!1}firstUpdated(){this._applyFxClasses(),this._applyFxCustomProperties()}updated(e){super.updated(e),(e.has("fx")||e.has("fxDisabled"))&&this._applyFxClasses(),(e.has("fxSpeed")||e.has("fxEase"))&&this._applyFxCustomProperties()}_applyFxClasses(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("button");e&&(e.classList.forEach(p=>{p.startsWith("ag-fx-")&&e.classList.remove(p)}),this.fx&&e.classList.add(`ag-fx-${this.fx}`),this.fxDisabled&&e.classList.add("ag-fx-disabled"))}_applyFxCustomProperties(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("button");e instanceof HTMLElement&&(e.style.setProperty("--ag-fx-duration",`var(--ag-fx-duration-${this.fxSpeed})`),e.style.setProperty("--ag-fx-ease",`var(--ag-fx-ease-${this.fxEase})`))}};C.styles=[W,E.styles,A`
      /* ========================================
...
`,qe=JSON.parse('{"title":"ButtonFx","description":"","frontmatter":{},"headers":[],"relativePath":"components/button-fx.md","filePath":"components/button-fx.md"}'),ke={name:"components/button-fx.md"},Ae=Object.assign(ke,{setup(l){return(e,o)=>(y(),m("div",null,[o[1]||(o[1]=n("h1",{id:"buttonfx",tabindex:"-1"},[a("ButtonFx "),n("a",{class:"header-anchor",href:"#buttonfx","aria-label":'Permalink to "ButtonFx"'},"​")],-1)),s(q),o[2]||(o[2]=n("p",null,"An enhanced button component with customizable animation effects that trigger on hover, click, or mount. ButtonFx extends the base Button component with a rich set of visual effects to create engaging, interactive UI elements.",-1)),o[3]||(o[3]=n("div",{class:"info custom-block"},[n("p",{class:"custom-block-title"},"Opt-in Component"),n("p",null,"ButtonFx adds a few hundred lines of CSS for animation effects. It's ideal for marketing sites, landing pages, or when visual polish is a priority.")],-1)),s(M,{component:"button-fx","vue-code":F(ge),"lit-code":F(ce),"react-code":F(fe)},{vue:t(()=>[s(he)]),lit:t(()=>[...o[0]||(o[0]=[n("buttonfx-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),o[4]||(o[4]=X(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
