import{A as f}from"./chunks/AlphaWarning.BeGEOyJF.js";import{i as A,a as m,x as u}from"./chunks/lit-element.B0TUrqGF.js";import{z as d}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{d as b,c as o,o as F,r as x,af as E,ag as w,_ as D,j as a,ae as C,G as k,a as h,w as y,k as r}from"./chunks/framework.DvJW1jwp.js";import{F as B}from"./chunks/FrameworkExample.mrNIqbEI.js";import"./chunks/VueTabPanel.vue_vue_type_script_setup_true_lang-BnQoc7fo.DSmE4LP6.js";import"./chunks/state-CovhUvdr.BllWkzJh.js";import"./chunks/unique-id.CpwMFgRD.js";import"./chunks/Button.CXY3ONNo.js";import"./chunks/if-defined-C8i28hSj.CfeO1FY9.js";import"./chunks/Icon.B28p3PBb.js";import"./chunks/zap.BjY0_zCO.js";var R=Object.defineProperty,c=(e,t,s,p)=>{for(var i=void 0,n=e.length-1,g;n>=0;n--)(g=e[n])&&(i=g(t,s,i)||i);return i&&R(t,s,i),i};const v=class extends m{constructor(){super(),this.width=1,this.height=1,this.maxWidth=void 0}get _aspectStyle(){const t=this.width||1,s=this.height||1,p=`${t} / ${s}`,i=[];return i.push(`aspect-ratio: ${p};`),this.maxWidth!==void 0&&this.maxWidth!==null&&(i.push(`max-inline-size: ${this.maxWidth}px;`),i.push("margin-inline-start: auto; margin-inline-end: auto;")),i.join(" ")}render(){return u`
...
`,Y=JSON.parse('{"title":"Aspect Ratio","description":"","frontmatter":{"title":"Aspect Ratio"},"headers":[],"relativePath":"components/aspect-ratio.md","filePath":"components/aspect-ratio.md"}'),N={name:"components/aspect-ratio.md"},Z=Object.assign(N,{setup(e){return(t,s)=>(F(),o("div",null,[s[1]||(s[1]=a("h1",{id:"aspect-ratio",tabindex:"-1"},[h("Aspect Ratio "),a("a",{class:"header-anchor",href:"#aspect-ratio","aria-label":'Permalink to "Aspect Ratio"'},"​")],-1)),k(f),s[2]||(s[2]=a("p",null,[h("The AgnosticUI AspectRatio component provides an easy, modern way to reserve space for embedded content (videos, iframes, third-party widgets) while preserving a given aspect ratio. It leverages the native CSS "),a("code",null,"aspect-ratio"),h(" property and exposes a simple API.")],-1)),s[3]||(s[3]=a("h2",{id:"examples",tabindex:"-1"},[h("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),k(B,{component:"aspect-ratio","vue-code":r(P),"lit-code":r(T),"react-code":r(V)},{vue:y(()=>[k(j)]),lit:y(()=>[...s[0]||(s[0]=[a("aspect-ratio-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),s[4]||(s[4]=C(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
