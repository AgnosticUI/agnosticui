...
`,S=JSON.parse('{"title":"VisuallyHidden","description":"","frontmatter":{"title":"VisuallyHidden"},"headers":[],"relativePath":"components/visually-hidden.md","filePath":"components/visually-hidden.md"}'),L={name:"components/visually-hidden.md"},R=Object.assign(L,{setup(a){return(c,e)=>(r(),d("div",null,[e[1]||(e[1]=n("h1",{id:"visuallyhidden",tabindex:"-1"},[t("VisuallyHidden "),n("a",{class:"header-anchor",href:"#visuallyhidden","aria-label":'Permalink to "VisuallyHidden"'},"​")],-1)),i(u),e[2]||(e[2]=n("p",null,[t("A utility component to visually hide content while keeping it accessible to screen readers. This is a common pattern for accessibility, often implemented with a CSS class like "),n("code",null,".sr-only"),t(" or "),n("code",null,".visually-hidden"),t(". This component provides a declarative way to achieve the same result.")],-1)),i(v,{component:"visually-hidden","vue-code":s(V),"lit-code":s(H),"react-code":s(C)},{vue:l(()=>[i(f)]),lit:l(()=>[...e[0]||(e[0]=[n("visually-hidden-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),e[3]||(e[3]=p('<h2 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;Props&quot;">​</a></h2><p>This component does not have any props. It simply wraps the content you provide to it in the default slot.</p><h2 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-label="Permalink to &quot;Events&quot;">​</a></h2><p>This component does not emit any events.</p><h2 id="accessibility" tabindex="-1">Accessibility <a class="header-anchor" href="#accessibility" aria-label="Permalink to &quot;Accessibility&quot;">​</a></h2><p>The <code>VisuallyHidden</code> component is an accessibility utility. It helps provide context to screen reader users that might be visually apparent to sighted users. A common use case is providing a text label for an icon-only button. The content remains in the accessibility tree and can be read by assistive technologies, but it is positioned off-screen so it is not visible.</p>',6))]))}});export{S as __pageData,R as default};
