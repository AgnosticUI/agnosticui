...
`,X=JSON.parse('{"title":"Progress","description":"","frontmatter":{},"headers":[],"relativePath":"components/progress.md","filePath":"components/progress.md"}'),W={name:"components/progress.md"},Y=Object.assign(W,{setup(e){return(s,a)=>(k(),r("div",null,[a[1]||(a[1]=i("h1",{id:"progress",tabindex:"-1"},[t("Progress "),i("a",{class:"header-anchor",href:"#progress","aria-label":'Permalink to "Progress"'},"​")],-1)),n(c),a[2]||(a[2]=i("p",null,"A progress component is used to display the progress of a task. It can show determinate progress (with a specific value) or indeterminate progress (loading state without a known duration).",-1)),a[3]||(a[3]=i("h2",{id:"examples",tabindex:"-1"},[t("Examples "),i("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),n(D,{component:"progress","vue-code":h(_),"lit-code":h($),"react-code":h(M)},{vue:o(()=>[n(U)]),lit:o(()=>[...a[0]||(a[0]=[i("progress-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[4]||(a[4]=P("",38))]))}});export{X as __pageData,Y as default};
