import{c as b,A as H}from"./chunks/AlphaWarning.BkRV4LZN.js";import{i as m,a as f,x as r}from"./chunks/lit-element.B0TUrqGF.js";import{t as P}from"./chunks/unique-id.CpwMFgRD.js";import{d as E,p as v,c as y,v as B,x as D,o as u,r as C,K as I,_ as S,C as g,j as n,G as i,w as a,a as e,ae as M}from"./chunks/framework.BoyT2Jkt.js";import{I as $}from"./chunks/info.D6aSxJKp.js";/**
 ...
 */const X=b("code",[["path",{d:"m16 18 6-6-6-6",key:"eg8j8"}],["path",{d:"m8 6-6 6 6 6",key:"ppft3o"}]]),R=class extends f{render(){return r`
  ...
  `];const A=class extends f{constructor(){super(),this._id=P("accordion-item"),this.open=!1,this.headingLevel=3,this.disabled=!1,this.bordered=!1,this.background=!1,this.useChevron=!0,this.useX=!1,this.useMinus=!1,this.noIndicator=!1,this.addEventListener("keydown",this._handleKeydown.bind(this))}connectedCallback(){super.connectedCallback(),this.setAttribute("data-enhanced","")}render(){return r`
    ...
    `;switch(Math.max(1,Math.min(6,this.headingLevel||3))){case 1:return r`<h1 class="heading" part="ag-accordion-heading">${s}</h1>`;case 2:return r`<h2 class="heading" part="ag-accordion-heading">${s}</h2>`;case 3:return r`<h3 class="heading" part="ag-accordion-heading">${s}</h3>`;case 4:return r`<h4 class="heading" part="ag-accordion-heading">${s}</h4>`;case 5:return r`<h5 class="heading" part="ag-accordion-heading">${s}</h5>`;case 6:return r`<h6 class="heading" part="ag-accordion-heading">${s}</h6>`}}toggle(){if(this.disabled)return;this.open=!this.open;const s=new CustomEvent("toggle",{detail:{open:this.open},bubbles:!0,composed:!0});this.dispatchEvent(s),this.onToggle&&this.onToggle(s)}focus(){var s,h;(h=(s=this.shadowRoot)==null?void 0:s.querySelector("button"))==null||h.focus()}get buttonElement(){var s;return((s=this.shadowRoot)==null?void 0:s.querySelector("button"))||null}_handleKeydown(s){if(this.disabled)return;const{key:h}=s;(h==="Enter"||h===" ")&&s.target===this.buttonElement&&(s.preventDefault(),this.toggle()),(h==="ArrowDown"||h==="ArrowUp"||h==="Home"||h==="End")&&(s.preventDefault(),this.dispatchEvent(new CustomEvent("accordion-keydown",{detail:{key:h,accordionItem:this},bubbles:!0})))}};A.properties={open:{type:Boolean,reflect:!0},headingLevel:{type:Number,reflect:!0,attribute:"heading-level"},disabled:{type:Boolean,reflect:!0},bordered:{type:Boolean,reflect:!0},background:{type:Boolean,reflect:!0},useChevron:{type:Boolean,reflect:!0,attribute:"use-chevron"},useX:{type:Boolean,reflect:!0,attribute:"use-x"},useMinus:{type:Boolean,reflect:!0,attribute:"use-minus"},noIndicator:{type:Boolean,reflect:!0,attribute:"no-indicator"},onToggle:{attribute:!1}},A.styles=[m`
    :host {
      display: block;
    }
    .header {
