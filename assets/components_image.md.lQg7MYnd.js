var H=Object.defineProperty;var J=(i,a,t)=>a in i?H(i,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[a]=t;var v=(i,a,t)=>J(i,typeof a!="symbol"?a+"":a,t);import{A as Q}from"./chunks/AlphaWarning.yC7ZufpQ.js";import{i as L,z as d,a as V,E as F,x as u}from"./chunks/Button.DkmThuAs.js";import{n as S}from"./chunks/state-CovhUvdr.CfYrM0Q-.js";import{d as O,c as B,o as A,r as I,K as X,p as k,j as e,G as h,a as w,k as p,w as y,ae as R}from"./chunks/framework.NAAYCHZu.js";import{m as ss}from"./chunks/VueIcon.vue_vue_type_script_setup_true_lang-C2Sky3bU.S7_3w1vO.js";import{T as es}from"./chunks/triangle-alert.DhPqtk12.js";import{F as as}from"./chunks/FrameworkExample.Z9eaTrCu.js";import"./chunks/Icon.BC5ob6Nk.js";import"./chunks/createLucideIcon.B61Wqv9x.js";import"./chunks/sdk.m.DhOmSlC9.js";var is=Object.defineProperty,l=(i,a,t,c)=>{for(var r=void 0,o=i.length-1,g;o>=0;o--)(g=i[o])&&(r=g(a,t,r)||r);return r&&is(a,t,r),r};const W=class extends V{constructor(){super(),this._handleLoad=()=>{this._loaded=!0,this._errored=!1,this.dispatchEvent(new CustomEvent("ag-load",{bubbles:!0,composed:!0}))},this._handleError=()=>{if(this._loaded=!1,this._errored=!0,this.fallbackSrc&&this._currentSrc!==this.fallbackSrc){this._currentSrc=this.fallbackSrc;return}this.dispatchEvent(new CustomEvent("ag-error",{bubbles:!0,composed:!0}))},this.src="",this.alt="",this.sources=[],this.fit="cover",this.position="center",this.loading="lazy",this.fade=!1,this.duration=200,this._loaded=!1,this._errored=!1,this._currentSrc=""}willUpdate(a){super.willUpdate(a),a.has("fit")&&this.style.setProperty("--ag-image-fit",this.fit),a.has("position")&&this.style.setProperty("--ag-image-position",this.position),a.has("width")&&(this.style.width=this.width!=null?`${this.width}px`:""),a.has("height")&&(this.style.height=this.height!=null?`${this.height}px`:""),(a.has("aspectRatio")||a.has("width")||a.has("height"))&&(this.aspectRatio?this.style.aspectRatio=this.aspectRatio:this.width!=null&&this.height!=null?this.style.aspectRatio=`${this.width} / ${this.height}`:this.style.aspectRatio=""),a.has("src")&&a.get("src")!==this.src&&(this._loaded=!1,this._errored=!1,this._currentSrc=this.src)}_renderImage(){const a=this._errored&&this.fallbackSrc?this.fallbackSrc:this._currentSrc;return u`
  ...
  `;let n=W;l([d({type:String})],n.prototype,"src");l([d({type:String})],n.prototype,"alt");l([d({type:Array})],n.prototype,"sources");l([d({type:Number})],n.prototype,"width");l([d({type:Number})],n.prototype,"height");l([d({type:String,attribute:"aspect-ratio"})],n.prototype,"aspectRatio");l([d({type:String})],n.prototype,"fit");l([d({type:String})],n.prototype,"position");l([d({type:String})],n.prototype,"loading");l([d({type:Boolean,reflect:!0})],n.prototype,"fade");l([d({type:Number})],n.prototype,"duration");l([d({type:String,attribute:"fallback-src"})],n.prototype,"fallbackSrc");l([S()],n.prototype,"_loaded");l([S()],n.prototype,"_errored");l([S()],n.prototype,"_currentSrc");customElements.get("ag-image")||customElements.define("ag-image",n);const ts=["src","alt","width","height","aspect-ratio","fit","position","loading",".fade","duration","fallback-src"],m=O({__name:"VueImage",props:{sources:{},src:{default:""},alt:{default:""},width:{},height:{},aspectRatio:{},fit:{default:"cover"},position:{default:"center"},loading:{default:"lazy"},fade:{type:Boolean,default:!1},duration:{default:200},fallbackSrc:{}},emits:["ag-load","ag-error"],setup(i,{emit:a}){const t=a,c=o=>{t("ag-load")},r=o=>{t("ag-error")};return(o,g)=>(A(),B("ag-image",X({src:i.src,alt:i.alt,width:i.width,height:i.height,"aspect-ratio":i.aspectRatio,fit:i.fit,position:i.position,loading:i.loading,".fade":i.fade,duration:i.duration,"fallback-src":i.fallbackSrc,onAgLoad:c,onAgError:r},o.$attrs),[I(o.$slots,"placeholder",{slot:"placeholder"}),I(o.$slots,"error",{slot:"error"}),I(o.$slots,"default")],48,ts))}}),ns={class:"image-examples-container"},os={class:"responsive-image-container"},ls={class:"contain-fit-container"},rs={class:"responsive-image-container"},hs={class:"responsive-image-container"},ps={slot:"error",class:"custom-error"},ds={class:"error-icon"},cs={class:"responsive-image-container"},$="https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=545&h=487&fit=crop&q=80",U="https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200&h=800&fit=crop&q=80",T="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=545&h=487&fit=crop&q=80",j="https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=545&h=487&fit=crop&q=80",P="https://thissourcedoesnotexist.com/image.jpg",z="https://images.unsplash.com/photo-1426604966848-d7adac402bff?w=545&h=487&fit=crop&q=80&auto=format&ps=50",N="https://thissourcedoesnotexist.com/another-broken-image.jpg",_="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=545&h=487&fit=crop&q=80",gs=O({__name:"ImageExamples",setup(i){const a=k($),t=()=>{a.value=`${$}&t=${new Date().getTime()}`},c=k(U),r=()=>{c.value=`${U}&t=${new Date().getTime()}`},o=k(T),g=()=>{o.value=`${T}&t=${new Date().getTime()}`},b=k(j),f=()=>{b.value=`${j}&t=${new Date().getTime()}`},M=[{srcset:"https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=1400&h=787&fit=crop&q=80",media:"(min-width: 1024px)"},{srcset:"https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=1000&h=562&fit=crop&q=80",media:"(min-width: 768px)"}],x=k(P),Z=()=>{x.value=`${P}?t=${new Date().getTime()}`},q=k(z),K=()=>{q.value=`${z}&t=${new Date().getTime()}`},D=k(N),Y=()=>{D.value=`${N}?t=${new Date().getTime()}`},E=k(_),G=()=>{E.value=`${_}&t=${new Date().getTime()}`};return(ys,s)=>(A(),B("div",ns,[s[2]||(s[2]=e("h2",null,"Basic Image",-1)),s[3]||(s[3]=e("p",null,[w("A standard image with a `src` and `alt` tag. This example also has the "),e("code",null,"fade"),w(" prop enabled. Click the button to reload the image and see the effect.")],-1)),h(p(m),{src:a.value,alt:"A beautiful landscape with a river and mountains.",width:545,height:487,fade:!0,style:{"max-width":"100%",height:"auto"}},null,8,["src"]),e("button",{onClick:t,class:"reload-button"},"Reload Image"),s[4]||(s[4]=e("hr",null,null,-1)),s[5]||(s[5]=e("h2",null,"Responsive Image (No Layout Shift)",-1)),s[6]||(s[6]=e("p",null," By omitting `width` and `height` props and providing `aspectRatio`, the image becomes responsive while preventing content layout shift. Fade is also enabled here. ",-1)),e("div",os,[h(p(m),{src:c.value,alt:"A forest path leading to a mountain.",aspectRatio:"16/9",fade:!0},null,8,["src"])]),e("button",{onClick:r,class:"reload-button"},"Reload Image"),s[7]||(s[7]=e("hr",null,null,-1)),s[8]||(s[8]=e("h2",null,"Object Fit: Contain",-1)),s[9]||(s[9]=e("p",null,'Use `fit="contain"` to ensure the entire image is visible within its container without being cropped.',-1)),e("div",ls,[h(p(m),{src:o.value,alt:"A dense forest with sunlight filtering through.",aspectRatio:"4/3",fit:"contain",fade:!0},null,8,["src"])]),e("button",{onClick:g,class:"reload-button"},"Reload Image"),s[10]||(s[10]=e("hr",null,null,-1)),s[11]||(s[11]=e("h2",null,"Responsive Sources with <picture>",-1)),s[12]||(s[12]=e("p",null,"Provide different images for different screen sizes using the `sources` prop. Resize your browser to see the image change.",-1)),e("div",rs,[h(p(m),{src:b.value,alt:"A responsive landscape that changes with screen size.",aspectRatio:"16/9",sources:M,fade:!0},null,8,["src"])]),e("button",{onClick:f,class:"reload-button"},"Reload Image"),s[13]||(s[13]=e("hr",null,null,-1)),s[14]||(s[14]=e("h2",null,"Fallback Source",-1)),s[15]||(s[15]=e("p",null,"If the primary `src` is broken, the `fallbackSrc` will be loaded instead. The fallback will also fade in.",-1)),h(p(m),{src:x.value,fallbackSrc:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=545&h=487&fit=crop&q=80",alt:"An image with a fallback source.",width:545,height:487,fade:!0,style:{"max-width":"100%",height:"auto"}},null,8,["src"]),e("button",{onClick:Z,class:"reload-button"},"Reload Image"),s[16]||(s[16]=e("hr",null,null,-1)),s[17]||(s[17]=e("h2",null,"Custom Placeholder Slot",-1)),s[18]||(s[18]=e("p",null,"Provide custom content to be displayed while the image is loading.",-1)),h(p(m),{src:q.value,alt:"A nature scene with a custom placeholder.",width:545,height:487,style:{"max-width":"100%",height:"auto"}},{default:y(()=>[...s[0]||(s[0]=[e("div",{slot:"placeholder",class:"custom-placeholder"},[e("div",{class:"placeholder-icon"},"📷"),e("div",null,"Loading beautiful scenery...")],-1)])]),_:1},8,["src"]),e("button",{onClick:K,class:"reload-button"},"Reload Image"),s[19]||(s[19]=e("hr",null,null,-1)),s[20]||(s[20]=e("h2",null,"Custom Error Slot",-1)),s[21]||(s[21]=e("p",null,"Display a custom message or UI when an image fails to load.",-1)),e("div",hs,[h(p(m),{src:D.value,alt:"An image with a custom error message.",aspectRatio:"4/3",style:{width:"100%"}},{default:y(()=>[e("div",ps,[e("div",ds,[h(p(ss),{size:"64",type:"error",noFill:!0},{default:y(()=>[h(p(es))]),_:1})]),s[1]||(s[1]=e("h2",{style:{"margin-top":"0"}},"Oops! The image could not be loaded.",-1))])]),_:1},8,["src"])]),e("button",{onClick:Y,class:"reload-button"},"Reload Image"),s[22]||(s[22]=e("hr",null,null,-1)),s[23]||(s[23]=e("h2",null,"Styled with CSS Class and Parts",-1)),s[24]||(s[24]=e("p",null,"Use a CSS class to apply custom styles to the component, including its internal parts like `::part(ag-img)`.",-1)),e("div",cs,[h(p(m),{class:"custom-styled-image",src:E.value,alt:"A landscape with a custom border style.",aspectRatio:"4/3",fade:!0},null,8,["src"])]),e("button",{onClick:G,class:"reload-button"},"Reload Image")]))}});class C extends V{createRenderRoot(){return this}constructor(){super();const a="https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=545&h=487&fit=crop&q=80",t="https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200&h=800&fit=crop&q=80",c="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=545&h=487&fit=crop&q=80",r="https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=545&h=487&fit=crop&q=80",o="https://thissourcedoesnotexist.com/image.jpg",g="https://images.unsplash.com/photo-1426604966848-d7adac402bff?w=545&h=487&fit=crop&q=80&auto=format&ps=50",b="https://thissourcedoesnotexist.com/another-broken-image.jpg",f="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=545&h=487&fit=crop&q=80";this.basicImageSrc=a,this.responsiveImageSrc=t,this.objectFitImageSrc=c,this.responsiveSourcesImageSrc=r,this.fallbackImageSrc=o,this.placeholderImageSrc=g,this.errorImageSrc=b,this.styledImageSrc=f,this.basicImageUrl=a,this.responsiveImageUrl=t,this.objectFitImageUrl=c,this.responsiveSourcesImageUrl=r,this.placeholderImageUrl=g,this.styledImageUrl=f}reloadBasicImage(){this.basicImageSrc=`${this.basicImageUrl}&t=${new Date().getTime()}`}reloadResponsiveImage(){this.responsiveImageSrc=`${this.responsiveImageUrl}&t=${new Date().getTime()}`}reloadObjectFitImage(){this.objectFitImageSrc=`${this.objectFitImageUrl}&t=${new Date().getTime()}`}reloadResponsiveSourcesImage(){this.responsiveSourcesImageSrc=`${this.responsiveSourcesImageUrl}&t=${new Date().getTime()}`}reloadFallbackImage(){this.fallbackImageSrc=`https://thissourcedoesnotexist.com/image.jpg?t=${new Date().getTime()}`}reloadPlaceholderImage(){this.placeholderImageSrc=`${this.placeholderImageUrl}&t=${new Date().getTime()}`}reloadErrorImage(){this.errorImageSrc=`https://thissourcedoesnotexist.com/another-broken-image.jpg?t=${new Date().getTime()}`}reloadStyledImage(){this.styledImageSrc=`${this.styledImageUrl}&t=${new Date().getTime()}`}render(){const a=[{srcset:"https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=1400&h=787&fit=crop&q=80",media:"(min-width: 1024px)"},{srcset:"https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=1000&h=562&fit=crop&q=80",media:"(min-width: 768px)"}];return u`
...
`,Es=JSON.parse('{"title":"Image","description":"","frontmatter":{"title":"Image"},"headers":[],"relativePath":"components/image.md","filePath":"components/image.md"}'),Fs={name:"components/image.md"},Rs=Object.assign(Fs,{setup(i){return(a,t)=>(A(),B("div",null,[t[1]||(t[1]=e("h1",{id:"image",tabindex:"-1"},[w("Image "),e("a",{class:"header-anchor",href:"#image","aria-label":'Permalink to "Image"'},"​")],-1)),h(Q),t[2]||(t[2]=R('<p>The AgnosticUI Image component is a powerful, performant replacement for the native <code>&lt;img&gt;</code> tag. It intelligently adapts to your needs: provide a simple <code>src</code> to render an <code>&lt;img&gt;</code>, or add a <code>sources</code> prop to automatically generate a responsive <code>&lt;picture&gt;</code> element.</p><p>Beyond its flexibility, it provides built-in solutions for common image-handling challenges, including responsive sizing, preventing layout shift, lazy loading, and graceful error handling.</p><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-label="Permalink to &quot;Examples&quot;">​</a></h2>',3)),h(as,{component:"image","vue-code":p(ks),"lit-code":p(ms),"react-code":p(us)},{vue:y(()=>[h(gs)]),lit:y(()=>[...t[0]||(t[0]=[e("image-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),t[3]||(t[3]=R(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
