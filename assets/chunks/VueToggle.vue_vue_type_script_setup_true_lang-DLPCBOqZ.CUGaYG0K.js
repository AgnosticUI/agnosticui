import{a as v,x as d,Q as p,i as y,z as l}from"./Button.CfALiVhd.js";import{i as f,t as u,u as _,a as m}from"./form-control-utils.DiC9dPVW.js";import{c as k}from"./face-mixin.D58DBW-D.js";import{d as x,p as $,c as w,q as z,o as I,K as S}from"./framework.BZTe5Kj6.js";var T=Object.defineProperty,s=(t,e,a,r)=>{for(var o=void 0,h=t.length-1,g;h>=0;h--)(g=t[h])&&(o=g(e,a,o)||o);return o&&T(e,a,o),o};const b=class extends k(v){constructor(){super(),this._toggleId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this._handleClick=a=>{this.onClick&&this.onClick(a),this._performToggle(a)},this._handleKeydown=a=>{(a.key===" "||a.key==="Enter")&&(a.preventDefault(),this._performToggle(a))},this._performToggle=a=>{if(this.disabled||this.readonly){a.preventDefault();return}this.checked=!this.checked,this._internals.setFormValue(this.checked?this.value||"on":null),this._syncValidity(),this._syncStates();const r=new CustomEvent("toggle-change",{detail:{checked:this.checked,name:this.name,value:this.value},bubbles:!0,composed:!0});this.dispatchEvent(r),this.onToggleChange&&this.onToggleChange(r)};const e=f("toggle");this._toggleId=e.inputId,this._labelId=e.labelId,this._helperId=e.helperId,this._errorId=e.errorId,this.label="",this.labelHidden=!1,this.noLabel=!1,this.checked=!1,this.size="md",this.variant="default",this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.value="",this.validationMessages=void 0}formResetCallback(){this.checked=!1,this._internals.setFormValue(null),this._internals.setValidity({}),this._syncStates()}formStateRestoreCallback(e,a){this.checked=e!==null,this._internals.setFormValue(this.checked?this.value||"on":null),this._syncValidity(),this._syncStates()}_syncValidity(){var e;this.required&&!this.checked?this._internals.setValidity({valueMissing:!0},((e=this.validationMessages)==null?void 0:e.valueMissing)??"Please check this field."):this._internals.setValidity({})}_syncStates(){this._setState("checked",this.checked),this._setState("disabled",this.disabled),this._setState("readonly",this.readonly),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}updated(e){super.updated(e),(e.has("disabled")||e.has("readonly"))&&this._syncStates()}firstUpdated(){this._internals.setFormValue(this.checked?this.value||"on":null),this._syncValidity(),this._syncStates(),!this.label&&!this.noLabel&&console.warn("AgToggle: label property is required for accessibility.")}renderLabel(){if(!this.label||this.noLabel)return"";const e=[];return u(this.labelPosition)?(e.push("ag-form-control__label--horizontal"),e.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&e.push(`ag-form-control__label--${this.labelPosition}`),d`
    ...
    `}render(){const e=_({helperId:this._helperId,errorId:this._errorId,hasHelper:!!this.helpText&&!this.invalid,hasError:!!this.invalid&&!!this.errorMessage}),a=this.helpText&&!this.invalid?d`<div class="ag-form-control__helper" id="${this._helperId}">
          ${this.helpText}
  ...
  `];let i=b;s([l({type:String})],i.prototype,"label");s([l({type:String,attribute:"label-position"})],i.prototype,"labelPosition");s([l({type:Boolean,attribute:"label-hidden"})],i.prototype,"labelHidden");s([l({type:Boolean,attribute:"no-label"})],i.prototype,"noLabel");s([l({type:Boolean,reflect:!0})],i.prototype,"checked");s([l({type:String,reflect:!0})],i.prototype,"size");s([l({type:String,reflect:!0})],i.prototype,"variant");s([l({type:Boolean,reflect:!0})],i.prototype,"disabled");s([l({type:Boolean,reflect:!0})],i.prototype,"readonly");s([l({type:Boolean,reflect:!0})],i.prototype,"required");s([l({type:Boolean,reflect:!0})],i.prototype,"invalid");s([l({type:String,attribute:"error-message"})],i.prototype,"errorMessage");s([l({type:String,attribute:"help-text"})],i.prototype,"helpText");s([l({type:String})],i.prototype,"value");s([l({attribute:!1})],i.prototype,"onClick");s([l({attribute:!1})],i.prototype,"validationMessages");s([l({attribute:!1})],i.prototype,"onToggleChange");customElements.get("ag-toggle")||customElements.define("ag-toggle",i);const M=["label",".labelPosition",".labelHidden",".noLabel","size","variant",".checked",".disabled",".readonly",".required",".invalid","errorMessage","helpText","name","value",".validationMessages"],V=x({__name:"VueToggle",props:{label:{},labelPosition:{default:"top"},labelHidden:{type:Boolean,default:!1},noLabel:{type:Boolean,default:!1},checked:{type:Boolean,default:!1},size:{default:"md"},variant:{default:"default"},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},required:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},errorMessage:{default:""},helpText:{default:""},name:{},value:{},validationMessages:{}},emits:["click","toggle-change","update:checked"],setup(t,{emit:e}){const a=t,r=e,o=$(),h=n=>{r("click",n)},g=n=>{const c=n;r("toggle-change",c.detail),r("update:checked",c.detail.checked)};return z(()=>a.checked,n=>{o.value&&o.value.checked!==n&&(o.value.checked=n)}),(n,c)=>(I(),w("ag-toggle",S({ref_key:"toggleRef",ref:o,label:t.label,".labelPosition":t.labelPosition,".labelHidden":t.labelHidden,".noLabel":t.noLabel,size:t.size,variant:t.variant,".checked":t.checked,".disabled":t.disabled,".readonly":t.readonly,".required":t.required,".invalid":t.invalid,errorMessage:t.errorMessage,helpText:t.helpText,name:t.name,value:t.value,".validationMessages":t.validationMessages,onClick:h,onToggleChange:g},n.$attrs),null,48,M))}});export{V as m};
