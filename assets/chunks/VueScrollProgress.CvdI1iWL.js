import{a as g,i as p,x as c,z as a}from"./property-CemaeiRl.Cea_q1B7.js";import"./Progress.B2H-2Q05.js";import"./ProgressRing.DojbIVdj.js";import"./Badge.NomNrVJa.js";import{s as h}from"./plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as u,c as m,o as b,r as f,K as y,p as _,v as S,P as v,s as z}from"./framework.DmF2n0Fc.js";var w=Object.defineProperty,l=(r,e,i,t)=>{for(var s=void 0,o=r.length-1,d;o>=0;o--)(d=r[o])&&(s=d(e,i,s)||s);return s&&w(e,i,s),s};class n extends g{constructor(){super(),this._scrollPercent=0,this._scrollHandler=this._handleScroll.bind(this),this._resizeHandler=this._handleScroll.bind(this),this.mode="bar",this.target=null,this.orientation="top",this.dots=5,this.badgeVariant="info",this.ringSize=32,this.ringStrokeWidth=3,this.ringVariant="info",this.precision=0}static get styles(){return p`
      :host {
        display: block;
      }
