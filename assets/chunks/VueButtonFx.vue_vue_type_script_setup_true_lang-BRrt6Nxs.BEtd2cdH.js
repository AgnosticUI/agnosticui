import{t as p}from"./Button.BmTmCFep.js";import{i as h,z as f}from"./property-CemaeiRl.Cea_q1B7.js";import{r as v}from"./motion.styles.DXtlED6G.js";import{d as c,p as m,c as w,q as y,o as k,r as S,K as E}from"./framework.DmF2n0Fc.js";var B=Object.defineProperty,l=(a,e,o,r)=>{for(var s=void 0,n=a.length-1,d;n>=0;n--)(d=a[n])&&(s=d(e,o,s)||s);return s&&B(e,o,s),s};const u=class extends p{constructor(){super(),this.fxSpeed="md",this.fxEase="ease",this.fxDisabled=!1}firstUpdated(){this._applyFxClasses(),this._applyFxCustomProperties()}updated(e){super.updated(e),(e.has("fx")||e.has("fxDisabled"))&&this._applyFxClasses(),(e.has("fxSpeed")||e.has("fxEase"))&&this._applyFxCustomProperties()}_applyFxClasses(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("button");e&&(e.classList.forEach(r=>{r.startsWith("ag-fx-")&&e.classList.remove(r)}),this.fx&&e.classList.add(`ag-fx-${this.fx}`),this.fxDisabled&&e.classList.add("ag-fx-disabled"))}_applyFxCustomProperties(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("button");e instanceof HTMLElement&&(e.style.setProperty("--ag-fx-duration",`var(--ag-fx-duration-${this.fxSpeed})`),e.style.setProperty("--ag-fx-ease",`var(--ag-fx-ease-${this.fxEase})`))}};u.styles=[v,p.styles,h`
      /* ========================================
    ...
    `];let i=u;l([f({type:String,reflect:!0})],i.prototype,"fx");l([f({type:String,attribute:"fx-speed"})],i.prototype,"fxSpeed");l([f({type:String,attribute:"fx-ease"})],i.prototype,"fxEase");l([f({type:Boolean,reflect:!0,attribute:"fx-disabled"})],i.prototype,"fxDisabled");customElements.get("ag-button-fx")||customElements.define("ag-button-fx",i);const F=[".disabled",".loading",".toggle",".pressed",".bordered",".ghost",".link",".grouped",".ariaLabel",".fx",".fxDisabled","type","variant","size","shape","fx-speed","fx-ease"],_=c({__name:"VueButtonFx",props:{variant:{default:""},size:{default:"md"},shape:{default:""},bordered:{type:Boolean,default:!1},ghost:{type:Boolean,default:!1},link:{type:Boolean,default:!1},grouped:{type:Boolean,default:!1},fullWidth:{type:Boolean},type:{default:"button"},disabled:{type:Boolean,default:!1},loading:{type:Boolean,default:!1},toggle:{type:Boolean,default:!1},pressed:{type:Boolean,default:!1},ariaLabel:{default:""},fx:{},fxSpeed:{default:"md"},fxEase:{default:"ease"},fxDisabled:{type:Boolean,default:!1}},emits:["click","focus","blur","toggle","update:pressed"],setup(a,{emit:e}){const o=a,r=e,s=m(),n=t=>{r("click",t)},d=t=>{r("focus",t)},x=t=>{r("blur",t)},b=t=>{const g=t;r("toggle",g.detail),r("update:pressed",g.detail.pressed)};return y(()=>o.pressed,t=>{s.value&&o.toggle&&(s.value.pressed=t)}),(t,g)=>(k(),w("ag-button-fx",E({ref_key:"buttonFxRef",ref:s,".disabled":a.disabled,".loading":a.loading,".toggle":a.toggle,".pressed":a.pressed,".bordered":a.bordered,".ghost":a.ghost,".link":a.link,".grouped":a.grouped,".ariaLabel":a.ariaLabel,".fx":a.fx,".fxDisabled":a.fxDisabled,type:a.type,variant:a.variant,size:a.size,shape:a.shape,"fx-speed":a.fxSpeed,"fx-ease":a.fxEase,onClick:n,onFocus:d,onBlur:x,onToggle:b},t.$attrs),[S(t.$slots,"default")],48,F))}});export{_ as k};
