import{i as v,z as n,a as p,x as g}from"./Button.D5k6BRt0.js";import{s as u}from"./plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as f,c as x,o as y,r as b,K as z,p as S,v as w,P as k,s as $}from"./framework.CEYhRMo2.js";var A=Object.defineProperty,o=(a,e,s,t)=>{for(var i=void 0,l=a.length-1,c;l>=0;l--)(c=a[l])&&(i=c(e,s,i)||i);return i&&A(e,s,i),i};const d=class extends p{constructor(){super(),this.text="",this.imgSrc="",this.imgAlt="",this.size="md",this.shape="circle",this.variant="default",this.ariaLabel=""}_renderContent(){return this.imgSrc?g`<img
        class="avatar-image"
