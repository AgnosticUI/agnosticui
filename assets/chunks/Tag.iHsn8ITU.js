import{i as p,z as e,a as d,x as l}from"./property-CemaeiRl.Cea_q1B7.js";var v=Object.defineProperty,t=(n,a,s,u)=>{for(var r=void 0,i=n.length-1,g;i>=0;i--)(g=n[i])&&(r=g(a,s,r)||r);return r&&v(a,s,r),r};const c=class extends d{constructor(){super(),this._handleRemove=()=>{const a=new CustomEvent("tag-remove",{detail:{variant:this.variant},bubbles:!0,composed:!0});this.dispatchEvent(a),this.onTagRemove&&this.onTagRemove(a)},this._handleKeyDown=a=>{(a.key==="Backspace"||a.key===" "||a.key==="Enter")&&(a.preventDefault(),this._handleRemove())},this.variant="",this.shape="",this.uppercase=!1,this.removable=!1}render(){return l`
  ...
  `;let o=c;t([e({type:String,reflect:!0})],o.prototype,"variant");t([e({type:String,reflect:!0})],o.prototype,"shape");t([e({type:Boolean,reflect:!0})],o.prototype,"uppercase");t([e({type:Boolean,reflect:!0})],o.prototype,"removable");t([e({attribute:!1})],o.prototype,"onTagRemove");export{o as r};
