 ...
 */const dt=r=>r??p;var De=Object.defineProperty,v=(r,t,e,s)=>{for(var i=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=o(t,e,i)||i);return i&&De(t,e,i),i};const te=class extends j{constructor(){super(),this.disabled=!1,this.loading=!1,this.toggle=!1,this.pressed=!1,this.bordered=!1,this.ghost=!1,this.link=!1,this.grouped=!1,this.fullWidth=!1,this.type="button",this.ariaLabel="",this.variant="",this.size="md",this.shape=""}_handleClick(t){if(this.onClick&&this.onClick(t),this.toggle&&!this.disabled&&!this.loading&&!t.defaultPrevented){this.pressed=!this.pressed;const e=new CustomEvent("toggle",{detail:{pressed:this.pressed},bubbles:!0,composed:!0});this.dispatchEvent(e),this.onToggle&&this.onToggle(e)}}_handleFocus(t){this.onFocus&&this.onFocus(t);const e=new FocusEvent("focus",{bubbles:!0,composed:!0});this.dispatchEvent(e)}_handleBlur(t){this.onBlur&&this.onBlur(t);const e=new FocusEvent("blur",{bubbles:!0,composed:!0});this.dispatchEvent(e)}focus(){var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("button");t&&t.focus()}blur(){var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("button");t&&t.blur()}render(){const t=this.disabled||this.loading;return pe`
  ...
  `;let g=te;v([f({type:String,reflect:!0})],g.prototype,"variant");v([f({type:String,reflect:!0})],g.prototype,"size");v([f({type:String,reflect:!0})],g.prototype,"shape");v([f({type:Boolean,reflect:!0})],g.prototype,"bordered");v([f({type:Boolean,reflect:!0})],g.prototype,"ghost");v([f({type:Boolean,reflect:!0})],g.prototype,"link");v([f({type:Boolean,reflect:!0})],g.prototype,"grouped");v([f({type:Boolean,reflect:!0,attribute:"full-width"})],g.prototype,"fullWidth");v([f({type:String})],g.prototype,"type");v([f({type:Boolean})],g.prototype,"disabled");v([f({type:Boolean})],g.prototype,"loading");v([f({type:Boolean})],g.prototype,"toggle");v([f({type:Boolean})],g.prototype,"pressed");v([f({type:String,reflect:!0,attribute:"aria-label"})],g.prototype,"ariaLabel");v([f({attribute:!1})],g.prototype,"onClick");v([f({attribute:!1})],g.prototype,"onFocus");v([f({attribute:!1})],g.prototype,"onBlur");v([f({attribute:!1})],g.prototype,"onToggle");customElements.get("ag-button")||customElements.define("ag-button",g);export{$ as E,dt as Q,j as a,We as b,se as i,g as t,pe as x,f as z};
