import{i as u,z as i,a as h,x as m}from"./Button.CfALiVhd.js";var f=Object.defineProperty,y=Object.getOwnPropertyDescriptor,s=(n,r,e,o)=>{for(var a=o>1?void 0:o?y(r,e):r,g=n.length-1,l;g>=0;g--)(l=n[g])&&(a=(o?l(r,e,a):l(a))||a);return o&&a&&f(r,e,a),a};const p=100,b=10,v=(p-b)/2,c=2*Math.PI*v,d=class extends h{constructor(){super(...arguments),this._value=0,this.noAnimation=!1}get value(){return this._value}set value(r){const e=Math.max(0,Math.min(100,Number(r)||0));this._value!==e&&(this._value=e,this.requestUpdate())}render(){const r=c-this._value/100*c,e=c.toFixed(4);return m`
      <div
