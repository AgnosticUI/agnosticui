import{a as l,i as b,x as n}from"./lit-element.B0TUrqGF.js";import{z as a}from"./property-CemaeiRl.BAjarvIB.js";import{Q as d}from"./if-defined-C8i28hSj.CfeO1FY9.js";var c=Object.defineProperty,s=(o,g,t,u)=>{for(var r=void 0,i=o.length-1,p;i>=0;i--)(p=o[i])&&(r=p(g,t,r)||r);return r&&c(g,t,r),r};class e extends l{constructor(){super(...arguments),this.max=100,this.label="",this.size="medium"}static get styles(){return b`
      :host {
        display: block;
    ...
    `}render(){return n`
      <div class="progress-wrapper" part="ag-progress-wrapper">
        ${this.label?n`<label for="progress" class="progress-label" part="progress-label">${this.label}</label>`:""}
        <progress
          id="progress"
