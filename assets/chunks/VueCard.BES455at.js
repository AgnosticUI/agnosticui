import{i as p,z as s,a as v,E as u,x as h}from"./Button.CfALiVhd.js";import{o as l}from"./slot.B17U6J5C.js";import{s as f}from"./plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as b,c as y,o as w,r as c,K as k,p as x,v as S}from"./framework.BZTe5Kj6.js";var C=Object.defineProperty,i=(a,t,e,d)=>{for(var o=void 0,n=a.length-1,m;n>=0;n--)(m=a[n])&&(o=m(t,e,o)||o);return o&&C(t,e,o),o};const $={fromAttribute(a){return a===""||a==="true"?"md":a==="false"||a===null?"":a||""},toAttribute(a){return typeof a=="boolean"?a?"md":null:a||null}},g=class extends v{constructor(){super(),this._hasHeaderSlotContent=!1,this._hasFooterSlotContent=!1,this.stacked=!1,this.shadow=!1,this.animated=!1,this.rounded="",this.variant="",this.hasMedia=!1,this.mediaPosition="top"}_handleSlotChange(t){const e=t.target,d=e.name;d==="header"?this._hasHeaderSlotContent=l(e):d==="footer"&&(this._hasFooterSlotContent=l(e)),this.requestUpdate()}firstUpdated(){var d,o;const t=(d=this.shadowRoot)==null?void 0:d.querySelector('slot[name="header"]'),e=(o=this.shadowRoot)==null?void 0:o.querySelector('slot[name="footer"]');this._hasHeaderSlotContent=l(t),this._hasFooterSlotContent=l(e),this.requestUpdate()}render(){const t=this._hasHeaderSlotContent?"card-header":"card-header empty",e=this._hasFooterSlotContent?"card-footer":"card-footer empty";return h`
