import{i as u,z as e,a as g,x as p}from"./Button.Bujdzq23.js";var v=Object.defineProperty,r=(s,t,i,b)=>{for(var o=void 0,n=s.length-1,c;n>=0;n--)(c=s[n])&&(o=c(t,i,o)||o);return o&&v(t,i,o),o};const l=class extends g{constructor(){super(),this._handleClick=t=>{t.stopPropagation(),this.dispatchEvent(new CustomEvent("close-button-click",{bubbles:!0,composed:!0}))},this.label="Close",this.size="md",this.position=void 0,this.variant="default"}render(){const t=["close-button",`close-button-${this.size}`].join(" ");return p`
      <button
        type="button"
        class="${t}"
