import{E as l,x as c,i as p,z as r,a as u}from"./property-CemaeiRl.Cea_q1B7.js";import{i as g,u as f,a as k}from"./form-control-utils.BYIX_mid.js";import{c as x,_ as m}from"./face-mixin.MgCHLM8W.js";var v=Object.defineProperty,i=(h,e,o,s)=>{for(var a=void 0,n=h.length-1,d;n>=0;n--)(d=h[n])&&(a=d(e,o,a)||a);return a&&v(e,o,a),a};const b=class extends x(u){constructor(){super(),this._ids=g("ag-checkbox"),this.value="",this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.size="medium",this.theme="primary",this.labelText="",this.labelPosition="end",this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText=""}get controlElement(){return this.inputRef||null}formResetCallback(){this.checked=!1,this.indeterminate=!1,this._internals.setFormValue(null),this._internals.setValidity({}),this._syncStates()}formStateRestoreCallback(e,o){this.checked=e!==null,this.indeterminate=!1,this._internals.setFormValue(this.checked?this.value||"on":null),this._syncValidity(),this._syncStates()}_syncValidity(){m(this._internals,this.inputRef)}_syncStates(){this._setState("checked",this.checked),this._setState("indeterminate",this.indeterminate),this._setState("disabled",this.disabled),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}updated(e){super.updated(e),e.has("indeterminate")&&this.inputRef&&(this.inputRef.indeterminate=this.indeterminate),(e.has("checked")||e.has("indeterminate"))&&(this._internals.setFormValue(this.checked?this.value||"on":null),this._syncValidity(),this._syncStates())}handleClick(e){this.onClick&&this.onClick(e)}handleChange(e){if(this.disabled){e.preventDefault();return}const o=e.target;this.checked=o.checked,this.indeterminate&&(this.indeterminate=!1),this._internals.setFormValue(this.checked?this.value||"on":null),this._syncValidity(),this._syncStates();const s=new CustomEvent("change",{detail:{checked:this.checked,value:this.value,name:this.name,indeterminate:this.indeterminate},bubbles:!0,composed:!0});this.dispatchEvent(s),this.onChange&&this.onChange(s)}_renderHelper(){return this.helpText?c`
      <div
    ...
    `,a=this._getAriaDescribedBy();return c`
  ...
  `];let t=b;i([r({type:String})],t.prototype,"value");i([r({type:Boolean,reflect:!0})],t.prototype,"checked");i([r({type:Boolean,reflect:!0})],t.prototype,"indeterminate");i([r({type:Boolean,reflect:!0})],t.prototype,"disabled");i([r({type:String})],t.prototype,"size");i([r({type:String})],t.prototype,"theme");i([r({type:String})],t.prototype,"labelText");i([r({type:String})],t.prototype,"labelPosition");i([r({type:Boolean,reflect:!0})],t.prototype,"required");i([r({type:Boolean,reflect:!0})],t.prototype,"invalid");i([r({type:String,attribute:"error-message"})],t.prototype,"errorMessage");i([r({type:String,attribute:"help-text"})],t.prototype,"helpText");i([r({attribute:!1})],t.prototype,"onClick");i([r({attribute:!1})],t.prototype,"onChange");customElements.get("ag-checkbox")||customElements.define("ag-checkbox",t);
