import{i as e,t as a}from"./FrameworkExample.DQckTML-.js";const l=e`
...
`;function n(r){const o=a(r);return{inputId:`${o}-input`,labelId:`${o}-label`,helperId:`${o}-helper`,errorId:`${o}-error`}}function i(r){const o=[];return r.hasHelper&&o.push(r.helperId),r.hasError&&o.push(r.errorId),o.length>0?o.join(" "):void 0}function s(r){return r==="start"||r==="end"}export{l as a,n as i,s as t,i as u};
