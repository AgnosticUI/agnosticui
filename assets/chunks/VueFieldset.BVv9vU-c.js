import{i as f,z as r,a as c,x as s}from"./Button.DkmThuAs.js";import{s as u}from"./plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as m,c as h,o as y,r as b,K as v,p as w,v as x}from"./framework.NAAYCHZu.js";var z=Object.defineProperty,l=(e,t,a,p)=>{for(var d=void 0,n=e.length-1,i;n>=0;n--)(i=e[n])&&(d=i(t,a,d)||d);return d&&z(t,a,d),d};const g=class extends c{constructor(){super(...arguments),this.legend="",this.bordered=!1,this.layout="vertical",this.legendHidden=!1}connectedCallback(){super.connectedCallback(),this.layout!=="vertical"&&this.layout!=="horizontal"&&(this.layout="vertical")}render(){const t=["ag-fieldset",this.bordered?"ag-fieldset--bordered":"",this.layout==="horizontal"?"ag-fieldset--horizontal":""].filter(Boolean).join(" "),a=["ag-fieldset-legend",this.legendHidden?"ag-fieldset-legend--hidden":""].filter(Boolean).join(" ");return s`
      <fieldset
        class="${t}"
        part="ag-fieldset"
      >
