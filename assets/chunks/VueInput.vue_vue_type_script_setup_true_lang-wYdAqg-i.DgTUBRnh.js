import{a as w,x as l,E as h,i as B,z as i}from"./property-CemaeiRl.Cea_q1B7.js";import{n as $}from"./state-CovhUvdr.C-u8O0Fo.js";import{f as S}from"./query-BykXNUlT.Pm7lu9c1.js";import{Q as g}from"./Button.CVPv0yaW.js";import{o as _}from"./slot.B17U6J5C.js";import{i as z,u as E,t as y,a as L}from"./form-control-utils.BYIX_mid.js";import{c as C,_ as q}from"./face-mixin.MgCHLM8W.js";import{d as I,c,o as b,e as v,r as m,K as T}from"./framework.DmF2n0Fc.js";var A=Object.defineProperty,a=(n,e,r,s)=>{for(var o=void 0,u=n.length-1,p;u>=0;u--)(p=n[u])&&(o=p(e,r,o)||o);return o&&A(e,r,o),o};const x=class extends C(w){constructor(){super(),this._ids=z("ag-input"),this._hasLeftAddon=!1,this._hasRightAddon=!1,this.label="",this.labelHidden=!1,this.labelPosition="top",this.noLabel=!1,this.ariaLabel="",this.type="text",this.value="",this.placeholder="",this.rows=4,this.cols=50,this.size="default",this.capsule=!1,this.rounded=!1,this.underlined=!1,this.underlinedWithBackground=!1,this.inline=!1,this.required=!1,this.disabled=!1,this.readonly=!1,this.invalid=!1,this.errorMessage="",this.helpText=""}get controlElement(){return this._inputElement}getValue(){var e;return((e=this._inputElement)==null?void 0:e.value)??""}setValue(e){this._inputElement&&(this._inputElement.value=e,this.value=e)}focus(){var e;(e=this._inputElement)==null||e.focus()}blur(){var e;(e=this._inputElement)==null||e.blur()}select(){var e;(e=this._inputElement)==null||e.select()}formResetCallback(){this.value="",this._internals.setFormValue(""),this._internals.setValidity({}),this._syncStates()}formStateRestoreCallback(e,r){this.value=typeof e=="string"?e:"",this._internals.setFormValue(this.value),this._syncValidity(),this._syncStates()}_syncStates(){this._setState("disabled",this.disabled),this._setState("readonly",this.readonly),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}_syncValidity(){q(this._internals,this._inputElement)}_handleSlotChange(e){const r=e.target,s=r.name;s==="addon-left"?this._hasLeftAddon=_(r):s==="addon-right"&&(this._hasRightAddon=_(r)),this.requestUpdate()}_handleInput(e){const r=e.target;this.value=r.value,this._internals.setFormValue(this.value),this._syncValidity(),this.onInput&&this.onInput(e)}_handleChange(e){const r=e.target;this.value=r.value,this._internals.setFormValue(this.value),this._syncValidity(),this.onChange&&this.onChange(e)}_handleFocus(e){this.dispatchEvent(new FocusEvent("focus",{bubbles:!0,composed:!0,relatedTarget:e.relatedTarget})),this.onFocus&&this.onFocus(e)}_handleBlur(e){this.dispatchEvent(new FocusEvent("blur",{bubbles:!0,composed:!0,relatedTarget:e.relatedTarget})),this.onBlur&&this.onBlur(e)}_handleClick(e){this.onClick&&this.onClick(e)}_getAriaDescribedBy(){return E({helperId:this._ids.helperId,errorId:this._ids.errorId,hasHelper:!!this.helpText,hasError:this.invalid&&!!this.errorMessage})}_renderInputElement(){const e=this.type==="textarea",r=this._getAriaDescribedBy(),s=[];return r&&s.push(r),e?l`
    ...
    `}render(){const e=this._hasLeftAddon||this._hasRightAddon,r=y(this.labelPosition),s=["ag-input"];this.size==="small"&&s.push("ag-input--small"),this.size==="large"&&s.push("ag-input--large"),this.rounded&&s.push("ag-input--rounded"),this.underlined&&s.push("ag-input--underlined"),this.underlinedWithBackground&&s.push("ag-input--underlined-with-background");const o=e?l`
