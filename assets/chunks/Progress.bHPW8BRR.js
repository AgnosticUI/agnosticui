import{a as l,i as b,x as p,z as a}from"./property-CemaeiRl.Cea_q1B7.js";import{Q as d}from"./if-defined-C8i28hSj.D90q5KVf.js";var c=Object.defineProperty,s=(o,g,t,u)=>{for(var r=void 0,i=o.length-1,n;i>=0;i--)(n=o[i])&&(r=n(g,t,r)||r);return r&&c(g,t,r),r};class e extends l{constructor(){super(...arguments),this.max=100,this.label="",this.size="medium"}static get styles(){return b`
      :host {
        display: block;
    ...
    `}render(){return p`
      <div class="progress-wrapper" part="ag-progress-wrapper">
        ${this.label?p`<label for="progress" class="progress-label" part="progress-label">${this.label}</label>`:""}
        <progress
          id="progress"
