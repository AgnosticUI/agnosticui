import{i as f,a as v,x as d}from"./lit-element.B0TUrqGF.js";import{z as o}from"./property-CemaeiRl.BAjarvIB.js";import{Q as c}from"./if-defined-C8i28hSj.CfeO1FY9.js";import{a as m,i as y,t as b,u as k}from"./form-control-utils.DRSK-DHo.js";import{d as _,p as x,c as $,q as w,o as z,K as I}from"./framework.BoyT2Jkt.js";var T=Object.defineProperty,i=(e,l,t,s)=>{for(var r=void 0,h=e.length-1,g;h>=0;h--)(g=e[h])&&(r=g(l,t,r)||r);return r&&T(l,t,r),r};const u=class extends v{constructor(){super(),this._toggleId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this._handleClick=t=>{this.onClick&&this.onClick(t),this._performToggle(t)},this._handleKeydown=t=>{(t.key===" "||t.key==="Enter")&&(t.preventDefault(),this._performToggle(t))},this._performToggle=t=>{if(this.disabled||this.readonly){t.preventDefault();return}this.checked=!this.checked;const s=new CustomEvent("toggle-change",{detail:{checked:this.checked,name:this.name,value:this.value},bubbles:!0,composed:!0});this.dispatchEvent(s),this.onToggleChange&&this.onToggleChange(s)};const l=y("toggle");this._toggleId=l.inputId,this._labelId=l.labelId,this._helperId=l.helperId,this._errorId=l.errorId,this.label="",this.labelHidden=!1,this.noLabel=!1,this.checked=!1,this.size="md",this.variant="default",this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.name="",this.value=""}firstUpdated(){!this.label&&!this.noLabel&&console.warn("AgToggle: label property is required for accessibility.")}renderLabel(){if(!this.label||this.noLabel)return"";const l=[];return b(this.labelPosition)?(l.push("ag-form-control__label--horizontal"),l.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&l.push(`ag-form-control__label--${this.labelPosition}`),d`
      <label
        id=${this._labelId}
        for=${this._toggleId}
        class="ag-form-control__label ${this.labelHidden?"ag-form-control__label--hidden":""} ${this.required?"ag-form-control__label--required":""} ${l.join(" ")}"
        part="ag-toggle-label"
      >
        ${this.label}
      </label>
    `}render(){const l=k({helperId:this._helperId,errorId:this._errorId,hasHelper:!!this.helpText&&!this.invalid,hasError:!!this.invalid&&!!this.errorMessage}),t=this.helpText&&!this.invalid?d`<div class="ag-form-control__helper" id="${this._helperId}">
          ${this.helpText}
  ...
  `];let a=u;i([o({type:String})],a.prototype,"label");i([o({type:String,attribute:"label-position"})],a.prototype,"labelPosition");i([o({type:Boolean,attribute:"label-hidden"})],a.prototype,"labelHidden");i([o({type:Boolean,attribute:"no-label"})],a.prototype,"noLabel");i([o({type:Boolean,reflect:!0})],a.prototype,"checked");i([o({type:String,reflect:!0})],a.prototype,"size");i([o({type:String,reflect:!0})],a.prototype,"variant");i([o({type:Boolean,reflect:!0})],a.prototype,"disabled");i([o({type:Boolean,reflect:!0})],a.prototype,"readonly");i([o({type:Boolean,reflect:!0})],a.prototype,"required");i([o({type:Boolean,reflect:!0})],a.prototype,"invalid");i([o({type:String,attribute:"error-message"})],a.prototype,"errorMessage");i([o({type:String,attribute:"help-text"})],a.prototype,"helpText");i([o({type:String})],a.prototype,"name");i([o({type:String})],a.prototype,"value");i([o({attribute:!1})],a.prototype,"onClick");i([o({attribute:!1})],a.prototype,"onToggleChange");customElements.get("ag-toggle")||customElements.define("ag-toggle",a);const B=["label",".labelPosition",".labelHidden",".noLabel","size","variant",".checked",".disabled",".readonly",".required",".invalid","errorMessage","helpText","name","value"],E=_({__name:"VueToggle",props:{label:{},labelPosition:{default:"top"},labelHidden:{type:Boolean,default:!1},noLabel:{type:Boolean,default:!1},checked:{type:Boolean,default:!1},size:{default:"md"},variant:{default:"default"},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},required:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},errorMessage:{default:""},helpText:{default:""},name:{},value:{}},emits:["click","toggle-change","update:checked"],setup(e,{emit:l}){const t=e,s=l,r=x(),h=n=>{s("click",n)},g=n=>{const p=n;s("toggle-change",p.detail),s("update:checked",p.detail.checked)};return w(()=>t.checked,n=>{r.value&&r.value.checked!==n&&(r.value.checked=n)}),(n,p)=>(z(),$("ag-toggle",I({ref_key:"toggleRef",ref:r,label:e.label,".labelPosition":e.labelPosition,".labelHidden":e.labelHidden,".noLabel":e.noLabel,size:e.size,variant:e.variant,".checked":e.checked,".disabled":e.disabled,".readonly":e.readonly,".required":e.required,".invalid":e.invalid,errorMessage:e.errorMessage,helpText:e.helpText,name:e.name,value:e.value,onClick:h,onToggleChange:g},n.$attrs),null,48,B))}});export{E as v};
