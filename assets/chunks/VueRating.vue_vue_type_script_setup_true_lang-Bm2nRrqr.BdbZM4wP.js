import{a as y,x as p,Q as g,b as c,i as b,z as n}from"./Button.CfALiVhd.js";import{n as u}from"./state-CovhUvdr.DFO-h9iY.js";import{i as w,t as m,u as $,a as P}from"./form-control-utils.DiC9dPVW.js";import{y as _}from"./face-mixin.Dz5PWcWd.js";import{d as x,p as V,c as C,o as M,r as H,K as L}from"./framework.NAAYCHZu.js";var I=Object.defineProperty,l=(s,e,a,t)=>{for(var i=void 0,h=s.length-1,o;h>=0;h--)(o=s[h])&&(i=o(e,a,i)||i);return i&&I(e,a,i),i};let k=0;const f=class extends _(y){constructor(){super(),this.uniqueId=++k,this._ratingId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this.hoverValue=0,this.isHovering=!1,this.isPointerDown=!1;const e=w("rating");this._ratingId=e.inputId,this._labelId=e.labelId,this._helperId=e.helperId,this._errorId=e.errorId,this.value=0,this.max=5,this.precision="whole",this.readonly=!1,this.allowClear=!1,this.variant="",this.size="md",this.label="",this.labelHidden=!1,this.noLabel=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.validationMessages=void 0,this.handlePointerMove=this.handlePointerMove.bind(this),this.handlePointerUp=this.handlePointerUp.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}_syncFormValue(){this._internals.setFormValue(this.value>0?String(this.value):null)}_syncValidity(){var e;this.required&&this.value===0?this._internals.setValidity({valueMissing:!0},((e=this.validationMessages)==null?void 0:e.valueMissing)??"Please select a rating."):this._internals.setValidity({})}firstUpdated(){this._syncFormValue(),this._syncValidity()}updated(e){super.updated(e),e.has("value")&&(this._syncFormValue(),this._syncValidity())}formResetCallback(){this.value=0,this._internals.setFormValue(null),this._internals.setValidity({})}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleKeyDown),this.removeGlobalPointerListeners()}renderLabel(){if(!this.label||this.noLabel)return"";const e=[];return m(this.labelPosition)?(e.push("ag-form-control__label--horizontal"),e.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&e.push(`ag-form-control__label--${this.labelPosition}`),p`
    ...
    `}render(){const e=this.isHovering?this.hoverValue:this.value,a=Array.from({length:this.max},(d,v)=>v+1),t=$({helperId:this._helperId,errorId:this._errorId,hasHelper:!!this.helpText&&!this.invalid,hasError:!!this.invalid&&!!this.errorMessage}),i=this.helpText&&!this.invalid?p`<div class="ag-form-control__helper" id="${this._helperId}">
          ${this.helpText}
