import{a as y,x as v,Q as g,b as c,i as b,z as n}from"./Button.CfALiVhd.js";import{n as u}from"./state-CovhUvdr.DFO-h9iY.js";import{i as w,t as m,u as _,a as $}from"./form-control-utils.DiC9dPVW.js";import{c as P}from"./face-mixin.D58DBW-D.js";import{d as x,p as V,c as C,o as M,r as H,K as L}from"./framework.BZTe5Kj6.js";var I=Object.defineProperty,l=(s,e,a,t)=>{for(var i=void 0,h=s.length-1,o;h>=0;h--)(o=s[h])&&(i=o(e,a,i)||i);return i&&I(e,a,i),i};let k=0;const f=class extends P(y){constructor(){super(),this.uniqueId=++k,this._ratingId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this.hoverValue=0,this.isHovering=!1,this.isPointerDown=!1;const e=w("rating");this._ratingId=e.inputId,this._labelId=e.labelId,this._helperId=e.helperId,this._errorId=e.errorId,this.value=0,this.max=5,this.precision="whole",this.readonly=!1,this.allowClear=!1,this.variant="",this.size="md",this.label="",this.labelHidden=!1,this.noLabel=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.validationMessages=void 0,this.handlePointerMove=this.handlePointerMove.bind(this),this.handlePointerUp=this.handlePointerUp.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}_syncFormValue(){this._internals.setFormValue(this.value>0?String(this.value):null)}_syncValidity(){var e;this.required&&this.value===0?this._internals.setValidity({valueMissing:!0},((e=this.validationMessages)==null?void 0:e.valueMissing)??"Please select a rating."):this._internals.setValidity({})}firstUpdated(){this._syncFormValue(),this._syncValidity(),this._syncStates()}updated(e){super.updated(e),e.has("value")&&(this._syncFormValue(),this._syncValidity()),(e.has("value")||e.has("readonly")||e.has("required")||e.has("invalid"))&&this._syncStates()}formResetCallback(){this.value=0,this._internals.setFormValue(null),this._internals.setValidity({}),this._syncStates()}formStateRestoreCallback(e,a){this.value=typeof e=="string"?parseFloat(e):0,this._syncFormValue(),this._syncValidity(),this._syncStates()}_syncStates(){this._setState("readonly",this.readonly),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleKeyDown),this.removeGlobalPointerListeners()}renderLabel(){if(!this.label||this.noLabel)return"";const e=[];return m(this.labelPosition)?(e.push("ag-form-control__label--horizontal"),e.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&e.push(`ag-form-control__label--${this.labelPosition}`),v`
      <label
        id=${this._labelId}
        for=${this._ratingId}
    ...
    `}render(){const e=this.isHovering?this.hoverValue:this.value,a=Array.from({length:this.max},(d,p)=>p+1),t=_({helperId:this._helperId,errorId:this._errorId,hasHelper:!!this.helpText&&!this.invalid,hasError:!!this.invalid&&!!this.errorMessage}),i=this.helpText&&!this.invalid?v`<div class="ag-form-control__helper" id="${this._helperId}">
          ${this.helpText}
        </div>`:"",h=this.invalid&&this.errorMessage?v`<div class="ag-form-control__error" id="${this._errorId}">
          ${this.errorMessage}
        </div>`:"",o=v`
      <div
        id="${this._ratingId}"
    ...
    `;return m(this.labelPosition)?v`
      ...
      ${i}
      ${h}
    `}renderStar(e,a){const t=a>=e,i=!t&&a>=e-.5&&this.precision==="half",h=t||i?"filled":"",o=this.isHovering&&this.hoverValue>=e?"hover":"",d=`ag-rating-half-${this.uniqueId}-${e}`;return v`
      <span
        class="star-button"
        part="star-button"
        @click="${p=>this.handleClickStar(p,e)}"
        aria-label="${e} star"
        title="${e} star"
      >
  ...
  `];let r=f;l([n({type:Number})],r.prototype,"value");l([n({type:Number})],r.prototype,"max");l([n({type:String})],r.prototype,"precision");l([n({type:Boolean,reflect:!0})],r.prototype,"readonly");l([n({type:Boolean})],r.prototype,"allowClear");l([n({type:String,reflect:!0})],r.prototype,"variant");l([n({type:String,reflect:!0})],r.prototype,"size");l([n({type:String})],r.prototype,"label");l([n({type:String,attribute:"label-position"})],r.prototype,"labelPosition");l([n({type:Boolean,attribute:"label-hidden"})],r.prototype,"labelHidden");l([n({type:Boolean,attribute:"no-label"})],r.prototype,"noLabel");l([n({type:Boolean,reflect:!0})],r.prototype,"required");l([n({type:Boolean,reflect:!0})],r.prototype,"invalid");l([n({type:String,attribute:"error-message"})],r.prototype,"errorMessage");l([n({type:String,attribute:"help-text"})],r.prototype,"helpText");l([n({attribute:!1})],r.prototype,"validationMessages");l([n({attribute:!1})],r.prototype,"onRatingChange");l([n({attribute:!1})],r.prototype,"onRatingHover");l([u()],r.prototype,"hoverValue");l([u()],r.prototype,"isHovering");l([u()],r.prototype,"isPointerDown");customElements.get("ag-rating")||customElements.define("ag-rating",r);const S=[".value",".readonly",".allowClear",".required",".invalid",".validationMessages","max","precision","variant","size","name","label","labelPosition","labelHidden","noLabel","errorMessage","helpText"],F=x({__name:"VueRating",props:{value:{default:0},max:{default:5},precision:{default:"whole"},readonly:{type:Boolean,default:!1},allowClear:{type:Boolean,default:!1},variant:{default:""},size:{default:"md"},name:{default:""},label:{default:""},labelPosition:{default:"top"},labelHidden:{type:Boolean,default:!1},noLabel:{type:Boolean,default:!1},required:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},errorMessage:{default:""},helpText:{default:""},validationMessages:{}},emits:["update:value","change","hover"],setup(s,{emit:e}){const a=e,t=V(),i=o=>{const d=o;a("change",d.detail),a("update:value",d.detail.newValue)},h=o=>{a("hover",o.detail)};return(o,d)=>(M(),C("ag-rating",L({ref_key:"ratingRef",ref:t,".value":s.value,".readonly":s.readonly,".allowClear":s.allowClear,".required":s.required,".invalid":s.invalid,".validationMessages":s.validationMessages,max:s.max,precision:s.precision,variant:s.variant,size:s.size,name:s.name,label:s.label,labelPosition:s.labelPosition,labelHidden:s.labelHidden,noLabel:s.noLabel,errorMessage:s.errorMessage,helpText:s.helpText,onRatingChange:i,onRatingHover:h},o.$attrs),[H(o.$slots,"default")],48,S))}});export{F as h};
