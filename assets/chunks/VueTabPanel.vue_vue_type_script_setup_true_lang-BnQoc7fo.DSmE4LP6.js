import{i as u,a as p,x as h}from"./lit-element.B0TUrqGF.js";import{z as c}from"./property-CemaeiRl.BAjarvIB.js";import{n as f}from"./state-CovhUvdr.BllWkzJh.js";import{t as A}from"./unique-id.CpwMFgRD.js";import{d as v,p as w,c as g,o as _,r as m,K as T}from"./framework.DvJW1jwp.js";var C=Object.defineProperty,o=(s,t,a,i)=>{for(var e=void 0,r=s.length-1,n;r>=0;r--)(n=s[r])&&(e=n(t,a,e)||e);return e&&C(t,a,e),e};const x=class extends p{constructor(){super(),this.panel="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}render(){return h`<div class="tab" part="ag-tab"><slot></slot></div>`}};x.styles=u`
    :host {
      display: inline-flex;
    }
  ...
  `;let y=x;o([c({type:String})],y.prototype,"panel");o([c({type:Boolean,reflect:!0})],y.prototype,"disabled");const k=class extends p{constructor(){super()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tabpanel"),this.setAttribute("tabindex","0")}render(){return h`<div class="tab-panel" part="ag-tab-panel"><slot></slot></div>`}};k.styles=u`
    :host {
      display: block;
    }
  ...
  `;let b=E;o([c({type:String})],b.prototype,"activation");o([c({type:Number,attribute:"active-tab"})],b.prototype,"activeTab");o([c({type:String})],b.prototype,"orientation");o([c({type:String,reflect:!0,attribute:"aria-label"})],b.prototype,"ariaLabel");o([c({attribute:!1})],b.prototype,"onTabChange");o([f()],b.prototype,"_tabs");o([f()],b.prototype,"_panels");o([f()],b.prototype,"_focusedTab");customElements.get("ag-tab")||customElements.define("ag-tab",y);customElements.get("ag-tab-panel")||customElements.define("ag-tab-panel",D);customElements.get("ag-tabs")||customElements.define("ag-tabs",b);const L=["activation","activeTab","orientation","ariaLabel"],j=v({__name:"VueTabs",props:{activeTab:{default:0},activation:{default:"manual"},orientation:{default:"horizontal"},ariaLabel:{}},emits:["tab-change","update:activeTab"],setup(s,{emit:t}){const a=t,i=w(),e=r=>{const n=r.detail;a("tab-change",n),a("update:activeTab",n.activeTab)};return(r,n)=>(_(),g("ag-tabs",T({ref_key:"tabsRef",ref:i,activation:s.activation,activeTab:s.activeTab,orientation:s.orientation,ariaLabel:s.ariaLabel,onTabChange:e},r.$attrs),[m(r.$slots,"default")],16,L))}}),P=["panel",".disabled","aria-disabled"],q=v({__name:"VueTab",props:{panel:{},disabled:{type:Boolean}},setup(s){return(t,a)=>(_(),g("ag-tab",T({slot:"tab",panel:s.panel,".disabled":s.disabled,"aria-disabled":s.disabled?"true":null},t.$attrs),[m(t.$slots,"default")],48,P))}}),$=["id"],O=v({__name:"VueTabPanel",props:{id:{}},setup(s){return(t,a)=>(_(),g("ag-tab-panel",T({slot:"panel",id:s.id},t.$attrs),[m(t.$slots,"default")],16,$))}});export{j as T,q as b,O as i};
