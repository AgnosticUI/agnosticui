import{i as Z,z as g,a as J,x as Q}from"./property-CemaeiRl.Cea_q1B7.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const x=globalThis,N=x.trustedTypes,F=N?N.createPolicy("lit-html",{createHTML:s=>s}):void 0,U="$lit$",f=`lit$${Math.random().toFixed(9).slice(2)}$`,D="?"+f,X=`<${D}>`,A=document,T=()=>A.createComment(""),w=s=>s===null||typeof s!="object"&&typeof s!="function",L=Array.isArray,Y=s=>L(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",C=`[ 	
\f\r]`,k=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,R=/-->/g,O=/>/g,y=RegExp(`>|${C}(?:([^\\s"'>=/]+)(${C}*=${C}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),P=/'/g,W=/"/g,q=/^(?:script|style|textarea|title)$/i,H=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),j=new WeakMap,$=A.createTreeWalker(A,129);function G(s,t){if(!L(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return F!==void 0?F.createHTML(t):t}const K=(s,t)=>{const e=s.length-1,o=[];let r,n=t===2?"<svg>":t===3?"<math>":"",a=k;for(let p=0;p<e;p++){const i=s[p];let c,b,h=-1,v=0;for(;v<i.length&&(a.lastIndex=v,b=a.exec(i),b!==null);)v=a.lastIndex,a===k?b[1]==="!--"?a=R:b[1]!==void 0?a=O:b[2]!==void 0?(q.test(b[2])&&(r=RegExp("</"+b[2],"g")),a=y):b[3]!==void 0&&(a=y):a===y?b[0]===">"?(a=r??k,h=-1):b[1]===void 0?h=-2:(h=a.lastIndex-b[2].length,c=b[1],a=b[3]===void 0?y:b[3]==='"'?W:P):a===W||a===P?a=y:a===R||a===O?a=k:(a=y,r=void 0);const m=a===y&&s[p+1].startsWith("/>")?" ":"";n+=a===k?i+X:h>=0?(o.push(c),i.slice(0,h)+U+i.slice(h)+f+m):i+f+(h===-2?p:m)}return[G(s,n+(s[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),o]};class S{constructor({strings:t,_$litType$:e},o){let r;this.parts=[];let n=0,a=0;const p=t.length-1,i=this.parts,[c,b]=K(t,e);if(this.el=S.createElement(c,o),$.currentNode=this.el.content,e===2||e===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=$.nextNode())!==null&&i.length<p;){if(r.nodeType===1){if(r.hasAttributes())for(const h of r.getAttributeNames())if(h.endsWith(U)){const v=b[a++],m=r.getAttribute(h).split(f),B=/([.?@])?(.*)/.exec(v);i.push({type:1,index:n,name:B[2],strings:m,ctor:B[1]==="."?et:B[1]==="?"?rt:B[1]==="@"?ot:E}),r.removeAttribute(h)}else h.startsWith(f)&&(i.push({type:6,index:n}),r.removeAttribute(h));if(q.test(r.tagName)){const h=r.textContent.split(f),v=h.length-1;if(v>0){r.textContent=N?N.emptyScript:"";for(let m=0;m<v;m++)r.append(h[m],T()),$.nextNode(),i.push({type:2,index:++n});r.append(h[v],T())}}}else if(r.nodeType===8)if(r.data===D)i.push({type:2,index:n});else{let h=-1;for(;(h=r.data.indexOf(f,h+1))!==-1;)i.push({type:7,index:n}),h+=f.length-1}n++}}static createElement(t,e){const o=A.createElement("template");return o.innerHTML=t,o}}function _(s,t,e=s,o){var a,p;if(t===H)return t;let r=o!==void 0?(a=e._$Co)==null?void 0:a[o]:e._$Cl;const n=w(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==n&&((p=r==null?void 0:r._$AO)==null||p.call(r,!1),n===void 0?r=void 0:(r=new n(s),r._$AT(s,e,o)),o!==void 0?(e._$Co??(e._$Co=[]))[o]=r:e._$Cl=r),r!==void 0&&(t=_(s,r._$AS(s,t.values),r,o)),t}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:o}=this._$AD,r=((t==null?void 0:t.creationScope)??A).importNode(e,!0);$.currentNode=r;let n=$.nextNode(),a=0,p=0,i=o[0];for(;i!==void 0;){if(a===i.index){let c;i.type===2?c=new z(n,n.nextSibling,this,t):i.type===1?c=new i.ctor(n,i.name,i.strings,this,t):i.type===6&&(c=new at(n,this,t)),this._$AV.push(c),i=o[++p]}a!==(i==null?void 0:i.index)&&(n=$.nextNode(),a++)}return $.currentNode=A,r}p(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}}class z{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,o,r){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=_(this,t,e),w(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==H&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Y(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&w(this._$AH)?this._$AA.nextSibling.data=t:this.T(A.createTextNode(t)),this._$AH=t}$(t){var n;const{values:e,_$litType$:o}=t,r=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=S.createElement(G(o.h,o.h[0]),this.options)),o);if(((n=this._$AH)==null?void 0:n._$AD)===r)this._$AH.p(e);else{const a=new tt(r,this),p=a.u(this.options);a.p(e),this.T(p),this._$AH=a}}_$AC(t){let e=j.get(t.strings);return e===void 0&&j.set(t.strings,e=new S(t)),e}k(t){L(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,r=0;for(const n of t)r===e.length?e.push(o=new z(this.O(T()),this.O(T()),this,this.options)):o=e[r],o._$AI(n),r++;r<e.length&&(this._$AR(o&&o._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){var o;for((o=this._$AP)==null?void 0:o.call(this,!1,!0,e);t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class E{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,o,r,n){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=d}_$AI(t,e=this,o,r){const n=this.strings;let a=!1;if(n===void 0)t=_(this,t,e,0),a=!w(t)||t!==this._$AH&&t!==H,a&&(this._$AH=t);else{const p=t;let i,c;for(t=n[0],i=0;i<n.length-1;i++)c=_(this,p[o+i],e,i),c===H&&(c=this._$AH[i]),a||(a=!w(c)||c!==this._$AH[i]),c===d?t=d:t!==d&&(t+=(c??"")+n[i+1]),this._$AH[i]=c}a&&!r&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class et extends E{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}}class rt extends E{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}}class ot extends E{constructor(t,e,o,r,n){super(t,e,o,r,n),this.type=5}_$AI(t,e=this){if((t=_(this,t,e,0)??d)===H)return;const o=this._$AH,r=t===d&&o!==d||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,n=t!==d&&(o===d||r);r&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class at{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){_(this,t)}}const M=x.litHtmlPolyfillSupport;M==null||M(S,z),(x.litHtmlVersions??(x.litHtmlVersions=[])).push("3.3.1");/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const I=s=>s??d;var nt=Object.defineProperty,u=(s,t,e,o)=>{for(var r=void 0,n=s.length-1,a;n>=0;n--)(a=s[n])&&(r=a(t,e,r)||r);return r&&nt(t,e,r),r};const V=class extends J{constructor(){super(),this.disabled=!1,this.loading=!1,this.toggle=!1,this.pressed=!1,this.bordered=!1,this.ghost=!1,this.link=!1,this.grouped=!1,this.fullWidth=!1,this.type="button",this.ariaLabel="",this.variant="",this.size="md",this.shape=""}_handleClick(t){if(this.onClick&&this.onClick(t),!this.disabled&&!this.loading&&!t.defaultPrevented){if(this.type==="submit"){const e=this.closest("form");e&&e.requestSubmit()}else if(this.type==="reset"){const e=this.closest("form");e&&e.reset()}}if(this.toggle&&!this.disabled&&!this.loading&&!t.defaultPrevented){this.pressed=!this.pressed;const e=new CustomEvent("toggle",{detail:{pressed:this.pressed},bubbles:!0,composed:!0});this.dispatchEvent(e),this.onToggle&&this.onToggle(e)}}_handleFocus(t){this.onFocus&&this.onFocus(t);const e=new FocusEvent("focus",{bubbles:!0,composed:!0});this.dispatchEvent(e)}_handleBlur(t){this.onBlur&&this.onBlur(t);const e=new FocusEvent("blur",{bubbles:!0,composed:!0});this.dispatchEvent(e)}focus(){var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("button");t&&t.focus()}blur(){var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("button");t&&t.blur()}render(){const t=this.disabled||this.loading;return Q`
      <button
        type=${this.type}
        part="ag-button"
        ?disabled=${t}
  ...
  `;let l=V;u([g({type:String,reflect:!0})],l.prototype,"variant");u([g({type:String,reflect:!0})],l.prototype,"size");u([g({type:String,reflect:!0})],l.prototype,"shape");u([g({type:Boolean,reflect:!0})],l.prototype,"bordered");u([g({type:Boolean,reflect:!0})],l.prototype,"ghost");u([g({type:Boolean,reflect:!0})],l.prototype,"link");u([g({type:Boolean,reflect:!0})],l.prototype,"grouped");u([g({type:Boolean,reflect:!0,attribute:"full-width"})],l.prototype,"fullWidth");u([g({type:String})],l.prototype,"type");u([g({type:Boolean})],l.prototype,"disabled");u([g({type:Boolean})],l.prototype,"loading");u([g({type:Boolean})],l.prototype,"toggle");u([g({type:Boolean})],l.prototype,"pressed");u([g({type:String,reflect:!0,attribute:"aria-label"})],l.prototype,"ariaLabel");u([g({attribute:!1})],l.prototype,"onClick");u([g({attribute:!1})],l.prototype,"onFocus");u([g({attribute:!1})],l.prototype,"onBlur");u([g({attribute:!1})],l.prototype,"onToggle");customElements.get("ag-button")||customElements.define("ag-button",l);export{I as Q,l as t};
