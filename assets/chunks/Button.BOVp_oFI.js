import{c as h}from"./AlphaWarning.D199zhtu.js";import{i as c,z as a,a as l,x as b}from"./property-CemaeiRl.Cea_q1B7.js";import{Q as d}from"./if-defined-C8i28hSj.CfeO1FY9.js";/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k=h("zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]);var v=Object.defineProperty,e=(s,t,o,p)=>{for(var n=void 0,i=s.length-1,g;i>=0;i--)(g=s[i])&&(n=g(t,o,n)||n);return n&&v(t,o,n),n};const u=class extends l{constructor(){super(),this.disabled=!1,this.loading=!1,this.toggle=!1,this.pressed=!1,this.bordered=!1,this.ghost=!1,this.link=!1,this.grouped=!1,this.type="button",this.ariaLabel="",this.variant="",this.size="md",this.shape=""}_handleClick(t){if(this.onClick&&this.onClick(t),this.toggle&&!this.disabled&&!this.loading&&!t.defaultPrevented){this.pressed=!this.pressed;const o=new CustomEvent("toggle",{detail:{pressed:this.pressed},bubbles:!0,composed:!0});this.dispatchEvent(o),this.onToggle&&this.onToggle(o)}}_handleFocus(t){this.onFocus&&this.onFocus(t);const o=new FocusEvent("focus",{bubbles:!0,composed:!0});this.dispatchEvent(o)}_handleBlur(t){this.onBlur&&this.onBlur(t);const o=new FocusEvent("blur",{bubbles:!0,composed:!0});this.dispatchEvent(o)}focus(){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("button");t&&t.focus()}blur(){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("button");t&&t.blur()}render(){const t=this.disabled||this.loading;return b`
      <button
        type=${this.type}
        part="ag-button"
        ?disabled=${t}
  ...
  `;let r=u;e([a({type:String,reflect:!0})],r.prototype,"variant");e([a({type:String,reflect:!0})],r.prototype,"size");e([a({type:String,reflect:!0})],r.prototype,"shape");e([a({type:Boolean,reflect:!0})],r.prototype,"bordered");e([a({type:Boolean,reflect:!0})],r.prototype,"ghost");e([a({type:Boolean,reflect:!0})],r.prototype,"link");e([a({type:Boolean,reflect:!0})],r.prototype,"grouped");e([a({type:String})],r.prototype,"type");e([a({type:Boolean})],r.prototype,"disabled");e([a({type:Boolean})],r.prototype,"loading");e([a({type:Boolean})],r.prototype,"toggle");e([a({type:Boolean})],r.prototype,"pressed");e([a({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel");e([a({attribute:!1})],r.prototype,"onClick");e([a({attribute:!1})],r.prototype,"onFocus");e([a({attribute:!1})],r.prototype,"onBlur");e([a({attribute:!1})],r.prototype,"onToggle");customElements.get("ag-button")||customElements.define("ag-button",r);export{k as Z,r as t};
