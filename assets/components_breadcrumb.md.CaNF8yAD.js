import{A as B}from"./chunks/AlphaWarning.CKFYAqLS.js";import{i as E,z as d,a as u,x as r}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{d as v,p as D,c as y,q as A,v as f,o as m,K as q,_ as x,C as w,j as a,G as p,a as k,ag as S,w as b,k as o}from"./chunks/framework.DmF2n0Fc.js";import{F as _}from"./chunks/FrameworkExample.Byhd3Bwz.js";import"./chunks/createLucideIcon.U6K_rCrv.js";import"./chunks/state-CovhUvdr.C-u8O0Fo.js";import"./chunks/sdk.m.Dxhqq5iP.js";import"./chunks/Button.BmTmCFep.js";import"./chunks/Icon.CxPOY7rJ.js";var P=Object.defineProperty,c=(t,s,i,h)=>{for(var n=void 0,e=t.length-1,l;e>=0;e--)(l=t[e])&&(n=l(s,i,n)||n);return n&&P(s,i,n),n};const C=class extends u{constructor(){super(),this._handleItemClick=(s,i,h)=>{const n=new CustomEvent("breadcrumb-click",{detail:{item:i,index:h,event:s},bubbles:!0,composed:!0});this.dispatchEvent(n),this.onBreadcrumbClick&&this.onBreadcrumbClick(n)},this.items=[],this.type="default",this.primary=!1,this.ariaLabel="Breadcrumb"}_renderBreadcrumbItem(s,i){const h=i===this.items.length-1,n=s.current||h;return r`
...
`,ts=JSON.parse('{"title":"Breadcrumb","description":"","frontmatter":{},"headers":[],"relativePath":"components/breadcrumb.md","filePath":"components/breadcrumb.md"}'),W={name:"components/breadcrumb.md"},es=Object.assign(W,{setup(t){return(s,i)=>(m(),y("div",null,[i[1]||(i[1]=a("h1",{id:"breadcrumb",tabindex:"-1"},[k("Breadcrumb "),a("a",{class:"header-anchor",href:"#breadcrumb","aria-label":'Permalink to "Breadcrumb"'},"​")],-1)),p(B),i[2]||(i[2]=a("p",null,[k("The "),a("code",null,"Breadcrumb"),k(" component is a "),a("span",{class:"quoted"},"wayfinding"),k(" element that helps make users aware of their current location within an application or website.")],-1)),i[3]||(i[3]=a("h2",{id:"examples",tabindex:"-1"},[k("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),p(_,{component:"breadcrumb","vue-code":o(O),"lit-code":o(j),"react-code":o(H)},{vue:b(()=>[p(M)]),lit:b(()=>[...i[0]||(i[0]=[a("breadcrumb-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),i[4]||(i[4]=S(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
