import{A as m}from"./chunks/AlphaWarning.BkRV4LZN.js";import{i as b,a as C,x as F}from"./chunks/lit-element.B0TUrqGF.js";import{z as d}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{d as E,p as B,c as y,q as D,v as A,o,K as v,_ as f,C as q,j as a,G as k,a as e,ae as x}from"./chunks/framework.BoyT2Jkt.js";var _=Object.defineProperty,g=(t,s,n,p)=>{for(var i=void 0,l=t.length-1,h;l>=0;l--)(h=t[l])&&(i=h(s,n,i)||i);return i&&_(s,n,i),i};const u=class extends C{constructor(){super(),this._handleItemClick=(s,n,p)=>{const i=new CustomEvent("breadcrumb-click",{detail:{item:n,index:p,event:s},bubbles:!0,composed:!0});this.dispatchEvent(i),this.onBreadcrumbClick&&this.onBreadcrumbClick(i)},this.items=[],this.type="default",this.primary=!1,this.ariaLabel="Breadcrumb"}_renderBreadcrumbItem(s,n){const p=n===this.items.length-1,i=s.current||p;return F`
