import{c as D,A}from"./chunks/AlphaWarning.D199zhtu.js";import{i as x,z as o,n as m,a as B,x as g,E as q,F as w}from"./chunks/FrameworkExample.DQckTML-.js";import"./chunks/IconButton.EheiJEd_.js";import{d as f,p as V,c as F,o as r,e as c,r as u,K as I,_ as z,C as _,j as a,G as n,w as y,ah as P,ai as L,ae as S,a as b,k as C}from"./chunks/framework.CdHt8f9T.js";import{C as R}from"./chunks/check.BKHGEuV_.js";import"./chunks/IconButton.CtiKGjPT.js";/**
...
`,ds=JSON.parse('{"title":"Copy Button","description":"","frontmatter":{},"headers":[],"relativePath":"components/copybutton.md","filePath":"components/copybutton.md"}'),ls={name:"components/copybutton.md"},gs=Object.assign(ls,{setup(l){return(s,i)=>(r(),F("div",null,[i[1]||(i[1]=a("h1",{id:"copy-button",tabindex:"-1"},[b("Copy Button "),a("a",{class:"header-anchor",href:"#copy-button","aria-label":'Permalink to "Copy Button"'},"​")],-1)),n(A),i[2]||(i[2]=a("p",null,"An accessible button component that copies text to the clipboard with visual feedback. The CopyButton automatically toggles between copy and checkmark icons and provides customizable success messaging.",-1)),i[3]||(i[3]=a("h2",{id:"examples",tabindex:"-1"},[b("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),n(w,{component:"copy-button","vue-code":C(as),"lit-code":C(ts),"react-code":C(ns)},{vue:y(()=>[n(ss)]),lit:y(()=>[...i[0]||(i[0]=[a("copybutton-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),i[4]||(i[4]=S(`<h2 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to &quot;Basic Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
