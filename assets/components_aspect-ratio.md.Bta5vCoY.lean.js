import{A as C}from"./chunks/AlphaWarning.BkRV4LZN.js";import{i as m,a as A,x as E}from"./chunks/lit-element.B0TUrqGF.js";import{z as k}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{d as y,c as F,o as r,r as D,af as b,ag as B,_ as v,j as t,ae as c,G as o,a as p}from"./chunks/framework.BoyT2Jkt.js";var f=Object.defineProperty,d=(h,a,s,e)=>{for(var i=void 0,n=h.length-1,g;n>=0;n--)(g=h[n])&&(i=g(a,s,i)||i);return i&&f(a,s,i),i};const u=class extends A{constructor(){super(),this.width=1,this.height=1,this.maxWidth=void 0}get _aspectStyle(){const a=this.width||1,s=this.height||1,e=`${a} / ${s}`,i=[];return i.push(`aspect-ratio: ${e};`),this.maxWidth!==void 0&&this.maxWidth!==null&&(i.push(`max-inline-size: ${this.maxWidth}px;`),i.push("margin-inline-start: auto; margin-inline-end: auto;")),i.join(" ")}render(){return E`
