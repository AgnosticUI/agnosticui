...
`,Us=JSON.parse('{"title":"Image","description":"","frontmatter":{"title":"Image"},"headers":[],"relativePath":"components/image.md","filePath":"components/image.md"}'),bs={name:"components/image.md"},Ts=Object.assign(bs,{setup(i){return(a,t)=>(A(),B("div",null,[t[1]||(t[1]=e("h1",{id:"image",tabindex:"-1"},[w("Image "),e("a",{class:"header-anchor",href:"#image","aria-label":'Permalink to "Image"'},"​")],-1)),r(Q),t[2]||(t[2]=R("",3)),r(ts,{component:"image","vue-code":h(us),"lit-code":h(Fs),"react-code":h(ys)},{vue:f(()=>[r(ms)]),lit:f(()=>[...t[0]||(t[0]=[e("image-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),t[3]||(t[3]=R("",48))]))}});export{Us as __pageData,Ts as default};
