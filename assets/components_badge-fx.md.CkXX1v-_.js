...
`,J=JSON.parse('{"title":"BadgeFx","description":"","frontmatter":{},"headers":[],"relativePath":"components/badge-fx.md","filePath":"components/badge-fx.md"}'),z={name:"components/badge-fx.md"},M=Object.assign(z,{setup(s){return(a,e)=>(k(),x("div",null,[e[1]||(e[1]=l("h1",{id:"badgefx",tabindex:"-1"},[r("BadgeFx "),l("a",{class:"header-anchor",href:"#badgefx","aria-label":'Permalink to "BadgeFx"'},"​")],-1)),t(b),e[2]||(e[2]=l("p",null,"BadgeFx extends the core Badge component with a handful of CSS-only micro-interaction effects.",-1)),e[3]||(e[3]=l("div",{class:"info custom-block"},[l("p",{class:"custom-block-title"},"Opt-in Component"),l("p",null,"BadgeFx adds a few hundred lines of CSS for animation effects. It's ideal for marketing sites, landing pages, or when visual polish is a priority.")],-1)),e[4]||(e[4]=l("h2",{id:"examples",tabindex:"-1"},[r("Examples "),l("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),t(E,{component:"badge-fx","vue-code":i(L),"lit-code":i(j),"react-code":i(N)},{vue:d(()=>[t(T)]),lit:d(()=>[...e[0]||(e[0]=[l("badgefx-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),e[5]||(e[5]=R(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
