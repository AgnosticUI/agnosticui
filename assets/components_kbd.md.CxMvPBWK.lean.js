import{A as v}from"./chunks/AlphaWarning.BeGEOyJF.js";import{i as c,a as C,x as B}from"./chunks/lit-element.B0TUrqGF.js";import{z as h}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{d as b,p as E,c as u,o as m,r as A,K as w,j as r,G as a,k as t,w as n,a as i,ae as z}from"./chunks/framework.DvJW1jwp.js";var x=Object.defineProperty,g=(d,l,s,k)=>{for(var o=void 0,F=d.length-1,y;F>=0;F--)(y=d[F])&&(o=y(l,s,o)||o);return o&&x(l,s,o),o};const f=class extends C{constructor(){super(),this.variant="default",this.bordered=!0,this.background=!1,this.size="md"}updated(l){super.updated(l),this._checkSingleChar()}_checkSingleChar(){var k;let l="";const s=(k=this.shadowRoot)==null?void 0:k.querySelector("slot");s&&(l=s.assignedNodes({flatten:!0}).map(o=>o.textContent||"").join("")),l=l.trim(),l.length===1?this.setAttribute("single-char","true"):this.removeAttribute("single-char")}_onSlotChange(){this._checkSingleChar()}render(){return B`
