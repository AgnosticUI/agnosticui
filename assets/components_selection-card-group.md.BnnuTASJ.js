import{A as V}from"./chunks/AlphaWarning.yC7ZufpQ.js";import{a as b,E as x,x as m,i as A,z as c}from"./chunks/Button.CfALiVhd.js";import{n as _}from"./chunks/state-CovhUvdr.DFO-h9iY.js";import{y as z}from"./chunks/face-mixin.Dz5PWcWd.js";import{d as C,c as v,o as y,r as E,K as B,_ as q,C as f,j as i,G as t,w as s,ae as R,a as S,k as F}from"./chunks/framework.NAAYCHZu.js";import{F as P}from"./chunks/FrameworkExample.DceoFvQt.js";import"./chunks/createLucideIcon.B61Wqv9x.js";import"./chunks/sdk.m.DhOmSlC9.js";import"./chunks/Icon.Dp0fxPe8.js";var T=Object.defineProperty,g=(l,e,a,o)=>{for(var d=void 0,r=l.length-1,n;r>=0;r--)(n=l[r])&&(d=n(e,a,d)||d);return d&&T(e,a,d),d};const D=class extends z(b){constructor(){super(),this._handleCardChange=e=>{e.stopPropagation();const{value:a,checked:o}=e.detail;let d;if(this.type==="radio")d=o?[a]:[];else{const n=[...this._getSelectedValues()];if(o)n.includes(a)||n.push(a);else{const p=n.indexOf(a);p>-1&&n.splice(p,1)}d=n}this._internalSelectedValues=d,this._syncFormValue(),this._syncValidity();const r=new CustomEvent("selection-change",{detail:{value:a,checked:o,selectedValues:d},bubbles:!0,composed:!0});this.dispatchEvent(r),this.onSelectionChange&&this.onSelectionChange(r)},this._handleKeyDown=e=>{const a=this._getCards().filter(n=>!n.disabled);if(a.length===0)return;const o=a.find(n=>{var p;try{return((p=n.shadowRoot)==null?void 0:p.activeElement)||n===document.activeElement}catch{return n===document.activeElement}}),d=o?a.indexOf(o):-1;let r=null;switch(e.key){case"ArrowDown":case"ArrowRight":e.preventDefault(),r=d===-1?0:(d+1)%a.length;break;case"ArrowUp":case"ArrowLeft":e.preventDefault(),r=d===-1?a.length-1:(d-1+a.length)%a.length;break;case"Home":e.preventDefault(),r=0;break;case"End":e.preventDefault(),r=a.length-1;break}if(r!==null){const n=a[r];n.focus(),this.type==="radio"&&this._handleCardChange(new CustomEvent("selection-card-change",{detail:{value:n.value,checked:!0}}))}},this.type="radio",this.legend="",this.legendHidden=!1,this.theme="",this.value="",this.values=[],this.disabled=!1,this.required=!1,this._internalSelectedValues=[],this.validationMessages=void 0}_getSelectedValues(){return this.type==="radio"?this.value?[this.value]:this._internalSelectedValues:this.values&&this.values.length>0?this.values:this._internalSelectedValues}_syncFormValue(){const e=this._getSelectedValues();if(this.type==="radio")this._internals.setFormValue(e.length>0?e[0]:null);else if(e.length===0)this._internals.setFormValue(null);else{const a=new FormData;e.forEach(o=>a.append(this.name,o)),this._internals.setFormValue(a)}}_syncValidity(){var a;const e=this._getSelectedValues();this.required&&e.length===0?this._internals.setValidity({valueMissing:!0},((a=this.validationMessages)==null?void 0:a.valueMissing)??"Please select an option."):this._internals.setValidity({})}formResetCallback(){this._internalSelectedValues=[],this._internals.setFormValue(null),this._syncValidity(),this._syncChildCards()}connectedCallback(){super.connectedCallback(),this.addEventListener("selection-card-change",this._handleCardChange),this.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("selection-card-change",this._handleCardChange),this.removeEventListener("keydown",this._handleKeyDown)}updated(e){super.updated(e),(e.has("type")||e.has("name")||e.has("theme")||e.has("disabled")||e.has("value")||e.has("values")||e.has("_internalSelectedValues"))&&this._syncChildCards(),e.has("value")||e.has("values")||e.has("_internalSelectedValues")?(this._syncFormValue(),this._syncValidity()):e.has("required")&&this._syncValidity()}firstUpdated(){this._syncChildCards(),this._syncFormValue(),this._syncValidity()}_getCards(){var a;const e=(a=this.shadowRoot)==null?void 0:a.querySelector("slot");return e?e.assignedElements({flatten:!0}).filter(o=>o.tagName.toLowerCase()==="ag-selection-card"):[]}_syncChildCards(){const e=this._getCards(),a=this._getSelectedValues();e.forEach(o=>{o._type=this.type,o._name=this.name,o._theme=this.theme,o.checked=a.includes(o.value),this.disabled&&(o.disabled=!0)})}_handleSlotChange(){this._syncChildCards()}render(){const e=["selection-card-group__legend",this.legendHidden?"selection-card-group__legend--hidden":""].filter(Boolean).join(" ");return m`
      <fieldset
...
`,oe=JSON.parse('{"title":"SelectionCardGroup","description":"","frontmatter":{},"headers":[],"relativePath":"components/selection-card-group.md","filePath":"components/selection-card-group.md"}'),Q={name:"components/selection-card-group.md"},ce=Object.assign(Q,{setup(l){return(e,a)=>(y(),v("div",null,[a[1]||(a[1]=i("h1",{id:"selectioncardgroup",tabindex:"-1"},[S("SelectionCardGroup "),i("a",{class:"header-anchor",href:"#selectioncardgroup","aria-label":'Permalink to "SelectionCardGroup"'},"​")],-1)),t(V),a[2]||(a[2]=i("p",null,"A card-based selection UI for single (radio) or multiple (checkbox) selection. Ideal for onboarding flows, preferences, pricing tiers, and feature opt-ins.",-1)),a[3]||(a[3]=i("h2",{id:"examples",tabindex:"-1"},[S("Examples "),i("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),t(P,{component:"selection-card-group","vue-code":F(U),"lit-code":F(J),"react-code":F(Y)},{vue:s(()=>[t(j)]),lit:s(()=>[...a[0]||(a[0]=[i("selection-card-group-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[4]||(a[4]=R(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
