import{C as Y,A as H}from"./chunks/AlphaWarning.CKFYAqLS.js";import{o as v}from"./chunks/slot.CsrcmCtp.js";import{i as Z,z as u,a as q,x as c}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{n as z}from"./chunks/state-CovhUvdr.C-u8O0Fo.js";import{d as G,p as $,c as m,o as b,e as x,r as A,K as X,_ as O,C as p,j as t,G as i,w as a,a as h,ag as J,k as f}from"./chunks/framework.DmF2n0Fc.js";import{v as K}from"./chunks/VueButton.vue_vue_type_script_setup_true_lang-D1jGatE9.Cl3S9w1o.js";import{c as y}from"./chunks/createLucideIcon.U6K_rCrv.js";import{R as Q}from"./chunks/rocket.DPaF681F.js";import{Z as ss}from"./chunks/sdk.m.Dxhqq5iP.js";import{S as is}from"./chunks/sparkles.ByoJBPUo.js";import{S as ts}from"./chunks/send.1bmp-GV0.js";import{A as as}from"./chunks/arrow-right.BWXWBkBL.js";import{S as ns}from"./chunks/shopping-cart.CyjOrtuh.js";import{U as es}from"./chunks/upload.C_oAgEWl.js";import{P as ls}from"./chunks/plus.FNgzR7Pn.js";import{M as ps}from"./chunks/mail.CtoDvRX1.js";import{H as hs}from"./chunks/heart.C0EURoXe.js";import{F as rs}from"./chunks/folder.DOCtEfa1.js";import{F as os}from"./chunks/FrameworkExample.Byhd3Bwz.js";import"./chunks/Button.BmTmCFep.js";import"./chunks/Icon.CxPOY7rJ.js";/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ks=y("chart-column",[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16",key:"c24i48"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]]);/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ds=y("file-text",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gs=y("lock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]]);/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cs=y("mic",[["path",{d:"M12 19v3",key:"npa21l"}],["path",{d:"M19 10v2a7 7 0 0 1-14 0v-2",key:"1vc78b"}],["rect",{x:"9",y:"2",width:"6",height:"13",rx:"3",key:"s6n7sd"}]]);/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const us=y("search-x",[["path",{d:"m13.5 8.5-5 5",key:"1cs55j"}],["path",{d:"m8.5 8.5 5 5",key:"a8mexj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);var ys=Object.defineProperty,F=(r,s,e,g)=>{for(var o=void 0,d=r.length-1,n;d>=0;d--)(n=r[d])&&(o=n(s,e,o)||o);return o&&ys(s,e,o),o};const S=class extends q{constructor(){super(),this._hasIconSlot=!1,this._hasActionsSlot=!1,this.title="",this.subtitle="",this.buttonText="",this.size="md",this.bordered=!1,this.rounded=!1}_handleSlotChange(s){const e=s.target,g=e.name;g==="icon"?this._hasIconSlot=v(e):g==="actions"&&(this._hasActionsSlot=v(e))}firstUpdated(){setTimeout(()=>{var d,n;const s=(d=this.shadowRoot)==null?void 0:d.querySelector('slot[name="icon"]'),e=(n=this.shadowRoot)==null?void 0:n.querySelector('slot[name="actions"]'),g=this._hasIconSlot,o=this._hasActionsSlot;this._hasIconSlot=v(s),this._hasActionsSlot=v(e),(g!==this._hasIconSlot||o!==this._hasActionsSlot)&&this.requestUpdate()},0)}render(){const s=["empty",this.bordered?"empty-bordered":"",this.rounded?"empty-rounded":""].filter(Boolean).join(" ");return c`
      ...
      <div class="${s}" role="region" aria-label="Empty state" part="ag-empty-state">
        ...
        <!-- Title part -->
        ${this.title?c`<h3 class="title" part="ag-title">${this.title}</h3>`:""}

        <!-- Subtitle part -->
        ${this.subtitle?c`<p class="subtitle" part="ag-subtitle">${this.subtitle}</p>`:""}
        ...
        <div class="actions" part="ag-actions">
          <slot name="actions" part="ag-actions-slot" @slotchange=${this._handleSlotChange}>
            ${this.buttonText&&!this._hasActionsSlot?c`
  ...
  `;let k=S;F([u({type:String})],k.prototype,"title");F([u({type:String})],k.prototype,"subtitle");F([u({type:String,attribute:"button-text"})],k.prototype,"buttonText");F([u({type:String,reflect:!0})],k.prototype,"size");F([u({type:Boolean})],k.prototype,"bordered");F([u({type:Boolean})],k.prototype,"rounded");F([z()],k.prototype,"_hasIconSlot");F([z()],k.prototype,"_hasActionsSlot");customElements.get("ag-empty-state")||customElements.define("ag-empty-state",k);const ms=[".bordered",".rounded","title","subtitle","buttonText","size"],bs={key:0,slot:"icon"},vs={key:1,slot:"actions"},Cs=G({__name:"VueEmptyState",props:{title:{default:""},subtitle:{default:""},buttonText:{default:""},size:{default:"md"},bordered:{type:Boolean,default:!1},rounded:{type:Boolean,default:!1}},setup(r){const s=$();return(e,g)=>(b(),m("ag-empty-state",X({ref_key:"agComponent",ref:s,".bordered":r.bordered,".rounded":r.rounded,title:r.title,subtitle:r.subtitle,buttonText:r.buttonText,size:r.size},e.$attrs),[e.$slots.icon?(b(),m("span",bs,[A(e.$slots,"icon")])):x("",!0),e.$slots.actions?(b(),m("span",vs,[A(e.$slots,"actions")])):x("",!0)],48,ms))}}),Bs={name:"EmptyStateExamples",components:{VueEmptyState:Cs,VueButton:K,SearchX:us,Folder:rs,Heart:hs,Mail:ps,Plus:ls,Upload:es,FileText:ds,ShoppingCart:ns,ArrowRight:as,Inbox:Fs,BarChart3:ks,AlertCircle:Y,Send:ts,Lock:gs,Sparkles:is,Zap:ss,Rocket:Q,Mic:cs},methods:{handleClearFilters(){console.log("Clearing filters...")}}},Es={class:"mbe6"},fs={class:"mbe6"},ws={class:"mbe6"},xs={class:"mbe6"},As={style:{display:"flex",gap:"0.5rem","justify-content":"center","flex-wrap":"wrap"}},qs={style:{display:"flex",gap:"0.5rem","flex-wrap":"wrap","justify-content":"center"}},zs={class:"mbe6"},Ss={style:{display:"flex",gap:"0.5rem","justify-content":"center","flex-wrap":"wrap"}},Ds={class:"mbe6"},Vs={style:{display:"flex",gap:"0.5rem","justify-content":"center","flex-wrap":"wrap"}},Ns={style:{display:"grid","grid-template-columns":"repeat(auto-fit, minmax(280px, 1fr))",gap:"var(--ag-space-4)"},class:"mbe6"},Rs={class:"mbe6"},Ts={class:"mbe6"},js={style:{display:"flex",gap:"0.5rem","flex-wrap":"wrap","justify-content":"center"}},Ms={style:{display:"flex",gap:"0.5rem","align-items":"center","justify-content":"center","flex-wrap":"wrap"}};function Is(r,s,e,g,o,d){const n=p("VueEmptyState"),w=p("SearchX"),C=p("Folder"),D=p("Heart"),V=p("Mail"),l=p("VueButton"),N=p("Plus"),R=p("Upload"),T=p("FileText"),j=p("ShoppingCart"),M=p("ArrowRight"),I=p("Inbox"),P=p("BarChart3"),B=p("AlertCircle"),_=p("Send"),L=p("Lock"),U=p("Rocket"),W=p("Sparkles"),E=p("Mic");return b(),m("section",null,[s[19]||(s[19]=t("div",{class:"mbe4"},[t("h2",null,"Basic Empty State"),t("p",{class:"mbs2 mbe3"},"Simple empty state with title and subtitle")],-1)),i(n,{title:"No items found",subtitle:"Get started by creating your first item",class:"mbe6"}),s[20]||(s[20]=t("div",{class:"mbe4"},[t("h2",null,"With Action Button"),t("p",{class:"mbs2 mbe3"},"Include a primary action button using the buttonText prop")],-1)),i(n,{title:"No projects yet",subtitle:"Create your first project to get started",buttonText:"New Project",class:"mbe6 empty-state-with-button"}),s[21]||(s[21]=t("div",{class:"mbe4"},[t("h2",null,"Size Variants"),t("p",{class:"mbs2 mbe3"},"Choose from small, medium, or large sizes to fit your layout")],-1)),t("div",Es,[i(n,{title:"No notifications",subtitle:"You're all caught up!",size:"sm",class:"mbe4"}),i(n,{title:"No activity",subtitle:"Recent activity will appear here",size:"md",class:"mbe4"}),i(n,{title:"Welcome!",subtitle:"Start your journey here",buttonText:"Get Started",size:"lg",class:"empty-state-with-button"})]),s[22]||(s[22]=t("div",{class:"mbe4"},[t("h2",null,"Bordered & Rounded"),t("p",{class:"mbs2 mbe3"},"Add visual separation with borders and rounded corners")],-1)),t("div",fs,[i(n,{title:"No data available",subtitle:"Upload a file to see your data",buttonText:"Upload File",bordered:!0,class:"empty-state-with-button mbe4"}),i(n,{title:"Empty folder",subtitle:"This folder contains no files yet",buttonText:"Add Files",rounded:!0,class:"empty-state-with-button mbe4"}),i(n,{title:"No messages",subtitle:"Send your first message",buttonText:"New Message",bordered:!0,rounded:!0,class:"empty-state-with-button"})]),s[23]||(s[23]=t("div",{class:"mbe4"},[t("h2",null,"Custom Icons"),t("p",{class:"mbs2 mbe3"},"Provide custom icons that match your context using the icon slot")],-1)),t("div",ws,[i(n,{title:"No search results",subtitle:"Try different keywords or remove filters",rounded:!0,size:"md",class:"mbe4"},{icon:a(()=>[i(w,{size:40,color:"#999"})]),_:1}),i(n,{title:"No files",subtitle:"Drag and drop files here",size:"md",bordered:!0,rounded:!0,class:"mbe4"},{icon:a(()=>[i(C,{size:56,color:"#999"})]),_:1}),i(n,{title:"No favorites yet",subtitle:"Mark items as favorites to see them here",rounded:!0,size:"md"},{icon:a(()=>[i(D,{size:32,color:"#ef4444"})]),_:1})]),s[24]||(s[24]=t("div",{class:"mbe4"},[t("h2",null,"Custom Actions"),t("p",{class:"mbs2 mbe3"},"Use the actions slot for complete control over buttons and interactions")],-1)),t("div",xs,[i(n,{title:"No team members",subtitle:"Invite people to collaborate",size:"md",bordered:!0,rounded:!0,class:"mbe4"},{actions:a(()=>[t("div",As,[i(l,{variant:"primary",size:"sm",shape:"rounded"},{default:a(()=>[i(V,{size:16}),s[0]||(s[0]=t("span",{style:{"margin-inline-start":"4px"}},"Invite Members",-1))]),_:1}),i(l,{variant:"secondary",size:"sm",shape:"rounded"},{default:a(()=>[...s[1]||(s[1]=[h(" Learn More ",-1)])]),_:1})])]),_:1}),i(n,{title:"Start your journey",subtitle:"Choose how you want to begin",size:"md",bordered:!0,rounded:!0},{icon:a(()=>[i(C,{size:56,color:"#999"})]),actions:a(()=>[t("div",qs,[i(l,{variant:"primary",size:"sm",shape:"rounded",isBordered:!0},{default:a(()=>[i(N,{size:16}),s[2]||(s[2]=t("span",{style:{"margin-inline-start":"4px"}},"Create New",-1))]),_:1}),i(l,{variant:"primary",size:"sm",shape:"rounded",isBordered:!0},{default:a(()=>[i(R,{size:16}),s[3]||(s[3]=t("span",{style:{"margin-inline-start":"4px"}},"Import Data",-1))]),_:1}),i(l,{variant:"primary",size:"sm",shape:"rounded",isBordered:!0},{default:a(()=>[i(T,{size:16}),s[4]||(s[4]=t("span",{style:{"margin-inline-start":"4px"}},"Use Template",-1))]),_:1})])]),_:1})]),s[25]||(s[25]=t("div",{class:"mbe4"},[t("h2",null,"Real-World Examples"),t("p",{class:"mbs2 mbe3"},"Common patterns for shopping cart, inbox, dashboard, and error states")],-1)),t("div",zs,[i(n,{title:"Your cart is empty",subtitle:"Add items to see them here",size:"md",bordered:!0,rounded:!0,class:"mbe4"},{icon:a(()=>[i(j,{size:48,color:"#999"})]),actions:a(()=>[i(l,{variant:"primary",shape:"rounded",size:"md"},{default:a(()=>[s[5]||(s[5]=h(" Continue Shopping ",-1)),i(M,{size:16,style:{"margin-inline-start":"4px"}})]),_:1})]),_:1}),i(n,{title:"Inbox Zero! 🎉",subtitle:"All caught up. No new messages.",size:"md",rounded:!0,class:"mbe4"},{icon:a(()=>[i(I,{size:40,color:"#10b981"})]),_:1}),i(n,{title:"No analytics data yet",subtitle:"Data will appear once you start tracking",bordered:!0,rounded:!0,class:"mbe4"},{icon:a(()=>[i(P,{size:56,color:"#6366f1"})]),actions:a(()=>[i(l,{isGhost:!0,size:"md"},{default:a(()=>[...s[6]||(s[6]=[h(" View Documentation ",-1)])]),_:1})]),_:1}),i(n,{title:"Something went wrong",subtitle:"Please try again or contact support",size:"md",rounded:!0,bordered:!0},{icon:a(()=>[i(B,{size:48,color:"#ef4444"})]),actions:a(()=>[t("div",Ss,[i(l,{variant:"danger",shape:"rounded",isBordered:!0,size:"md"},{default:a(()=>[...s[7]||(s[7]=[h(" Try Again ",-1)])]),_:1}),i(l,{variant:"secondary",shape:"rounded",isBordered:!0,size:"md"},{default:a(()=>[s[8]||(s[8]=t("span",{style:{"margin-inline-end":"0.125rem"}},"Contact Support",-1)),i(_,{size:16})]),_:1})])]),_:1})]),s[26]||(s[26]=t("div",{class:"mbe4"},[t("h2",null,"State-Specific Variants"),t("p",{class:"mbs2 mbe3"},"Empty states for different scenarios with appropriate icons and actions")],-1)),t("div",Ds,[i(n,{title:"No matches found",subtitle:"Try adjusting your filters or search",size:"md",bordered:!0,class:"mbe4"},{icon:a(()=>[i(w,{size:40,color:"#999"})]),actions:a(()=>[i(l,{variant:"secondary",shape:"rounded",size:"sm",onClick:d.handleClearFilters},{default:a(()=>[...s[9]||(s[9]=[h(" Clear Filters ",-1)])]),_:1},8,["onClick"])]),_:1}),i(n,{title:"Action Required",subtitle:"This action cannot be undone",size:"md",bordered:!0,rounded:!0,class:"mbe4"},{icon:a(()=>[i(B,{size:48,color:"#f59e0b"})]),actions:a(()=>[t("div",Vs,[i(l,{variant:"warning",size:"md"},{default:a(()=>[...s[10]||(s[10]=[h(" Proceed Anyway ",-1)])]),_:1}),i(l,{variant:"secondary",size:"md"},{default:a(()=>[...s[11]||(s[11]=[h(" Cancel ",-1)])]),_:1})])]),_:1}),i(n,{title:"Access Required",subtitle:"You don't have permission to view this",size:"md",bordered:!0},{icon:a(()=>[i(L,{size:48,color:"#999"})]),actions:a(()=>[i(l,{variant:"primary",shape:"rounded",size:"md"},{default:a(()=>[...s[12]||(s[12]=[h(" Request Access ",-1)])]),_:1})]),_:1})]),s[27]||(s[27]=t("div",{class:"mbe4"},[t("h2",null,"Compact Size Showcase"),t("p",{class:"mbs2 mbe3"},"Small empty states work great in sidebars, cards, or dense layouts")],-1)),t("div",Ns,[i(n,{title:"No tasks",subtitle:"Create a task to get started",buttonText:"New Task",size:"sm",bordered:!0,rounded:!0,class:"empty-state-with-button"}),i(n,{title:"No events",subtitle:"Schedule your first event",buttonText:"Add Event",size:"sm",bordered:!0,rounded:!0,class:"empty-state-with-button"}),i(n,{title:"No contacts",subtitle:"Add contacts to your list",buttonText:"Add Contact",size:"sm",bordered:!0,rounded:!0,class:"empty-state-with-button"}),i(n,{title:"No notes",subtitle:"Jot down your first note",buttonText:"Create Note",size:"sm",bordered:!0,rounded:!0,class:"empty-state-with-button"})]),s[28]||(s[28]=t("div",{class:"mbe4"},[t("h2",null,"CSS Shadow Parts Customization"),t("p",{class:"mbs2 mbe3"},[h(" Use CSS Shadow Parts to customize appearance: "),t("code",null,"::part(ag-empty-state)"),h(", "),t("code",null,"::part(ag-icon)"),h(", "),t("code",null,"::part(ag-title)"),h(", "),t("code",null,"::part(ag-subtitle)"),h(", "),t("code",null,"::part(ag-actions)")])],-1)),t("div",Rs,[i(n,{title:"Colorful Accent",subtitle:"Icon with background circle",buttonText:"Start Now",bordered:!0,class:"custom-empty-state-3"},{icon:a(()=>[i(U,{size:48,color:"#f59e0b"})]),_:1})]),s[29]||(s[29]=t("div",{class:"mbe4"},[t("h2",null,"Minimal Empty States"),t("p",{class:"mbs2 mbe3"},"Simple empty states without icons for clean, understated designs")],-1)),t("div",Ts,[i(n,{title:"Nothing here yet",size:"sm",rounded:!0,class:"mbe4"}),i(n,{title:"No activity",subtitle:"Recent activity will appear here",size:"md",rounded:!0,class:"mbe4"}),i(n,{title:"Empty",rounded:!0,size:"md"})]),s[30]||(s[30]=t("div",{class:"mbe4"},[t("h2",null,"Large Welcome States"),t("p",{class:"mbs2 mbe3"},"Spacious layouts perfect for onboarding and full-page empty states")],-1)),i(n,{title:"Welcome to Your Dashboard",subtitle:"Add some content and you'll see it appear here. You'll be able to manage projects and collaborate with your team.",buttonText:"Get Started",size:"lg",bordered:!0,rounded:!0,class:"empty-state-with-button mbe6"},{icon:a(()=>[i(W,{size:48,color:"#6366f1"})]),_:1}),s[31]||(s[31]=t("div",{class:"mbe4"},[t("h2",null,"Multiple Button Variants"),t("p",{class:"mbs2 mbe3"},"Showcase different button styles in custom actions")],-1)),i(n,{title:"Choose your action",subtitle:"Different button styles for different purposes",size:"md",bordered:!0,rounded:!0,class:"mbe6"},{icon:a(()=>[i(B,{size:40,color:"#999"})]),actions:a(()=>[t("div",js,[i(l,{variant:"primary",size:"sm",shape:"rounded"},{default:a(()=>[...s[13]||(s[13]=[h(" Primary Action ",-1)])]),_:1}),i(l,{variant:"secondary",size:"sm",shape:"rounded",isBordered:!0},{default:a(()=>[...s[14]||(s[14]=[h(" Secondary ",-1)])]),_:1}),i(l,{size:"sm",shape:"rounded",isBordered:!0},{default:a(()=>[...s[15]||(s[15]=[h(" Default ",-1)])]),_:1})])]),_:1}),s[32]||(s[32]=t("div",{class:"mbe4"},[t("h2",null,"Button Size Variations"),t("p",{class:"mbs2 mbe3"},"Match button sizes to your empty state size for visual harmony")],-1)),i(n,{title:"Different Button Sizes",subtitle:"Choose the right size for your layout",size:"md",bordered:!0,rounded:!0,class:"mbe6"},{icon:a(()=>[i(C,{size:48,color:"#999"})]),actions:a(()=>[t("div",Ms,[i(l,{variant:"primary",size:"sm",shape:"rounded",isBordered:!0},{default:a(()=>[i(E,{size:14}),s[16]||(s[16]=t("span",{style:{"margin-inline-start":"4px"}},"Small",-1))]),_:1}),i(l,{variant:"primary",size:"md",shape:"rounded",isBordered:!0},{default:a(()=>[i(E,{size:18}),s[17]||(s[17]=t("span",{style:{"margin-inline-start":"4px"}},"Medium",-1))]),_:1}),i(l,{variant:"primary",size:"lg",shape:"rounded",isBordered:!0},{default:a(()=>[i(E,{size:24}),s[18]||(s[18]=t("span",{style:{"margin-inline-start":"4px"}},"Large",-1))]),_:1})])]),_:1})])}const Ps=O(Bs,[["render",Is],["__scopeId","data-v-d772e1e5"]]);class _s extends q{createRenderRoot(){return this}render(){return c`
      <style>
    ...
    `}}customElements.define("empty-state-lit-examples",_s);const Ls=`<template>
  <section>
    <div class="mbe4">
      <h2>Basic Empty State</h2>
      <p class="mbs2 mbe3">Simple empty state with title and subtitle</p>
...
`,Us=`import { LitElement, html } from "lit";
...
`,Fi=JSON.parse('{"title":"Empty State","description":"","frontmatter":{},"headers":[],"relativePath":"components/empty-state.md","filePath":"components/empty-state.md"}'),Ys={name:"components/empty-state.md"},gi=Object.assign(Ys,{setup(r){return(s,e)=>(b(),m("div",null,[e[1]||(e[1]=t("h1",{id:"empty-state",tabindex:"-1"},[h("Empty State "),t("a",{class:"header-anchor",href:"#empty-state","aria-label":'Permalink to "Empty State"'},"​")],-1)),i(H),e[2]||(e[2]=t("p",null,"A versatile component for displaying empty states, placeholder content, and messaging when no data is available. Helps guide users toward meaningful actions and provides clear context about why content is missing.",-1)),e[3]||(e[3]=t("h2",{id:"examples",tabindex:"-1"},[h("Examples "),t("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(os,{component:"empty-state","vue-code":f(Ls),"lit-code":f(Us),"react-code":f(Ws)},{vue:a(()=>[i(Ps)]),lit:a(()=>[...e[0]||(e[0]=[t("empty-state-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),e[4]||(e[4]=J(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
...
<span class="line"><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">    &lt;/</span><span style="--shiki-light:#024C1A;--shiki-dark:#72F088;">div</span><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">  &lt;/</span><span style="--shiki-light:#024C1A;--shiki-dark:#72F088;">div</span><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&lt;/</span><span style="--shiki-light:#024C1A;--shiki-dark:#72F088;">template</span><span style="--shiki-light:#0E1116;--shiki-dark:#F0F3F6;">&gt;</span></span></code></pre></div><h2 id="resources" tabindex="-1">Resources <a class="header-anchor" href="#resources" aria-label="Permalink to &quot;Resources&quot;">​</a></h2><ul><li><a href="https://material.io/design/communication/empty-states.html" target="_blank" rel="noreferrer">Empty States: Material Design</a></li><li><a href="https://uxdesign.cc/empty-state-best-practices-3d3f3f3f3f3f" target="_blank" rel="noreferrer">Empty State Best Practices - UX Collective</a></li><li><a href="https://www.smashingmagazine.com/2020/03/designing-better-empty-states/" target="_blank" rel="noreferrer">Designing Better Empty States</a></li></ul>`,92))]))}});export{Fi as __pageData,gi as default};
