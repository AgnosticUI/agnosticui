import{A}from"./chunks/AlphaWarning.BkRV4LZN.js";import{i as x,a as D,x as g,b}from"./chunks/lit-element.B0TUrqGF.js";import{z as d}from"./chunks/property-CemaeiRl.BAjarvIB.js";import{n as y}from"./chunks/state-CovhUvdr.BllWkzJh.js";import{Q as f}from"./chunks/if-defined-C8i28hSj.CfeO1FY9.js";import{a as P,i as $,t as C,u as q}from"./chunks/form-control-utils.DRSK-DHo.js";import{d as B,p as F,c as v,o as m,r as R,K as V,_,C as H,j as e,G as h,t as u,ae as S,a as E}from"./chunks/framework.BoyT2Jkt.js";import"./chunks/unique-id.CpwMFgRD.js";var I=Object.defineProperty,p=(n,s,i,a)=>{for(var l=void 0,r=n.length-1,t;r>=0;r--)(t=n[r])&&(l=t(s,i,l)||l);return l&&I(s,i,l),l};let L=0;const w=class extends D{constructor(){super(),this.uniqueId=++L,this._ratingId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this.hoverValue=0,this.isHovering=!1,this.isPointerDown=!1;const s=$("rating");this._ratingId=s.inputId,this._labelId=s.labelId,this._helperId=s.helperId,this._errorId=s.errorId,this.value=0,this.max=5,this.precision="whole",this.readonly=!1,this.allowClear=!1,this.variant="",this.size="md",this.name="",this.label="",this.labelHidden=!1,this.noLabel=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.handlePointerMove=this.handlePointerMove.bind(this),this.handlePointerUp=this.handlePointerUp.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleKeyDown),this.removeGlobalPointerListeners()}renderLabel(){if(!this.label||this.noLabel)return"";const s=[];return C(this.labelPosition)?(s.push("ag-form-control__label--horizontal"),s.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&s.push(`ag-form-control__label--${this.labelPosition}`),g`
      <label
        id=${this._labelId}
        for=${this._ratingId}
