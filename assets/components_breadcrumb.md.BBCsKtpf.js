import{A as B}from"./chunks/AlphaWarning.D199zhtu.js";import{i as E,z as d,a as b,x as r,F as v}from"./chunks/FrameworkExample.DQckTML-.js";import{d as D,p as A,c as y,q as f,v as q,o as m,K as x,_ as w,C as S,j as a,G as p,a as k,ae as _,w as u,k as o}from"./chunks/framework.CdHt8f9T.js";var P=Object.defineProperty,c=(t,s,i,h)=>{for(var n=void 0,e=t.length-1,l;e>=0;e--)(l=t[e])&&(n=l(s,i,n)||n);return n&&P(s,i,n),n};const C=class extends b{constructor(){super(),this._handleItemClick=(s,i,h)=>{const n=new CustomEvent("breadcrumb-click",{detail:{item:i,index:h,event:s},bubbles:!0,composed:!0});this.dispatchEvent(n),this.onBreadcrumbClick&&this.onBreadcrumbClick(n)},this.items=[],this.type="default",this.primary=!1,this.ariaLabel="Breadcrumb"}_renderBreadcrumbItem(s,i){const h=i===this.items.length-1,n=s.current||h;return r`
  ...
  `;let F=C;c([d({type:Array})],F.prototype,"items");c([d({type:String,reflect:!0})],F.prototype,"type");c([d({type:Boolean,reflect:!0})],F.prototype,"primary");c([d({type:String,reflect:!0,attribute:"aria-label"})],F.prototype,"ariaLabel");c([d({attribute:!1})],F.prototype,"onBreadcrumbClick");customElements.get("ag-breadcrumb")||customElements.define("ag-breadcrumb",F);const T=["type",".primary",".ariaLabel"],V=D({__name:"VueBreadcrumb",props:{items:{},type:{default:"default"},primary:{type:Boolean,default:!1},ariaLabel:{default:"Breadcrumb"}},emits:["breadcrumb-click"],setup(t,{emit:s}){const i=t,h=s,n=A(),e=g=>{h("breadcrumb-click",g.detail)},l=()=>{n.value&&(n.value.items=i.items)};return f(()=>i.items,l,{deep:!0}),q(async()=>{await customElements.whenDefined("ag-breadcrumb"),n.value&&l()}),(g,J)=>(m(),y("ag-breadcrumb",x({ref_key:"breadcrumbRef",ref:n,type:t.type,".primary":t.primary,".ariaLabel":t.ariaLabel,onBreadcrumbClick:e},g.$attrs),null,48,T))}}),N={name:"BreadcrumbExamples",components:{VueBreadcrumb:V},data(){return{items:[{label:"Home",href:"#"},{label:"About",href:"#about"},{label:"Services",href:"#services"},{label:"Products",href:"#products"}]}},methods:{handleClick(t){console.log(`VueBreadcrumb -> handleClick -- label: ${t.item.label}, href: ${t.item.href}`)}}},R={class:"mbe4"},L={class:"mbe4"},I={class:"mbe4"},z={style:{display:"flex","flex-direction":"column",gap:"2rem"}};function $(t,s,i,h,n,e){const l=S("VueBreadcrumb");return m(),y("section",null,[a("div",R,[s[0]||(s[0]=a("div",{class:"mbe2"},[a("h2",null,"Default")],-1)),p(l,{items:n.items,onBreadcrumbClick:e.handleClick},null,8,["items","onBreadcrumbClick"])]),a("div",L,[s[1]||(s[1]=a("div",{class:"mbe2"},[a("h2",null,"Types")],-1)),p(l,{class:"mbe4",type:"slash",items:n.items,onBreadcrumbClick:e.handleClick},null,8,["items","onBreadcrumbClick"]),p(l,{class:"mbe4",type:"bullet",items:n.items,onBreadcrumbClick:e.handleClick},null,8,["items","onBreadcrumbClick"]),p(l,{class:"mbe4",type:"arrow",items:n.items,onBreadcrumbClick:e.handleClick},null,8,["items","onBreadcrumbClick"]),p(l,{primary:"",type:"arrow",items:n.items,onBreadcrumbClick:e.handleClick},null,8,["items","onBreadcrumbClick"])]),a("div",I,[s[4]||(s[4]=a("div",{class:"mbe2"},[a("h2",null,"CSS Shadow Parts Customization"),a("p",{style:{"margin-top":"0.5rem","margin-bottom":"1rem",color:"var(--vp-c-text-2)"}},[k(" Breadcrumb can be customized using CSS Shadow Parts: "),a("code",null,"::part(ag-breadcrumb-item)"),k(", "),a("code",null,"::part(ag-breadcrumb-item-link)"),k(", "),a("code",null,"::part(ag-breadcrumb-item-current)"),k(". The following are meant solely to show how to utilize CSS shadow parts to create custom breadcrumb styles. They are NOT meant to represent best practices or good taste in breadcrumb design! ")])],-1)),a("div",z,[a("div",null,[s[2]||(s[2]=a("h3",null,"Minimal with Underline",-1)),s[3]||(s[3]=a("div",{class:"mbe3"},null,-1)),p(l,{class:"custom-minimal-breadcrumb",items:n.items},null,8,["items"])])])])])}const M=w(N,[["render",$],["__scopeId","data-v-a207b872"]]);class U extends b{createRenderRoot(){return this}constructor(){super(),this.items=[{label:"Home",href:"#"},{label:"About",href:"#about"},{label:"Services",href:"#services"},{label:"Products",href:"#products"}]}firstUpdated(){this.querySelectorAll("ag-breadcrumb").forEach(i=>{i.items=this.items,i.addEventListener("breadcrumb-click",h=>{console.log(`ag-breadcrumb -> breadcrumb-click -- label: ${h.detail.item.label}, href: ${h.detail.item.href}`)})})}render(){return r`
      <section>
        <!-- Default -->
        <div class="mbe4">
          <div class="mbe2">
...
`,Y=JSON.parse('{"title":"Breadcrumb","description":"","frontmatter":{},"headers":[],"relativePath":"components/breadcrumb.md","filePath":"components/breadcrumb.md"}'),W={name:"components/breadcrumb.md"},Z=Object.assign(W,{setup(t){return(s,i)=>(m(),y("div",null,[i[1]||(i[1]=a("h1",{id:"breadcrumb",tabindex:"-1"},[k("Breadcrumb "),a("a",{class:"header-anchor",href:"#breadcrumb","aria-label":'Permalink to "Breadcrumb"'},"​")],-1)),p(B),i[2]||(i[2]=a("p",null,[k("The "),a("code",null,"Breadcrumb"),k(" component is a "),a("span",{class:"quoted"},"wayfinding"),k(" element that helps make users aware of their current location within an application or website.")],-1)),i[3]||(i[3]=a("h2",{id:"examples",tabindex:"-1"},[k("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),p(v,{component:"breadcrumb","vue-code":o(O),"lit-code":o(j),"react-code":o(H)},{vue:u(()=>[p(M)]),lit:u(()=>[...i[0]||(i[0]=[a("breadcrumb-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),i[4]||(i[4]=_(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
