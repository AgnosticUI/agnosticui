var L=Object.defineProperty;var M=(t,s,i)=>s in t?L(t,s,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[s]=i;var _=(t,s,i)=>M(t,typeof s!="symbol"?s+"":s,i);import{A as N}from"./chunks/AlphaWarning.CKFYAqLS.js";import{a as V,x as F,i as W,z as o}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{n as A}from"./chunks/state-CovhUvdr.C-u8O0Fo.js";import{f as R}from"./chunks/query-BykXNUlT.Pm7lu9c1.js";import{Q as u}from"./chunks/Button.BmTmCFep.js";import{i as U,t as S,u as j,a as H}from"./chunks/form-control-utils.BYIX_mid.js";import{c as O}from"./chunks/face-mixin.MgCHLM8W.js";import{d as P,p as B,c as y,o as v,K as G,_ as Y,C as X,j as a,G as r,e as w,F as q,B as $,t as C,a as b,ag as J,w as T,k as x}from"./chunks/framework.DmF2n0Fc.js";import{F as K}from"./chunks/FrameworkExample.Duc6fCJB.js";import"./chunks/createLucideIcon.U6K_rCrv.js";import"./chunks/sdk.m.Dxhqq5iP.js";import"./chunks/Icon.CxPOY7rJ.js";var Q=Object.defineProperty,k=(t,s,i,n)=>{for(var l=void 0,d=t.length-1,e;d>=0;d--)(e=t[d])&&(l=e(s,i,l)||l);return l&&Q(s,i,l),l};const z=class extends O(V){constructor(){super(),this._defaultValue=0,this._activeDrag=null,this._lastRenderTime=0,this._renderThrottleMs=16,this.labelPosition="top",this._activeThumb=null,this._focusedThumb=null,this._draggingThumb=null;const s=U("slider");this._sliderId=this.id||s.inputId,this._minInputId=`${s.inputId}-min`,this._maxInputId=`${s.inputId}-max`,this._labelId=s.labelId,this._helperId=s.helperId,this._errorId=s.errorId,this.label="",this.labelHidden=!1,this.noLabel=!1,this.ariaLabel="",this.min=0,this.max=100,this.step=1,this.value=0,this.dual=!1,this.vertical=!1,this.filled=!1,this.monochrome=!1,this.size="default",this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.showTooltip=!1,this.showTicks=!1,this.tickStep=25,this._handlePointerMove=this._handlePointerMove.bind(this),this._handlePointerUp=this._handlePointerUp.bind(this)}willUpdate(s){(s.has("min")||s.has("max"))&&this.min>=this.max&&(console.warn(`ag-slider: min (${this.min}) must be less than max (${this.max}). Adjusting values.`),s.has("min")?this.max=this.min+1:this.min=this.max-1),s.has("step")&&this.step!==void 0&&this.step<=0&&(console.warn(`ag-slider: step (${this.step}) must be greater than 0. Using default step of 1.`),this.step=1),(s.has("value")||s.has("min")||s.has("max"))&&this._clampAndValidateValue()}_clampAndValidateValue(){if(this.dual&&Array.isArray(this.value)){const s=this._clampValue(this.value[0]),i=this._clampValue(this.value[1]);(s!==this.value[0]||i!==this.value[1])&&(this.value=[s,i])}else if(!this.dual&&typeof this.value=="number"){const s=this._clampValue(this.value);s!==this.value&&(this.value=s)}}updated(s){super.updated(s),(s.has("disabled")||s.has("readonly")||s.has("required")||s.has("invalid"))&&this._syncStates()}firstUpdated(){this._defaultValue=Array.isArray(this.value)?[...this.value]:this.value,this._updateFormValue(),this._syncStates()}formResetCallback(){this.value=Array.isArray(this._defaultValue)?[...this._defaultValue]:this._defaultValue,this._updateFormValue(),this._syncStates()}formStateRestoreCallback(s,i){if(!(s instanceof FormData)||!this.name)return;const n=Array.from(s.getAll(this.name));this.dual&&n.length===2?this.value=[parseFloat(n[0]),parseFloat(n[1])]:n.length===1&&(this.value=parseFloat(n[0])),this._updateFormValue(),this._syncStates()}_syncStates(){this._setState("disabled",this.disabled),this._setState("readonly",this.readonly),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}_updateFormValue(){const s=new FormData;this.name?(this.dual&&Array.isArray(this.value)?(s.append(this.name,this.value[0].toString()),s.append(this.name,this.value[1].toString())):s.append(this.name,this.value.toString()),this._internals.setFormValue(s)):this._internals.setFormValue(null),this._internals.setValidity({})}get _values(){return Array.isArray(this.value)?this.value:[this.min,this.value]}_getPercentage(s){return(s-this.min)/(this.max-this.min)*100}_getValueFromPercentage(s){const i=this.min+s/100*(this.max-this.min);return this.step?Math.round(i/this.step)*this.step:i}_getValueFromPointer(s,i,n){let l;return this.vertical?l=(n.bottom-i)/n.height*100:l=(s-n.left)/n.width*100,l=Math.max(0,Math.min(100,l)),this._getValueFromPercentage(l)}_clampValue(s){let i=Math.max(this.min,Math.min(this.max,s));return this.step&&(i=Math.round(i/this.step)*this.step),Number(i.toFixed(10))}_announceValue(s){if(!this._liveRegion)return;let i="";this.dual&&Array.isArray(s)?i=`Range selected from ${s[0]} to ${s[1]}`:!this.dual&&typeof s=="number"&&(i=`Value set to ${s}`),setTimeout(()=>{this._liveRegion&&(this._liveRegion.textContent=i,setTimeout(()=>{this._liveRegion&&(this._liveRegion.textContent="")},100))},50)}_handleThumbPointerDown(s,i){if(this.disabled||this.readonly)return;const n=this._track;if(!n)return;s.preventDefault(),s.stopPropagation(),s.currentTarget.setPointerCapture(s.pointerId);const l=n.getBoundingClientRect(),d=this._values;this._activeDrag={thumb:i,startX:s.clientX,startY:s.clientY,startValue:i==="min"?d[0]:d[1],trackRect:l},this._draggingThumb=i,document.addEventListener("pointermove",this._handlePointerMove),document.addEventListener("pointerup",this._handlePointerUp),document.addEventListener("pointercancel",this._handlePointerUp)}_handlePointerMove(s){if(!this._activeDrag||this.disabled||this.readonly)return;const i=Date.now();if(i-this._lastRenderTime<this._renderThrottleMs)return;this._lastRenderTime=i,s.preventDefault();const{thumb:n,trackRect:l}=this._activeDrag,d=this._getValueFromPointer(s.clientX,s.clientY,l);if(this.dual){const e=this._values;if(n==="min"){const g=this.step,h=e[1]-g,m=[Math.min(d,h),e[1]];this._updateValue(m,"input")}else if(n==="max"){const g=this.step,h=e[0]+g,m=Math.max(d,h),D=[e[0],m];this._updateValue(D,"input")}}else this._updateValue(d,"input")}_handlePointerUp(s){var i,n;this._activeDrag&&(s.preventDefault(),(n=(i=this.shadowRoot)==null?void 0:i.querySelector(`.ag-slider__thumb[part*="${this._activeDrag.thumb}"]`))==null||n.releasePointerCapture(s.pointerId),this._activeDrag&&this._updateValue(this.value,"change"),this._activeDrag=null,this._draggingThumb=null,document.removeEventListener("pointermove",this._handlePointerMove),document.removeEventListener("pointerup",this._handlePointerUp),document.removeEventListener("pointercancel",this._handlePointerUp))}_updateValue(s,i="change"){if(this.readonly||this.disabled)return;if(this.dual&&Array.isArray(s)){s=[this._clampValue(s[0]),this._clampValue(s[1])];const l=this.step;s[1]-s[0]<l&&(s[0]===this._values[0]?s[0]=s[1]-l:s[1]=s[0]+l),s[0]>s[1]&&(s=[s[1],s[0]])}else!this.dual&&typeof s=="number"&&(s=this._clampValue(s));this.value=s,this._updateFormValue(),i==="input"&&this._draggingThumb&&this._announceValue(s);const n=new CustomEvent(i,{bubbles:!0,composed:!0,detail:{value:s}});this.dispatchEvent(n),i==="change"&&this.onChange?this.onChange(n):i==="input"&&this.onInput&&this.onInput(n)}_handleInput(s,i){if(this._activeDrag)return;if(this.readonly){s.preventDefault();return}const n=s.target,l=parseFloat(n.value);if(this.dual){const d=this._values,e=i==="min"?[l,d[1]]:[d[0],l];this._updateValue(e,"input")}else this._updateValue(l,"input")}_handleChange(s,i){if(this._activeDrag)return;if(this.readonly){s.preventDefault();return}const n=s.target,l=parseFloat(n.value);if(this.dual){const d=this._values,e=i==="min"?[l,d[1]]:[d[0],l];this._updateValue(e,"change")}else this._updateValue(l,"change")}_handleFocus(s,i){this._focusedThumb=i,this.dispatchEvent(new FocusEvent("focus",{bubbles:!0,composed:!0})),this.onFocus&&this.onFocus(s)}_handleBlur(s,i){this._focusedThumb=null,this.dispatchEvent(new FocusEvent("blur",{bubbles:!0,composed:!0})),this.onBlur&&this.onBlur(s)}_handleTrackClick(s){if(this.disabled||this.readonly)return;const i=s.currentTarget.getBoundingClientRect(),n=this._getValueFromPointer(s.clientX,s.clientY,i);if(this.dual){const l=this._values,d=Math.abs(n-l[0]),e=Math.abs(n-l[1]),g=d<e?[n,l[1]]:[l[0],n];this._updateValue(g)}else this._updateValue(n)}_renderTicks(){if(!this.showTicks||!this.tickStep||this.tickStep<=0||!isFinite(this.tickStep))return null;const s=[],i=Math.floor((this.max-this.min)/this.tickStep);if(i>1e3)return null;for(let n=0;n<=i;n++){const l=this.min+n*this.tickStep,d=this._getPercentage(l),e=this.vertical?`bottom: ${d}%`:`inset-inline-start: ${d}%`;s.push(F`
        <div class="ag-slider__tick" style="${e}">
          <div class="ag-slider__tick-label">${l}</div>
        </div>
      `)}return F`<div class="ag-slider__ticks">${s}</div>`}_renderThumb(s,i,n){const l=this._getPercentage(s),d=this._focusedThumb===i,e=this._draggingThumb===i,g=this.vertical?`bottom: ${l}%`:`inset-inline-start: ${l}%`,h=`ag-slider__thumb 
    ...
    `}_renderProgress(){const s=this._values;if(this.dual){const i=this._getPercentage(s[0]),n=this._getPercentage(s[1]),l=`ag-slider__progress ${s[1]-s[0]<=this.step?"ag-slider__progress--min-gap":""}`,d=this.vertical?`bottom: ${i}%; height: ${n-i}%`:`left: ${i}%; width: ${n-i}%`;return F`<div class="${l}" style="${d}" part="ag-slider-progress"></div>`}else{const i=this._getPercentage(s[1]),n=this.vertical?`bottom: 0; height: ${i}%`:`left: 0; width: ${i}%`;return F`<div class="ag-slider__progress" style="${n}" part="ag-slider-progress"></div>`}}renderLabel(){if(!this.label||this.noLabel||this.dual)return"";const s=[];return S(this.labelPosition)?(s.push("ag-form-control__label--horizontal"),s.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&s.push(`ag-form-control__label--${this.labelPosition}`),F`
      <label
        id=${this._labelId}
        for=${this._sliderId}
      ...
      >
        ...
        ${this.dual?F`
          <input
            ...
            aria-valuemax="${s[1]}"
            aria-valuenow="${s[0]}"
            aria-label="${u(this.dual?n:this.ariaLabel||void 0)}"
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointermove",this._handlePointerMove),document.removeEventListener("pointerup",this._handlePointerUp),document.removeEventListener("pointercancel",this._handlePointerUp)}};z.styles=[H,W`
    :host {
      display: block;
  ...
  `];let p=z;k([o({type:String})],p.prototype,"label");k([o({type:String,attribute:"label-position"})],p.prototype,"labelPosition");k([o({type:Boolean,attribute:"label-hidden"})],p.prototype,"labelHidden");k([o({type:Boolean,attribute:"no-label"})],p.prototype,"noLabel");k([o({type:String,reflect:!0,attribute:"aria-label"})],p.prototype,"ariaLabel");k([o({type:Number})],p.prototype,"min");k([o({type:Number})],p.prototype,"max");k([o({type:Number})],p.prototype,"step");k([o({type:Object})],p.prototype,"value");k([o({type:Boolean,reflect:!0})],p.prototype,"dual");k([o({type:Boolean,reflect:!0})],p.prototype,"vertical");k([o({type:Boolean,reflect:!0})],p.prototype,"filled");k([o({type:Boolean,reflect:!0})],p.prototype,"monochrome");k([o({type:String,reflect:!0})],p.prototype,"size");k([o({type:Boolean,reflect:!0})],p.prototype,"disabled");k([o({type:Boolean,reflect:!0})],p.prototype,"readonly");k([o({type:Boolean,reflect:!0})],p.prototype,"required");k([o({type:Boolean,reflect:!0})],p.prototype,"invalid");k([o({type:String,attribute:"error-message"})],p.prototype,"errorMessage");k([o({type:String,attribute:"help-text"})],p.prototype,"helpText");k([o({type:Boolean,attribute:"show-tooltip"})],p.prototype,"showTooltip");k([o({type:Boolean,attribute:"show-ticks"})],p.prototype,"showTicks");k([o({type:Number,attribute:"tick-step"})],p.prototype,"tickStep");k([o({attribute:!1})],p.prototype,"onChange");k([o({attribute:!1})],p.prototype,"onInput");k([o({attribute:!1})],p.prototype,"onFocus");k([o({attribute:!1})],p.prototype,"onBlur");k([A()],p.prototype,"_activeThumb");k([A()],p.prototype,"_focusedThumb");k([A()],p.prototype,"_draggingThumb");k([R(".ag-slider__track")],p.prototype,"_track");k([R(".ag-slider__live-region")],p.prototype,"_liveRegion");customElements.get("ag-slider")||customElements.define("ag-slider",p);const Z=[".value",".dual",".vertical",".filled",".monochrome",".labelHidden",".labelPosition",".noLabel",".disabled",".readonly",".required",".invalid",".showTooltip",".showTicks","min","max","step","size","label","ariaLabel","errorMessage","helpText","name","tickStep"],ss=P({__name:"VueSlider",props:{label:{default:""},labelPosition:{default:"top"},labelHidden:{type:Boolean,default:!1},noLabel:{type:Boolean,default:!1},ariaLabel:{default:""},min:{default:0},max:{default:100},step:{default:1},value:{default:0},dual:{type:Boolean,default:!1},vertical:{type:Boolean,default:!1},size:{default:"default"},filled:{type:Boolean,default:!1},monochrome:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},required:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},errorMessage:{default:""},helpText:{default:""},name:{default:""},showTooltip:{type:Boolean,default:!1},showTicks:{type:Boolean,default:!1},tickStep:{default:25}},emits:["input","change","focus","blur","update:value"],setup(t,{emit:s}){const i=s,n=B(),l=h=>{const m=h;i("input",m.detail),i("update:value",m.detail.value)},d=h=>{i("change",h.detail)},e=h=>{i("focus",h)},g=h=>{i("blur",h)};return(h,m)=>(v(),y("ag-slider",G({ref_key:"sliderRef",ref:n,".value":t.value,".dual":t.dual,".vertical":t.vertical,".filled":t.filled,".monochrome":t.monochrome,".labelHidden":t.labelHidden,".labelPosition":t.labelPosition,".noLabel":t.noLabel,".disabled":t.disabled,".readonly":t.readonly,".required":t.required,".invalid":t.invalid,".showTooltip":t.showTooltip,".showTicks":t.showTicks,min:t.min,max:t.max,step:t.step,size:t.size,label:t.label,ariaLabel:t.ariaLabel,errorMessage:t.errorMessage,helpText:t.helpText,name:t.name,tickStep:t.tickStep,onInput:l,onChange:d,onFocus:e,onBlur:g},h.$attrs),null,48,Z))}}),is=P({name:"SliderExamples",components:{VueSlider:ss},setup(){const t=B(50),s=B([]),i=B([200,800]),n=B([]),l=c=>{s.value=[...s.value,`${new Date().toLocaleTimeString()}: ${c}`].slice(-10)},d=c=>{n.value=[...n.value,`${new Date().toLocaleTimeString()}: ${c}`].slice(-10)};return{eventValue:t,events:s,rangeValue:i,rangeEvents:n,handleInput:c=>{t.value=c.value,l(`📝 input: value=${c.value}`)},handleChange:c=>{l(`✅ change: value=${c.value}`)},handleFocus:()=>{l("🎯 focus")},handleBlur:()=>{l("👋 blur")},handleRangeInput:c=>{i.value=c.value;const[f,E]=c.value;d(`📝 input: range=[$${f}, $${E}]`)},handleRangeChange:c=>{const[f,E]=c.value;d(`✅ change: range=[$${f}, $${E}]`)}}}}),as={class:"mbe4"},es={class:"mbe4"},ns={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},ts={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},ls={style:{border:"1px solid var(--ag-border)",padding:"1rem","border-radius":"var(--ag-radius-md)"}},hs={style:{border:"1px solid var(--ag-border)",padding:"1rem","border-radius":"var(--ag-radius-md)"}},rs={style:{border:"1px solid var(--ag-border)",padding:"1rem","border-radius":"var(--ag-radius-md)"}},ds={style:{border:"1px solid var(--ag-border)",padding:"1rem","border-radius":"var(--ag-radius-md)"}},ps={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},ks={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},os={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},Fs={class:"mbe4",style:{display:"flex",gap:"2rem","align-items":"flex-end"}},gs={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},cs={class:"mbe4"},us={class:"mbe4"},ms={class:"event-log",style:{"margin-top":"1.5rem",padding:"1rem",background:"var(--ag-background-secondary)","border-radius":"var(--ag-radius-md)",border:"1px solid var(--ag-border)"}},ys={key:0,style:{color:"var(--ag-text-muted)","font-size":"0.875rem","font-style":"italic"}},vs={style:{"margin-top":"1rem","font-size":"0.875rem",color:"var(--ag-text-secondary)"}},bs={class:"mbe4"},Cs={class:"event-log",style:{"margin-top":"1.5rem",padding:"1rem",background:"var(--ag-background-secondary)","border-radius":"var(--ag-radius-md)",border:"1px solid var(--ag-border)"}},Bs={key:0,style:{color:"var(--ag-text-muted)","font-size":"0.875rem","font-style":"italic"}},fs={style:{"margin-top":"1rem","font-size":"0.875rem",color:"var(--ag-text-secondary)"}},Es={class:"mbe4",style:{display:"flex","flex-direction":"column",gap:"2rem"}},xs={class:"mbe4",style:{"max-width":"600px"}},As={class:"mbe3"},Ds={class:"mbe3"},_s={class:"mbe3"},Ss={class:"mbe3"},ws={class:"mbe4",style:{"max-width":"600px"}},qs={class:"mbe3"},$s={class:"mbe3"},Ts={class:"mbe3"},Vs={class:"mbe3"};function Rs(t,s,i,n,l,d){const e=X("VueSlider");return v(),y("section",null,[s[8]||(s[8]=a("div",{class:"mbe4"},[a("h2",null,"Basic Slider"),a("p",{class:"mbs2 mbe3"},"Single value slider with label")],-1)),a("div",as,[r(e,{label:"Volume",value:75})]),s[9]||(s[9]=a("div",{class:"mbe4"},[a("h2",null,"Dual Range Slider"),a("p",{class:"mbs2 mbe3"},"Select a range with two thumbs")],-1)),a("div",es,[r(e,{label:"Price Range ($0 - $1000)",dual:"",min:0,max:1e3,value:[200,800]})]),s[10]||(s[10]=a("div",{class:"mbe4"},[a("h2",null,"Size Variants"),a("p",{class:"mbs2 mbe3"},"Three size options: small, default, and large")],-1)),a("div",ns,[r(e,{label:"Small",size:"small",value:30}),r(e,{label:"Default",size:"default",value:50}),r(e,{label:"Large",size:"large",value:70})]),s[11]||(s[11]=a("div",{class:"mbe4"},[a("h2",null,"Style Variants"),a("p",{class:"mbs2 mbe3"},"Choose from filled and monochrome variants")],-1)),a("div",ts,[a("fieldset",ls,[s[0]||(s[0]=a("legend",{style:{padding:"0 0.5rem","font-weight":"600"}},"Default (Primary Color)",-1)),r(e,{label:"Standard",value:50})]),a("fieldset",hs,[s[1]||(s[1]=a("legend",{style:{padding:"0 0.5rem","font-weight":"600"}},"Filled Variant",-1)),r(e,{label:"Filled Thumb",filled:"",value:60})]),a("fieldset",rs,[s[2]||(s[2]=a("legend",{style:{padding:"0 0.5rem","font-weight":"600"}},"Monochrome (Adapts to Dark Mode)",-1)),r(e,{label:"Monochrome",monochrome:"",value:70})]),a("fieldset",ds,[s[3]||(s[3]=a("legend",{style:{padding:"0 0.5rem","font-weight":"600"}},"Monochrome Filled",-1)),r(e,{label:"Monochrome Filled",monochrome:"",filled:"",value:80})])]),s[12]||(s[12]=a("div",{class:"mbe4"},[a("h2",null,"With Ticks and Tooltip"),a("p",{class:"mbs2 mbe3"},"Display tick marks and value tooltip")],-1)),a("div",ps,[r(e,{label:"With Tick Marks","show-ticks":"","tick-step":25,value:50}),r(e,{label:"With Tooltip","show-tooltip":"",value:65}),r(e,{label:"Ticks + Tooltip","show-ticks":"","show-tooltip":"","tick-step":20,value:40})]),s[13]||(s[13]=a("div",{class:"mbe4"},[a("h2",null,"Step Increments"),a("p",{class:"mbs2 mbe3"},"Control the granularity of value changes. Tick marks show the step intervals.")],-1)),a("div",ks,[r(e,{label:"Step 5",step:5,value:50,"show-ticks":"","tick-step":5}),r(e,{label:"Step 10",step:10,value:50,"show-ticks":"","tick-step":10}),r(e,{label:"Step 25 (Coarse)",step:25,value:50,"show-ticks":"","tick-step":25})]),s[14]||(s[14]=a("div",{class:"mbe4"},[a("h2",null,"Custom Range"),a("p",{class:"mbs2 mbe3"},"Configure min, max, and step values")],-1)),a("div",os,[r(e,{label:"Temperature (°C)",min:-20,max:40,step:5,value:20}),r(e,{label:"Percentage",min:0,max:100,step:1,value:75,"help-text":"Adjust from 0% to 100%"})]),s[15]||(s[15]=a("div",{class:"mbe4"},[a("h2",null,"Vertical Orientation"),a("p",{class:"mbs2 mbe3"},"Vertical sliders for compact layouts")],-1)),a("div",Fs,[r(e,{label:"Volume",vertical:"",value:75}),r(e,{label:"Bass",vertical:"",size:"small",value:50}),r(e,{label:"Treble",vertical:"",size:"large",value:60}),r(e,{label:"Balance",vertical:"",dual:"",value:[25,75]})]),s[16]||(s[16]=a("div",{class:"mbe4"},[a("h2",null,"States"),a("p",{class:"mbs2 mbe3"},"Disabled, readonly, and invalid states")],-1)),a("div",gs,[r(e,{label:"Disabled",disabled:"",value:50,"help-text":"This slider is disabled"}),r(e,{label:"Readonly",readonly:"",value:65,"help-text":"This slider is readonly"}),r(e,{label:"Invalid",invalid:"","error-message":"Value must be at least 50",value:30})]),s[17]||(s[17]=a("div",{class:"mbe4"},[a("h2",null,"With Help Text"),a("p",{class:"mbs2 mbe3"},"Provide additional guidance with help text")],-1)),a("div",cs,[r(e,{label:"Brightness","help-text":"Adjust screen brightness level (affects battery life)",value:75})]),s[18]||(s[18]=a("div",{class:"mbe4"},[a("h2",null,"Event Testing"),a("p",{class:"mbs2 mbe3"}," Demonstrates the dual-dispatch event pattern: both CustomEvents (via @input/@change) and native events work simultaneously. Drag the slider to see real-time events. ")],-1)),a("div",us,[r(e,{label:"Interactive Slider",value:t.eventValue,onInput:t.handleInput,onChange:t.handleChange,onFocus:t.handleFocus,onBlur:t.handleBlur},null,8,["value","onInput","onChange","onFocus","onBlur"]),a("div",ms,[s[4]||(s[4]=a("h3",{style:{"margin-top":"0","margin-bottom":"0.75rem","font-size":"0.95rem"}},"Event Log (last 10 events):",-1)),t.events.length===0?(v(),y("div",ys," Interact with the slider to see events... ")):w("",!0),(v(!0),y(q,null,$(t.events,(g,h)=>(v(),y("div",{key:h,style:{"font-family":"monospace","font-size":"0.875rem",padding:"0.25rem 0",color:"var(--ag-text-primary)"}},C(g),1))),128))]),a("div",vs,[s[5]||(s[5]=b(" Current value: ",-1)),a("strong",null,C(t.eventValue),1)])]),s[19]||(s[19]=a("div",{class:"mbe4"},[a("h2",null,"Dual Range Events"),a("p",{class:"mbs2 mbe3"},"Event handling with dual range sliders")],-1)),a("div",bs,[r(e,{label:"Price Range Filter",dual:"",min:0,max:1e3,step:10,value:t.rangeValue,onInput:t.handleRangeInput,onChange:t.handleRangeChange},null,8,["value","onInput","onChange"]),a("div",Cs,[s[6]||(s[6]=a("h3",{style:{"margin-top":"0","margin-bottom":"0.75rem","font-size":"0.95rem"}},"Range Event Log (last 10 events):",-1)),t.rangeEvents.length===0?(v(),y("div",Bs," Drag the range handles to see events... ")):w("",!0),(v(!0),y(q,null,$(t.rangeEvents,(g,h)=>(v(),y("div",{key:h,style:{"font-family":"monospace","font-size":"0.875rem",padding:"0.25rem 0",color:"var(--ag-text-primary)"}},C(g),1))),128))]),a("div",fs,[s[7]||(s[7]=b(" Current range: ",-1)),a("strong",null,"$"+C(t.rangeValue[0])+" - $"+C(t.rangeValue[1]),1)])]),s[20]||(s[20]=a("div",{class:"mbe4"},[a("h2",null,"CSS Shadow Parts Customization"),a("p",{class:"mbs2 mbe3"}," Use CSS Shadow Parts to customize the component's appearance. These examples show customized track, thumb, and label styling. ")],-1)),a("div",Es,[r(e,{label:"Gradient Track",value:60,class:"custom-slider-1"}),r(e,{label:"Large Thumb with Shadow",value:70,class:"custom-slider-2"}),r(e,{label:"Fully Customized",value:50,class:"custom-slider-3","help-text":"Custom colors, sizing, and typography"})]),s[21]||(s[21]=a("div",{class:"mbe4"},[a("h2",null,"External Label Support"),a("p",{class:"mbs2 mbe3"}," The Slider component supports external labels with helper text, required fields, and validation states. ")],-1)),a("div",xs,[a("div",As,[r(e,{label:"Volume Level",min:0,max:100,value:75})]),a("div",Ds,[r(e,{label:"Brightness","help-text":"Adjust screen brightness level (affects battery life)",min:0,max:100,value:50})]),a("div",_s,[r(e,{label:"Temperature",required:!0,"help-text":"This field is required",min:-20,max:40,value:20})]),a("div",Ss,[r(e,{label:"Price Range",required:!0,invalid:!0,"error-message":"Please select a valid price range",min:0,max:1e3,value:50})])]),s[22]||(s[22]=a("div",{class:"mbe4"},[a("h2",null,"Label Positioning"),a("p",{class:"mbs2 mbe3"},[b(" Control label position with "),a("code",null,"label-position"),b(": 'top' (default), 'start', 'end', or 'bottom'. ")])],-1)),a("div",ws,[a("div",qs,[r(e,{label:"Top Label (Default)","label-position":"top",min:0,max:100,value:50})]),a("div",$s,[r(e,{label:"Start Position","label-position":"start",min:0,max:100,value:60})]),a("div",Ts,[r(e,{label:"End Position","label-position":"end",min:0,max:100,value:70})]),a("div",Vs,[r(e,{label:"Bottom Position","label-position":"bottom","help-text":"Bottom label position for alternative layouts",min:0,max:100,value:40})])])])}const Ps=Y(is,[["render",Rs]]);class I extends V{constructor(){super(),this.eventValue=50,this.events=[],this.rangeValue=[200,800],this.rangeEvents=[]}createRenderRoot(){return this}addEvent(s){this.events=[...this.events,`${new Date().toLocaleTimeString()}: ${s}`].slice(-10)}addRangeEvent(s){this.rangeEvents=[...this.rangeEvents,`${new Date().toLocaleTimeString()}: ${s}`].slice(-10)}handleInput(s){this.eventValue=s.detail.value,this.addEvent(`📝 input: value=${s.detail.value}`)}handleChange(s){this.addEvent(`✅ change: value=${s.detail.value}`)}handleFocus(){this.addEvent("🎯 focus")}handleBlur(){this.addEvent("👋 blur")}handleRangeInput(s){this.rangeValue=s.detail.value;const[i,n]=s.detail.value;this.addRangeEvent(`📝 input: range=[$${i}, $${n}]`)}handleRangeChange(s){const[i,n]=s.detail.value;this.addRangeEvent(`✅ change: range=[$${i}, $${n}]`)}render(){return F`
      <section>
        <div class="mbe4">
          <h2>Basic Slider</h2>
    ...
    `}}_(I,"properties",{eventValue:{type:Number},events:{type:Array},rangeValue:{type:Array},rangeEvents:{type:Array}});customElements.define("slider-lit-examples",I);const zs=`<template>
  <section>
    <div class="mbe4">
      <h2>Basic Slider</h2>
      <p class="mbs2 mbe3">Single value slider with label</p>
...
`,Is=`import { LitElement, html } from 'lit';
...
`,ai=JSON.parse('{"title":"Slider","description":"","frontmatter":{},"headers":[],"relativePath":"components/slider.md","filePath":"components/slider.md"}'),Ms={name:"components/slider.md"},ei=Object.assign(Ms,{setup(t){return(s,i)=>(v(),y("div",null,[i[1]||(i[1]=a("h1",{id:"slider",tabindex:"-1"},[b("Slider "),a("a",{class:"header-anchor",href:"#slider","aria-label":'Permalink to "Slider"'},"​")],-1)),r(N),i[2]||(i[2]=a("p",null,"Slider allows a user to select a value or range of values by moving a thumb along a track. It's ideal for adjusting settings like volume, brightness, price ranges, and other numeric inputs.",-1)),i[3]||(i[3]=a("h2",{id:"examples",tabindex:"-1"},[b("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),r(K,{component:"slider","vue-code":x(zs),"lit-code":x(Is),"react-code":x(Ls)},{vue:T(()=>[r(Ps)]),lit:T(()=>[...i[0]||(i[0]=[a("slider-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),i[4]||(i[4]=J(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
