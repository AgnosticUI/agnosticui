import{A as f}from"./chunks/AlphaWarning.yC7ZufpQ.js";import{i as V,z as g,a as h,x as F}from"./chunks/Button.Bujdzq23.js";import{d as y,p as R,c as u,o as p,r as z,K as B,j as t,G as i,k as n,w as e,a as s,ae as C}from"./chunks/framework.NAAYCHZu.js";import{F as N}from"./chunks/FrameworkExample.Vj5DwYx5.js";import"./chunks/createLucideIcon.B61Wqv9x.js";import"./chunks/Icon.odq14qpJ.js";var w=Object.defineProperty,c=(l,r,a,k)=>{for(var b=void 0,m=l.length-1,v;m>=0;m--)(v=l[m])&&(b=v(r,a,b)||b);return b&&w(r,a,b),b};const K=class extends h{constructor(){super(),this.variant="default",this.bordered=!0,this.background=!1,this.size="md"}updated(r){super.updated(r),this._checkSingleChar()}_checkSingleChar(){var k;let r="";const a=(k=this.shadowRoot)==null?void 0:k.querySelector("slot");a&&(r=a.assignedNodes({flatten:!0}).map(b=>b.textContent||"").join("")),r=r.trim(),r.length===1?this.setAttribute("single-char","true"):this.removeAttribute("single-char")}_onSlotChange(){this._checkSingleChar()}render(){return F`
