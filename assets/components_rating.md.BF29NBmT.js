var P=Object.defineProperty;var S=(n,a,i)=>a in n?P(n,a,{enumerable:!0,configurable:!0,writable:!0,value:i}):n[a]=i;var f=(n,a,i)=>S(n,typeof a!="symbol"?a+"":a,i);import{A as D}from"./chunks/AlphaWarning.BrPcWDzH.js";import{i as q,z as d,a as V,x as g,Q as C,b as E}from"./chunks/Button.D5k6BRt0.js";import{n as F,F as z}from"./chunks/FrameworkExample.Bxe-4Cvs.js";import{a as H,i as L,t as R,u as T}from"./chunks/form-control-utils.DNE0R8LF.js";import{d as $,p as u,c as y,o as b,r as _,K as I,_ as N,C as M,j as t,G as o,t as v,ae as U,a as x,w,k as m}from"./chunks/framework.CEYhRMo2.js";import"./chunks/createLucideIcon.DDrmbL84.js";import"./chunks/Icon.D4VjhFbj.js";var W=Object.defineProperty,p=(n,a,i,e)=>{for(var l=void 0,r=n.length-1,s;r>=0;r--)(s=n[r])&&(l=s(a,i,l)||l);return l&&W(a,i,l),l};let O=0;const B=class extends V{constructor(){super(),this.uniqueId=++O,this._ratingId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this.hoverValue=0,this.isHovering=!1,this.isPointerDown=!1;const a=L("rating");this._ratingId=a.inputId,this._labelId=a.labelId,this._helperId=a.helperId,this._errorId=a.errorId,this.value=0,this.max=5,this.precision="whole",this.readonly=!1,this.allowClear=!1,this.variant="",this.size="md",this.name="",this.label="",this.labelHidden=!1,this.noLabel=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.handlePointerMove=this.handlePointerMove.bind(this),this.handlePointerUp=this.handlePointerUp.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleKeyDown),this.removeGlobalPointerListeners()}renderLabel(){if(!this.label||this.noLabel)return"";const a=[];return R(this.labelPosition)?(a.push("ag-form-control__label--horizontal"),a.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&a.push(`ag-form-control__label--${this.labelPosition}`),g`
      <label
        id=${this._labelId}
        for=${this._ratingId}
    ...
    `}render(){const a=this.isHovering?this.hoverValue:this.value,i=Array.from({length:this.max},(c,k)=>k+1),e=T({helperId:this._helperId,errorId:this._errorId,hasHelper:!!this.helpText&&!this.invalid,hasError:!!this.invalid&&!!this.errorMessage}),l=this.helpText&&!this.invalid?g`<div class="ag-form-control__helper" id="${this._helperId}">
          ${this.helpText}
    ...
    `}renderStarSvg(a,i,e){return i?E`
...
`,Ea=JSON.parse('{"title":"Rating","description":"","frontmatter":{},"headers":[],"relativePath":"components/rating.md","filePath":"components/rating.md"}'),ca={name:"components/rating.md"},Ra=Object.assign(ca,{setup(n){return(a,i)=>(b(),y("div",null,[i[1]||(i[1]=t("h1",{id:"rating",tabindex:"-1"},[x("Rating "),t("a",{class:"header-anchor",href:"#rating","aria-label":'Permalink to "Rating"'},"​")],-1)),o(D),i[2]||(i[2]=t("p",null,"The Rating component provides a way for users to view and set a rating, typically represented by stars. It's highly customizable, supporting different sizes, colors, and precision.",-1)),i[3]||(i[3]=t("h2",{id:"examples",tabindex:"-1"},[x("Examples "),t("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),o(z,{component:"rating","vue-code":m(pa),"lit-code":m(da),"react-code":m(ga)},{vue:w(()=>[o(ha)]),lit:w(()=>[...i[0]||(i[0]=[t("rating-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),i[4]||(i[4]=U(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
