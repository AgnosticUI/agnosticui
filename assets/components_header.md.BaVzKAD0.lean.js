import{A as E}from"./chunks/AlphaWarning.D199zhtu.js";import{i as x,z as y,a as m,x as u}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{s as A}from"./chunks/plugin-vue_export-helper-CHgC5LLL.lGy7RumW.js";import{d as f,c as r,o as p,j as s,r as c,K as w,p as B,v as D,_ as S,C as q,G as l,w as n,a as d,ae as v,k}from"./chunks/framework.CdHt8f9T.js";import{F as H}from"./chunks/FrameworkExample.Cu0hWhnk.js";import"./chunks/state-CovhUvdr.DnzyR2fh.js";import"./chunks/unique-id.CpwMFgRD.js";import"./chunks/Button.yxJuDTTi.js";import"./chunks/if-defined-C8i28hSj.CfeO1FY9.js";import"./chunks/zap.-Jsm5uUC.js";var z=Object.defineProperty,b=(t,i,a,F)=>{for(var h=void 0,o=t.length-1,e;o>=0;o--)(e=t[o])&&(h=e(i,a,h)||h);return h&&z(i,a,h),h};const C=class extends m{constructor(){super(...arguments),this.sticky=!1,this.contentJustify="between"}render(){return u`
...
`,fs=JSON.parse('{"title":"Header","description":"","frontmatter":{},"headers":[],"relativePath":"components/header.md","filePath":"components/header.md"}'),hs={name:"components/header.md"},vs=Object.assign(hs,{setup(t){return(i,a)=>(p(),r("div",null,[a[1]||(a[1]=s("h1",{id:"header",tabindex:"-1"},[d("Header "),s("a",{class:"header-anchor",href:"#header","aria-label":'Permalink to "Header"'},"​")],-1)),l(E),a[2]||(a[2]=s("p",null,"The Header component provides a semantic, accessible, and responsive page header with support for branding/logo and navigation content. It features sticky positioning, flexible content alignment, and responsive behavior.",-1)),a[3]||(a[3]=s("h2",{id:"examples",tabindex:"-1"},[d("Examples "),s("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),l(H,{component:"header","vue-code":k(ts),"lit-code":k(es),"react-code":k(ls)},{vue:n(()=>[l(ns)]),lit:n(()=>[...a[0]||(a[0]=[s("header-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[4]||(a[4]=v("",32))]))}});export{fs as __pageData,vs as default};
