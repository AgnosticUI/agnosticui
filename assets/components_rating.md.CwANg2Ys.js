var P=Object.defineProperty;var S=(n,a,i)=>a in n?P(n,a,{enumerable:!0,configurable:!0,writable:!0,value:i}):n[a]=i;var f=(n,a,i)=>S(n,typeof a!="symbol"?a+"":a,i);import{A as D}from"./chunks/AlphaWarning.BNPjaonO.js";import{i as q,z as d,a as V,x as g,Q as C,b as E}from"./chunks/Button.D5k6BRt0.js";import{n as F,F as z}from"./chunks/FrameworkExample.loPfkzmf.js";import{a as H,i as L,t as R,u as T}from"./chunks/form-control-utils.CRHCn4X4.js";import{d as $,p as u,c as y,o as b,r as _,K as I,_ as N,C as M,j as t,G as o,t as v,ae as U,a as x,w,k as m}from"./chunks/framework.CdHt8f9T.js";import"./chunks/createLucideIcon.BZxhvBdy.js";var W=Object.defineProperty,p=(n,a,i,e)=>{for(var l=void 0,r=n.length-1,s;r>=0;r--)(s=n[r])&&(l=s(a,i,l)||l);return l&&W(a,i,l),l};let O=0;const B=class extends V{constructor(){super(),this.uniqueId=++O,this._ratingId="",this._labelId="",this._helperId="",this._errorId="",this.labelPosition="top",this.hoverValue=0,this.isHovering=!1,this.isPointerDown=!1;const a=L("rating");this._ratingId=a.inputId,this._labelId=a.labelId,this._helperId=a.helperId,this._errorId=a.errorId,this.value=0,this.max=5,this.precision="whole",this.readonly=!1,this.allowClear=!1,this.variant="",this.size="md",this.name="",this.label="",this.labelHidden=!1,this.noLabel=!1,this.required=!1,this.invalid=!1,this.errorMessage="",this.helpText="",this.handlePointerMove=this.handlePointerMove.bind(this),this.handlePointerUp=this.handlePointerUp.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleKeyDown),this.removeGlobalPointerListeners()}renderLabel(){if(!this.label||this.noLabel)return"";const a=[];return R(this.labelPosition)?(a.push("ag-form-control__label--horizontal"),a.push(`ag-form-control__label--${this.labelPosition}`)):this.labelPosition==="bottom"&&a.push(`ag-form-control__label--${this.labelPosition}`),g`
      <label
        id=${this._labelId}
        for=${this._ratingId}
