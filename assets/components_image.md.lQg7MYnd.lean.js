...
`,Es=JSON.parse('{"title":"Image","description":"","frontmatter":{"title":"Image"},"headers":[],"relativePath":"components/image.md","filePath":"components/image.md"}'),Fs={name:"components/image.md"},Rs=Object.assign(Fs,{setup(i){return(a,t)=>(A(),B("div",null,[t[1]||(t[1]=e("h1",{id:"image",tabindex:"-1"},[w("Image "),e("a",{class:"header-anchor",href:"#image","aria-label":'Permalink to "Image"'},"​")],-1)),h(Q),t[2]||(t[2]=R("",3)),h(as,{component:"image","vue-code":p(ks),"lit-code":p(ms),"react-code":p(us)},{vue:y(()=>[h(gs)]),lit:y(()=>[...t[0]||(t[0]=[e("image-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),t[3]||(t[3]=R("",48))]))}});export{Es as __pageData,Rs as default};
