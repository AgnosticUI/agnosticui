...
`,Ae=JSON.parse('{"title":"Skeleton Loader","description":"","frontmatter":{},"headers":[],"relativePath":"components/skeleton-loader.md","filePath":"components/skeleton-loader.md"}'),ue={name:"components/skeleton-loader.md"},qe=Object.assign(ue,{setup(s){return(e,n)=>(g(),k("div",null,[n[1]||(n[1]=a("h1",{id:"skeleton-loader",tabindex:"-1"},[m("Skeleton Loader "),a("a",{class:"header-anchor",href:"#skeleton-loader","aria-label":'Permalink to "Skeleton Loader"'},"​")],-1)),i(f),n[2]||(n[2]=a("p",null,"Skeleton loader provides a visual placeholders while content is loading, improving perceived performance and user experience. It represents the approximate shape and size of the content that will appear.",-1)),n[3]||(n[3]=a("h2",{id:"examples",tabindex:"-1"},[m("Examples "),a("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(T,{component:"skeleton","vue-code":c(ke),"lit-code":c(ge),"react-code":c(ce)},{vue:v(()=>[i(he)]),lit:v(()=>[...n[0]||(n[0]=[a("skeleton-loader-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),n[4]||(n[4]=N(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
