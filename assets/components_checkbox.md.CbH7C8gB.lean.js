...
`,is=JSON.parse('{"title":"Checkbox","description":"","frontmatter":{},"headers":[],"relativePath":"components/checkbox.md","filePath":"components/checkbox.md"}'),G={name:"components/checkbox.md"},as=Object.assign(G,{setup(p){return(e,n)=>(r(),F("div",null,[n[1]||(n[1]=s("h1",{id:"checkbox",tabindex:"-1"},[h("Checkbox "),s("a",{class:"header-anchor",href:"#checkbox","aria-label":'Permalink to "Checkbox"'},"​")],-1)),i(c),n[2]||(n[2]=s("p",null,"Checkbox allows a user to select one or more options from a set. It's ideal for forms, settings panels, and multi-select interfaces.",-1)),n[3]||(n[3]=s("h2",{id:"examples",tabindex:"-1"},[h("Examples "),s("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(C,{component:"checkbox","vue-code":k(_),"lit-code":k(M),"react-code":k(W)},{vue:t(()=>[i(N)]),lit:t(()=>[...n[0]||(n[0]=[s("checkbox-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),n[4]||(n[4]=y("",43))]))}});export{is as __pageData,as as default};
