import{A as es}from"./chunks/AlphaWarning.CKFYAqLS.js";import{a as K,E as B,x as v,i as ts,z as d}from"./chunks/property-CemaeiRl.Cea_q1B7.js";import{n as E}from"./chunks/state-CovhUvdr.C-u8O0Fo.js";import{f as I}from"./chunks/query-BykXNUlT.Pm7lu9c1.js";import{c as ls}from"./chunks/face-mixin.MgCHLM8W.js";import{i as ns,u as os,t as Y,a as hs}from"./chunks/form-control-utils.BYIX_mid.js";import"./chunks/CloseButton.Ddd3q8sQ.js";import"./chunks/Checkbox.DMDXnQdv.js";import"./chunks/Tag.35_Kzebd.js";import{d as J,p as g,c as M,o as R,r as ps,j as e,G as k,k as c,t as q,e as ds,a as A,_ as rs,ag as ks,w as G}from"./chunks/framework.DmF2n0Fc.js";import{F as cs}from"./chunks/FrameworkExample.Byhd3Bwz.js";import"./chunks/createLucideIcon.U6K_rCrv.js";import"./chunks/Tag.iHsn8ITU.js";import"./chunks/sdk.m.Dxhqq5iP.js";import"./chunks/Button.BmTmCFep.js";import"./chunks/Icon.CxPOY7rJ.js";var Fs=Object.defineProperty,bs=Object.getOwnPropertyDescriptor,h=(r,s,i,t)=>{for(var l=t>1?void 0:t?bs(s,i):s,u=r.length-1,m;u>=0;u--)(m=r[u])&&(l=(t?m(s,i,l):m(l))||l);return t&&l&&Fs(s,i,l),l};const Q=class extends ls(K){constructor(){super(),this._value="",this.labelPosition="top",this._open=!1,this._searchTerm="",this._filteredOptions=[],this._activeIndex=-1,this._selectedOptions=[],this._displayLabel="",this._comboboxId="",this._listboxId="",this._labelId="",this._helpTextId="",this._errorTextId="",this._justSelected=!1,this._isDefaultValueInitialized=!1,this.options=[],this.placeholder="",this.labelHidden=!1,this.noLabel=!1,this.ariaLabel=null,this.id="",this.autocomplete="list",this.filterMode="startsWith",this.clearable=!1,this.disabled=!1,this.readonly=!1,this.required=!1,this.invalid=!1,this.size="default",this.variant="default",this.maxVisibleOptions=10,this.closeOnSelect=!0,this.multiple=!1,this.maxOptionsVisible=3,this.loading=!1,this.loadingText="Loading...",this.noResultsText="No results found",this.validationMessages=void 0}get value(){return this._value}set value(s){const i=this._value;this.multiple?this._value=Array.isArray(s)?s:s?s.split(" "):[]:this._value=Array.isArray(s)?s.join(" "):s,this.requestUpdate("value",i)}connectedCallback(){super.connectedCallback();const s=ns("combobox");this._comboboxId=this.id||s.inputId,this._listboxId=`${this._comboboxId}-listbox`,this._labelId=s.labelId,this._helpTextId=s.helperId,this._errorTextId=s.errorId,this._clickOutsideHandler=i=>{this._open&&(i.composedPath().includes(this)||this.close())},document.addEventListener("click",this._clickOutsideHandler)}disconnectedCallback(){super.disconnectedCallback(),this._clickOutsideHandler&&document.removeEventListener("click",this._clickOutsideHandler)}willUpdate(s){if(super.willUpdate(s),!this._isDefaultValueInitialized&&this.defaultValue&&this.options.length>0){const i=Array.isArray(this.defaultValue)?this.defaultValue:[this.defaultValue];this._selectedOptions=this.options.filter(t=>i.includes(t.value)),this._selectionChanged(),this._isDefaultValueInitialized=!0;return}if(s.has("value")&&(this._isDefaultValueInitialized||!this.defaultValue)){const i=this.value,t=Array.isArray(i)?i:i?[i]:[];this._selectedOptions=this.options.filter(l=>t.includes(l.value)),this._selectionChanged()}s.has("errorMessage")&&(this.invalid=!!this.errorMessage)}updated(s){super.updated(s),s.has("value")&&(this._syncFormValue(),this._syncValidity()),(s.has("disabled")||s.has("readonly")||s.has("required")||s.has("value"))&&this._syncStates()}focus(){var s;(s=this._inputElement)==null||s.focus()}blur(){var s;(s=this._inputElement)==null||s.blur()}open(){var i,t;if(this.disabled||this.readonly||this._open)return;this._open=!0,this._filterOptions(),this.setAttribute("open","");const s=new CustomEvent("open",{detail:{open:!0},bubbles:!0,composed:!0});this.dispatchEvent(s),(i=this.onOpen)==null||i.call(this,s),(t=this._inputElement)==null||t.setAttribute("aria-expanded","true")}close(){var i,t,l;if(!this._open)return;if(this._open=!1,this._activeIndex=-1,this.multiple)this._searchTerm=this._displayLabel;else if(!this.options.some(u=>u.label===this._searchTerm)){const u=this._selectedOptions[0];u?this._searchTerm=u.label:this._searchTerm=""}this.removeAttribute("open");const s=new CustomEvent("close",{detail:{open:!1},bubbles:!0,composed:!0});this.dispatchEvent(s),(i=this.onClose)==null||i.call(this,s),(t=this._inputElement)==null||t.setAttribute("aria-expanded","false"),(l=this._inputElement)==null||l.removeAttribute("aria-activedescendant")}toggle(){this._open?this.close():this.open()}selectOption(s){var u,m,y;let i;if(typeof s=="string"){if(i=this.options.find(C=>C.value===s),!i)return}else i=s;if(i.disabled)return;this.multiple?(this._selectedOptions.findIndex(C=>C.value===i.value)>-1?this._selectedOptions=this._selectedOptions.filter(C=>C.value!==i.value):this._selectedOptions=[...this._selectedOptions,i],this._selectionChanged()):(this._selectedOptions=[i],this._selectionChanged(),this.closeOnSelect&&this.close()),this._inputElement&&(this._inputElement.value=this._searchTerm);const t=new CustomEvent("select",{detail:{option:i,value:i.value},bubbles:!0,composed:!0});this.dispatchEvent(t),(u=this.onSelect)==null||u.call(this,t),this._syncFormValue(),this._syncValidity();const l=new CustomEvent("change",{detail:{value:this.value,option:i},bubbles:!0,composed:!0});this.dispatchEvent(l),(m=this.onChange)==null||m.call(this,l),this._justSelected=!0,(y=this._inputElement)==null||y.focus(),requestAnimationFrame(()=>{const C=this._inputElement;if(C){const x=C.value.length;C.setSelectionRange(x,x)}}),setTimeout(()=>{this._justSelected=!1},100)}clearSelection(){var i;this._selectedOptions=[],this._selectionChanged(),this._activeIndex=-1,this._syncFormValue(),this._syncValidity();const s=new CustomEvent("change",{detail:{value:this.value,option:null},bubbles:!0,composed:!0});this.dispatchEvent(s),(i=this.onChange)==null||i.call(this,s)}_syncFormValue(){if(this.multiple){const s=Array.isArray(this.value)?this.value:[];if(s.length===0)this._internals.setFormValue(null);else{const i=new FormData;s.forEach(t=>i.append(this.name,t)),this._internals.setFormValue(i)}}else{const s=typeof this.value=="string"?this.value:"";this._internals.setFormValue(s||null)}}_syncValidity(){var i;const s=this.multiple?Array.isArray(this.value)&&this.value.length>0:!!(typeof this.value=="string"&&this.value);this.required&&!s?this._internals.setValidity({valueMissing:!0},((i=this.validationMessages)==null?void 0:i.valueMissing)??"Please select an option."):this._internals.setValidity({})}firstUpdated(){this._syncFormValue(),this._syncValidity(),this._syncStates()}formResetCallback(){this._selectedOptions=[],this._selectionChanged(),this._internals.setFormValue(null),this._internals.setValidity({}),this._syncStates()}formStateRestoreCallback(s,i){if(s===null)this._selectedOptions=[];else if(s instanceof FormData){const t=new Set(Array.from(s.getAll(this.name)));this._selectedOptions=this.options.filter(l=>t.has(l.value))}else if(typeof s=="string"){const t=this.options.find(l=>l.value===s);this._selectedOptions=t?[t]:[]}this._selectionChanged(),this._syncFormValue(),this._syncValidity(),this._syncStates()}_syncStates(){this._setState("disabled",this.disabled),this._setState("readonly",this.readonly),this._setState("required",this.required),this._setState("invalid",!this._internals.validity.valid)}_selectionChanged(){if(this.multiple)this.value=this._selectedOptions.map(s=>s.value),this._searchTerm="";else{const s=this._selectedOptions[0];this.value=(s==null?void 0:s.value)??"",this._displayLabel=(s==null?void 0:s.label)??"",this._searchTerm=this._displayLabel}}_renderSelectedTags(){if(!this.multiple||this._selectedOptions.length===0)return B;const s=this._selectedOptions.slice(0,this.maxOptionsVisible),i=this._selectedOptions.length-this.maxOptionsVisible;return v`
  ...
  `];let o=Q;h([d({type:Array})],o.prototype,"options",2);h([d({type:[String,Array]})],o.prototype,"value",1);h([d({type:[String,Array],attribute:"default-value"})],o.prototype,"defaultValue",2);h([d({type:String})],o.prototype,"placeholder",2);h([d({type:String})],o.prototype,"label",2);h([d({type:String,attribute:"label-position"})],o.prototype,"labelPosition",2);h([d({type:Boolean,attribute:"label-hidden"})],o.prototype,"labelHidden",2);h([d({type:Boolean,attribute:"no-label"})],o.prototype,"noLabel",2);h([d({type:String,attribute:"aria-label"})],o.prototype,"ariaLabel",2);h([d({type:String,attribute:"help-text"})],o.prototype,"helpText",2);h([d({type:String,attribute:"error-message"})],o.prototype,"errorMessage",2);h([d({type:String})],o.prototype,"id",2);h([d({type:String})],o.prototype,"autocomplete",2);h([d({type:String,attribute:"filter-mode"})],o.prototype,"filterMode",2);h([d({type:Boolean})],o.prototype,"clearable",2);h([d({type:Boolean,reflect:!0})],o.prototype,"disabled",2);h([d({type:Boolean})],o.prototype,"readonly",2);h([d({type:Boolean})],o.prototype,"required",2);h([d({type:Boolean,reflect:!0})],o.prototype,"invalid",2);h([d({type:String,reflect:!0})],o.prototype,"size",2);h([d({type:String,reflect:!0})],o.prototype,"variant",2);h([d({type:Number,attribute:"max-visible-options"})],o.prototype,"maxVisibleOptions",2);h([d({type:Boolean})],o.prototype,"closeOnSelect",2);h([d({type:Boolean})],o.prototype,"multiple",2);h([d({type:Number,attribute:"max-options-visible"})],o.prototype,"maxOptionsVisible",2);h([d({type:Boolean})],o.prototype,"loading",2);h([d({type:String,attribute:"loading-text"})],o.prototype,"loadingText",2);h([d({type:String,attribute:"no-results-text"})],o.prototype,"noResultsText",2);h([d({attribute:!1})],o.prototype,"onChange",2);h([d({attribute:!1})],o.prototype,"onSelect",2);h([d({attribute:!1})],o.prototype,"onSearch",2);h([d({attribute:!1})],o.prototype,"onOpen",2);h([d({attribute:!1})],o.prototype,"onClose",2);h([d({attribute:!1})],o.prototype,"onFocus",2);h([d({attribute:!1})],o.prototype,"onBlur",2);h([d({attribute:!1})],o.prototype,"validationMessages",2);h([E()],o.prototype,"_open",2);h([E()],o.prototype,"_searchTerm",2);h([E()],o.prototype,"_filteredOptions",2);h([E()],o.prototype,"_activeIndex",2);h([E()],o.prototype,"_selectedOptions",2);h([E()],o.prototype,"_displayLabel",2);h([I(".combobox-input")],o.prototype,"_inputElement",2);h([I(".combobox-listbox")],o.prototype,"_listboxElement",2);h([I(".combobox-sr-announcer")],o.prototype,"_srAnnouncer",2);customElements.get("ag-combobox")||customElements.define("ag-combobox",o);const gs=[".labelHidden",".labelPosition",".noLabel",".disabled",".invalid",".clearable",".readonly",".required",".validationMessages",".loading",".multiple",".closeOnSelect",".options",".value",".defaultValue",".maxOptionsVisible","placeholder","label","ariaLabel","helpText","errorMessage","autocomplete","filterMode","size","variant","loadingText","noResultsText"],F=J({__name:"VueCombobox",props:{options:{default:()=>[]},value:{default:void 0},defaultValue:{default:void 0},placeholder:{default:""},label:{default:""},labelPosition:{default:"top"},labelHidden:{type:Boolean,default:!1},noLabel:{type:Boolean,default:!1},ariaLabel:{default:null},helpText:{default:""},errorMessage:{default:""},id:{},autocomplete:{default:"list"},filterMode:{default:"startsWith"},clearable:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},required:{type:Boolean,default:!1},invalid:{type:Boolean,default:!1},size:{default:"default"},maxVisibleOptions:{},closeOnSelect:{type:Boolean,default:!0},variant:{default:"default"},multiple:{type:Boolean,default:!1},maxOptionsVisible:{default:3},loading:{type:Boolean,default:!1},loadingText:{default:"Loading..."},noResultsText:{default:"No results found"},validationMessages:{}},emits:["change","select","search","open","close","focus","blur","update:value"],setup(r,{expose:s,emit:i}){const t=i,l=g(),u=n=>{const b=n;t("change",b.detail),t("update:value",b.detail.value)},m=n=>{t("select",n.detail)},y=n=>{t("search",n.detail)},C=n=>{t("open",n.detail)},x=n=>{t("close",n.detail)},w=n=>{t("focus",n)},O=n=>{t("blur",n)};return s({focus:()=>{var n,b;return(b=(n=l.value)==null?void 0:n.focus)==null?void 0:b.call(n)},blur:()=>{var n,b;return(b=(n=l.value)==null?void 0:n.blur)==null?void 0:b.call(n)},open:()=>{var n,b;return(b=(n=l.value)==null?void 0:n.open)==null?void 0:b.call(n)},close:()=>{var n,b;return(b=(n=l.value)==null?void 0:n.close)==null?void 0:b.call(n)},toggle:()=>{var n,b;return(b=(n=l.value)==null?void 0:n.toggle)==null?void 0:b.call(n)},selectOption:n=>{var b,S;return(S=(b=l.value)==null?void 0:b.selectOption)==null?void 0:S.call(b,n)},clearSelection:()=>{var n,b;return(b=(n=l.value)==null?void 0:n.clearSelection)==null?void 0:b.call(n)}}),(n,b)=>(R(),M("ag-combobox",{ref_key:"comboboxRef",ref:l,".labelHidden":r.labelHidden,".labelPosition":r.labelPosition,".noLabel":r.noLabel,".disabled":r.disabled,".invalid":r.invalid,".clearable":r.clearable,".readonly":r.readonly,".required":r.required,".validationMessages":r.validationMessages,".loading":r.loading,".multiple":r.multiple,".closeOnSelect":r.closeOnSelect,".options":r.options,".value":r.value,".defaultValue":r.defaultValue,".maxOptionsVisible":r.maxOptionsVisible,placeholder:r.placeholder,label:r.label,ariaLabel:r.ariaLabel,helpText:r.helpText,errorMessage:r.errorMessage,autocomplete:r.autocomplete,filterMode:r.filterMode,size:r.size,variant:r.variant,loadingText:r.loadingText,noResultsText:r.noResultsText,onChange:u,onSelect:m,onSearch:y,onOpen:C,onClose:x,onFocus:w,onBlur:O},[ps(n.$slots,"default")],40,gs))}}),us={class:"stacked mbe4"},ms={class:"text-sm text-secondary"},ys={class:"stacked mbe4"},vs={class:"stacked mbe4"},Cs={class:"stacked mbe4"},xs={class:"text-sm text-secondary"},fs={class:"stacked mbe4"},Bs={class:"stacked mbe4"},Ds={class:"stacked mbe4"},As={class:"stacked mbe4"},Es={class:"stacked mbe4"},Ss={class:"stacked mbe4"},_s={class:"stacked mbe4"},qs={class:"stacked mbe4"},ws={class:"text-sm text-secondary"},Os={class:"stacked mbe4"},Ts={class:"stacked mbe4"},Ls={class:"stacked mbe4"},Vs={class:"stacked mbe4"},Ms={class:"stacked mbe4"},Rs={class:"flex-inline items-center",style:{gap:"10px"}},Is={key:0},zs={class:"mbe4",style:{"max-width":"600px"}},Ns={class:"mbe3"},$s={class:"mbe3"},Ps={class:"mbe3"},Ws={class:"mbe3"},Hs={class:"mbe4",style:{"max-width":"600px"}},Us={class:"mbe3"},js={class:"mbe3"},Ys={class:"mbe3"},Gs={class:"mbe3"},Ks=J({__name:"ComboboxExamples",setup(r){const s=[{value:"al",label:"Alabama"},{value:"ak",label:"Alaska"},{value:"az",label:"Arizona"},{value:"ar",label:"Arkansas"},{value:"ca",label:"California"},{value:"co",label:"Colorado"},{value:"ct",label:"Connecticut"},{value:"de",label:"Delaware"},{value:"fl",label:"Florida"},{value:"ga",label:"Georgia"}],i=[{value:"ca",label:"California"},{value:"co",label:"Colorado",disabled:!0},{value:"ct",label:"Connecticut"},{value:"fl",label:"Florida",disabled:!0},{value:"ny",label:"New York"}],t=g(""),l=g(""),u=g(""),m=g(""),y=g(""),C=g(""),x=g("ca"),w=g("ca"),O=g("co"),n=g(""),b=g(""),S=g(""),z=g(""),T=g([]),D=g(!1),N=g(""),$=g(""),P=g(""),W=g(""),L=g([]),H=g(["ny","co"]),U=g([]),j=g(""),_=g(null),V=g(null),X=f=>{V.value=f.value;const a=f.option?f.option.label:"cleared";_.value=`change (value: ${f.value||"none"}, option: ${a})`},Z=f=>{V.value=f.value,_.value=`select (value: ${f.value}, label: ${f.option.label})`},ss=f=>{const a=V.value?`, selected: ${V.value}`:"";_.value=`search (searchTerm: "${f.searchTerm}"${a})`},is=f=>{console.log("State changed:",f)},as=()=>{D.value=!D.value,D.value?(T.value=[],setTimeout(()=>{T.value=s,D.value=!1},2e3)):T.value=s};return(f,a)=>(R(),M("section",null,[a[22]||(a[22]=e("div",{class:"mbe4"},[e("h2",null,"Basic Combobox")],-1)),e("div",us,[k(c(F),{value:t.value,"onUpdate:value":a[0]||(a[0]=p=>t.value=p),options:s,label:"Select State",placeholder:"Choose a state...",class:"mbe2",onChange:is},null,8,["value"]),e("p",ms,"Selected: "+q(t.value||"None"),1)]),a[23]||(a[23]=e("div",{class:"mbe4"},[e("h2",null,"Sizes")],-1)),e("div",ys,[k(c(F),{value:l.value,"onUpdate:value":a[1]||(a[1]=p=>l.value=p),options:s,label:"Small Combobox",size:"small",placeholder:"Small size",class:"mbe2"},null,8,["value"]),k(c(F),{value:u.value,"onUpdate:value":a[2]||(a[2]=p=>u.value=p),options:s,label:"Default Combobox",size:"default",placeholder:"Default size",class:"mbe2"},null,8,["value"]),k(c(F),{value:m.value,"onUpdate:value":a[3]||(a[3]=p=>m.value=p),options:s,label:"Large Combobox",size:"large",placeholder:"Large size",class:"mbe2"},null,8,["value"])]),a[24]||(a[24]=e("div",{class:"mbe4"},[e("h2",null,"Filter Modes")],-1)),e("div",vs,[k(c(F),{value:y.value,"onUpdate:value":a[4]||(a[4]=p=>y.value=p),options:s,label:"Starts With Filter","filter-mode":"startsWith",placeholder:"Type to filter...","help-text":"Try typing 'Ca' to see California",class:"mbe2"},null,8,["value"]),k(c(F),{value:C.value,"onUpdate:value":a[5]||(a[5]=p=>C.value=p),options:s,label:"Contains Filter","filter-mode":"contains",placeholder:"Type to search...","help-text":"Try typing 'or' to see multiple matches",class:"mbe2"},null,8,["value"])]),a[25]||(a[25]=e("div",{class:"mbe4"},[e("h2",null,"Clearable")],-1)),e("div",Cs,[k(c(F),{value:x.value,"onUpdate:value":a[6]||(a[6]=p=>x.value=p),options:s,label:"Clearable Combobox",clearable:!0,placeholder:"Select and clear...","help-text":"Clear button appears when a value is selected",class:"mbe2"},null,8,["value"]),e("p",xs,"Selected: "+q(x.value||"None"),1)]),a[26]||(a[26]=e("div",{class:"mbe4"},[e("h2",null,"States")],-1)),e("div",fs,[k(c(F),{value:w.value,"onUpdate:value":a[7]||(a[7]=p=>w.value=p),options:s,label:"Disabled Combobox",disabled:!0,placeholder:"This is disabled",class:"mbe2"},null,8,["value"]),k(c(F),{value:O.value,"onUpdate:value":a[8]||(a[8]=p=>O.value=p),options:s,label:"Readonly Combobox",readonly:!0,placeholder:"This is readonly",class:"mbe2"},null,8,["value"]),k(c(F),{value:n.value,"onUpdate:value":a[9]||(a[9]=p=>n.value=p),options:s,label:"Required Combobox",required:!0,placeholder:"This is required","help-text":"This field is required",class:"mbe2"},null,8,["value"]),k(c(F),{value:b.value,"onUpdate:value":a[10]||(a[10]=p=>b.value=p),options:s,label:"Invalid Combobox",invalid:!0,"error-message":"Please select a valid state",placeholder:"This has an error",class:"mbe2"},null,8,["value"])]),a[27]||(a[27]=e("div",{class:"mbe4"},[e("h2",null,"With Help Text")],-1)),e("div",Bs,[k(c(F),{value:S.value,"onUpdate:value":a[11]||(a[11]=p=>S.value=p),options:s,label:"State of Residence",placeholder:"Select your state...","help-text":"Choose the state where you currently reside",class:"mbe2"},null,8,["value"])]),a[28]||(a[28]=e("div",{class:"mbe4"},[e("h2",null,"Loading State")],-1)),e("div",Ds,[k(c(F),{value:z.value,"onUpdate:value":a[12]||(a[12]=p=>z.value=p),options:T.value,label:"Loading Combobox",loading:D.value,"loading-text":"Fetching states...",placeholder:"Loading...",class:"mbe2"},null,8,["value","options","loading"]),e("button",{onClick:as,class:"btn btn-primary"},q(D.value?"Stop Loading":"Start Loading"),1)]),a[29]||(a[29]=e("div",{class:"mbe4"},[e("h2",null,"With Disabled Options")],-1)),e("div",As,[k(c(F),{value:N.value,"onUpdate:value":a[13]||(a[13]=p=>N.value=p),options:i,label:"Select State",placeholder:"Some options are disabled...","help-text":"Colorado and Florida are disabled",class:"mbe2"},null,8,["value"])]),a[30]||(a[30]=e("div",{class:"mbe4"},[e("h2",null,"Custom No Results Text")],-1)),e("div",Es,[k(c(F),{value:$.value,"onUpdate:value":a[14]||(a[14]=p=>$.value=p),options:s,label:"Search States",placeholder:"Type to search...","no-results-text":"No states match your search","help-text":"Try typing 'xyz' to see custom no results message",class:"mbe2"},null,8,["value"])]),a[31]||(a[31]=e("div",{class:"mbe4"},[e("h2",null,"Hidden Label")],-1)),e("div",Ss,[k(c(F),{value:P.value,"onUpdate:value":a[15]||(a[15]=p=>P.value=p),options:s,label:"State (Hidden)","label-hidden":!0,placeholder:"Label is visually hidden but accessible","help-text":"The label is hidden visually but still accessible to screen readers",class:"mbe2"},null,8,["value"])]),a[32]||(a[32]=e("div",{class:"mbe4"},[e("h2",null,"Monochrome Variant (Single Select)")],-1)),e("div",_s,[k(c(F),{value:W.value,"onUpdate:value":a[16]||(a[16]=p=>W.value=p),options:s,label:"Select State",variant:"monochrome",placeholder:"Choose a state...","help-text":"Monochrome variant with inverted colors for selected items",class:"mbe2"},null,8,["value"])]),a[33]||(a[33]=e("div",{class:"mbe4"},[e("h2",null,"Multiple Select")],-1)),e("div",qs,[k(c(F),{value:L.value,"onUpdate:value":a[17]||(a[17]=p=>L.value=p),options:s,label:"Select States",multiple:!0,"close-on-select":!1,placeholder:"Choose one or more states...","help-text":"Select multiple states with checkboxes",class:"mbe2"},null,8,["value"]),e("p",ws,"Selected: "+q(Array.isArray(L.value)?L.value.join(", "):"None"),1)]),a[34]||(a[34]=e("div",{class:"mbe4"},[e("h2",null,"Multiple with Defaults")],-1)),e("div",Os,[k(c(F),{options:s,label:"Pre-selected States",multiple:!0,"close-on-select":!1,"default-value":["ca","fl"],"help-text":"California and Florida are pre-selected",class:"mbe2"})]),a[35]||(a[35]=e("div",{class:"mbe4"},[e("h2",null,"Multiple Clearable")],-1)),e("div",Ts,[k(c(F),{value:H.value,"onUpdate:value":a[18]||(a[18]=p=>H.value=p),options:s,label:"Select States",multiple:!0,clearable:!0,"close-on-select":!1,placeholder:"Select and clear multiple...","help-text":"Clear button removes all selections",class:"mbe2"},null,8,["value"])]),a[36]||(a[36]=e("div",{class:"mbe4"},[e("h2",null,"Multiple with Max Visible Tags")],-1)),e("div",Ls,[k(c(F),{options:s,label:"Select States",multiple:!0,"close-on-select":!1,"default-value":["al","ak","az","ar","ca"],"max-options-visible":2,"help-text":"Shows only 2 tags, with a +3 summary",class:"mbe2"})]),a[37]||(a[37]=e("div",{class:"mbe4"},[e("h2",null,"Multiple Monochrome")],-1)),e("div",Vs,[k(c(F),{value:U.value,"onUpdate:value":a[19]||(a[19]=p=>U.value=p),options:s,label:"Select States",multiple:!0,variant:"monochrome","close-on-select":!1,placeholder:"Choose one or more states...","help-text":"Multiple select with monochrome variant",class:"mbe2"},null,8,["value"])]),a[38]||(a[38]=e("div",{class:"mbe4"},[e("h2",null,"Event Handling")],-1)),e("div",Ms,[e("div",Rs,[k(c(F),{value:j.value,"onUpdate:value":a[20]||(a[20]=p=>j.value=p),options:s,label:"Event Test",placeholder:"Type or select...",onChange:X,onSelect:Z,onSearch:ss,class:"mbe2"},null,8,["value"]),_.value?(R(),M("p",Is,[a[21]||(a[21]=A(" Last event: ",-1)),e("strong",null,q(_.value),1)])):ds("",!0)])]),a[39]||(a[39]=e("div",{class:"mbe4"},[e("h2",null,"External Label Support"),e("p",{class:"mbs2 mbe3"}," The Combobox component supports external labels with helper text, required fields, and validation states. ")],-1)),e("div",zs,[e("div",Ns,[k(c(F),{options:s,label:"Favorite State",name:"favorite",placeholder:"Choose a state..."})]),e("div",$s,[k(c(F),{options:s,label:"Home State","help-text":"Select the state where you currently reside",name:"home",placeholder:"Choose your home state..."})]),e("div",Ps,[k(c(F),{options:s,label:"Required State",required:!0,"help-text":"This field is required",name:"required",placeholder:"Choose a state..."})]),e("div",Ws,[k(c(F),{options:s,label:"State Selection",required:!0,invalid:!0,"error-message":"Please select a valid state to continue",name:"validation",placeholder:"Choose a state..."})])]),a[40]||(a[40]=e("div",{class:"mbe4"},[e("h2",null,"Label Positioning"),e("p",{class:"mbs2 mbe3"},[A(" Control label position with "),e("code",null,"label-position"),A(": 'top' (default), 'start', 'end', or 'bottom'. "),e("strong",null,"Note:"),A(" 'bottom' is not recommended as the dropdown will cover the label when opened. ")])],-1)),e("div",Hs,[e("div",Us,[k(c(F),{options:s,label:"Top Label (Default)","label-position":"top",name:"pos-top",placeholder:"Choose a state..."})]),e("div",js,[k(c(F),{options:s,label:"Start Position","label-position":"start",name:"pos-start",placeholder:"Choose a state..."})]),e("div",Ys,[k(c(F),{options:s,label:"End Position","label-position":"end",name:"pos-end",placeholder:"Choose a state..."})]),e("div",Gs,[k(c(F),{options:s,label:"Bottom Position (Not Recommended)","label-position":"bottom",name:"pos-bottom","help-text":"The dropdown will cover this label when opened",placeholder:"Choose a state..."})])])]))}}),Js=rs(Ks,[["__scopeId","data-v-df8b8c9e"]]);class Qs extends K{createRenderRoot(){return this}constructor(){super(),this.stateOptions=[{value:"al",label:"Alabama"},{value:"ak",label:"Alaska"},{value:"az",label:"Arizona"},{value:"ar",label:"Arkansas"},{value:"ca",label:"California"},{value:"co",label:"Colorado"},{value:"ct",label:"Connecticut"},{value:"de",label:"Delaware"},{value:"fl",label:"Florida"},{value:"ga",label:"Georgia"}],this.optionsWithDisabled=[{value:"ca",label:"California"},{value:"co",label:"Colorado",disabled:!0},{value:"ct",label:"Connecticut"},{value:"fl",label:"Florida",disabled:!0},{value:"ny",label:"New York"}],this.selectedState="",this.isLoading=!1,this.lastEvent=null}firstUpdated(){this.querySelectorAll("ag-combobox").forEach(i=>{const t=i.id;t==="disabled-options"?i.options=this.optionsWithDisabled:i.options=this.stateOptions,i.addEventListener("change",l=>{t==="basic-combobox"&&(this.selectedState=l.detail.value,this.requestUpdate())})})}toggleLoading(){this.isLoading=!this.isLoading;const s=this.querySelector("#loading-combobox");s&&(this.isLoading?(s.options=[],setTimeout(()=>{s.options=this.stateOptions,this.isLoading=!1,this.requestUpdate()},2e3)):s.options=this.stateOptions),this.requestUpdate()}render(){return v`
      <section>
        <!-- Basic Combobox -->
        <div class="mbe4">
    ...
    `}}customElements.define("combobox-lit-examples",Qs);const Xs=`<template>
  <section>
    <div class="mbe4">
      <h2>Basic Combobox</h2>
    </div>
