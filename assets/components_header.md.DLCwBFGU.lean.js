...
`,cs=JSON.parse('{"title":"Header","description":"","frontmatter":{},"headers":[],"relativePath":"components/header.md","filePath":"components/header.md"}'),hs={name:"components/header.md"},ys=Object.assign(hs,{setup(t){return(i,a)=>(p(),r("div",null,[a[1]||(a[1]=s("h1",{id:"header",tabindex:"-1"},[d("Header "),s("a",{class:"header-anchor",href:"#header","aria-label":'Permalink to "Header"'},"​")],-1)),l(E),a[2]||(a[2]=s("p",null,"The Header component provides a semantic, accessible, and responsive page header with support for branding/logo and navigation content. It features sticky positioning, flexible content alignment, and responsive behavior.",-1)),a[3]||(a[3]=s("h2",{id:"examples",tabindex:"-1"},[d("Examples "),s("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),l(H,{component:"header","vue-code":k(ts),"lit-code":k(es),"react-code":k(ls)},{vue:n(()=>[l(ns)]),lit:n(()=>[...a[0]||(a[0]=[s("header-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),a[4]||(a[4]=v("",32))]))}});export{cs as __pageData,ys as default};
