var G=Object.defineProperty;var w=(r,t,n)=>t in r?G(r,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[t]=n;var f=(r,t,n)=>w(r,typeof t!="symbol"?t+"":t,n);import{A as P}from"./chunks/AlphaWarning.CwXaAIH6.js";import{a as A,E as V,x as y,i as O,z as h}from"./chunks/Button.CfALiVhd.js";import{n as T}from"./chunks/state-CovhUvdr.DFO-h9iY.js";import{y as M}from"./chunks/face-mixin.Dz5PWcWd.js";import{d as x,c as B,o as S,r as R,K as z,p as E,j as l,G as i,k as a,w as s,a as o,t as D,_ as I,ae as $}from"./chunks/framework.BZTe5Kj6.js";import{F as H}from"./chunks/FrameworkExample.CMxxQdRI.js";import"./chunks/createLucideIcon.DDiaDq_P.js";import"./chunks/sdk.m.Czxx67nf.js";import"./chunks/Icon.Dp0fxPe8.js";var L=Object.defineProperty,b=(r,t,n,u)=>{for(var p=void 0,c=r.length-1,e;c>=0;c--)(e=r[c])&&(p=e(t,n,p)||p);return p&&L(t,n,p),p};const _=class extends M(A){constructor(){super(),this._handleButtonChange=t=>{t.stopPropagation();const{value:n,checked:u}=t.detail;let p;if(this.type==="radio")p=u?[n]:[];else{const e=[...this._getSelectedValues()];if(u)e.includes(n)||e.push(n);else{const v=e.indexOf(n);v>-1&&e.splice(v,1)}p=e}this._internalSelectedValues=p,this._syncFormValue(),this._syncValidity();const c=new CustomEvent("selection-change",{detail:{value:n,checked:u,selectedValues:p},bubbles:!0,composed:!0});this.dispatchEvent(c),this.onSelectionChange&&this.onSelectionChange(c)},this._handleKeyDown=t=>{const n=this._getButtons().filter(e=>!e.disabled);if(n.length===0)return;const u=n.find(e=>{var v;try{return((v=e.shadowRoot)==null?void 0:v.activeElement)||e===document.activeElement}catch{return e===document.activeElement}}),p=u?n.indexOf(u):-1;let c=null;switch(t.key){case"ArrowDown":case"ArrowRight":t.preventDefault(),c=p===-1?0:(p+1)%n.length;break;case"ArrowUp":case"ArrowLeft":t.preventDefault(),c=p===-1?n.length-1:(p-1+n.length)%n.length;break;case"Home":t.preventDefault(),c=0;break;case"End":t.preventDefault(),c=n.length-1;break}if(c!==null){const e=n[c];e.focus(),this.type==="radio"&&this._handleButtonChange(new CustomEvent("selection-button-change",{detail:{value:e.value,checked:!0}}))}},this.type="radio",this.legend="",this.legendHidden=!1,this.theme="",this.size="md",this.shape="",this.value="",this.values=[],this.disabled=!1,this.required=!1,this._internalSelectedValues=[],this.validationMessages=void 0}_getSelectedValues(){return this.type==="radio"?this.value?[this.value]:this._internalSelectedValues:this.values&&this.values.length>0?this.values:this._internalSelectedValues}_syncFormValue(){const t=this._getSelectedValues();if(this.type==="radio")this._internals.setFormValue(t.length>0?t[0]:null);else if(t.length===0)this._internals.setFormValue(null);else{const n=new FormData;t.forEach(u=>n.append(this.name,u)),this._internals.setFormValue(n)}}_syncValidity(){var n;const t=this._getSelectedValues();this.required&&t.length===0?this._internals.setValidity({valueMissing:!0},((n=this.validationMessages)==null?void 0:n.valueMissing)??"Please select an option."):this._internals.setValidity({})}formResetCallback(){this._internalSelectedValues=[],this._internals.setFormValue(null),this._syncValidity(),this._syncChildButtons()}connectedCallback(){super.connectedCallback(),this.addEventListener("selection-button-change",this._handleButtonChange),this.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("selection-button-change",this._handleButtonChange),this.removeEventListener("keydown",this._handleKeyDown)}updated(t){super.updated(t),(t.has("type")||t.has("name")||t.has("theme")||t.has("size")||t.has("shape")||t.has("disabled")||t.has("value")||t.has("values")||t.has("_internalSelectedValues"))&&this._syncChildButtons(),t.has("value")||t.has("values")||t.has("_internalSelectedValues")?(this._syncFormValue(),this._syncValidity()):t.has("required")&&this._syncValidity()}firstUpdated(){this._syncChildButtons(),this._syncFormValue(),this._syncValidity()}_getButtons(){var n;const t=(n=this.shadowRoot)==null?void 0:n.querySelector("slot");return t?t.assignedElements({flatten:!0}).filter(u=>u.tagName.toLowerCase()==="ag-selection-button"):[]}_syncChildButtons(){const t=this._getButtons(),n=this._getSelectedValues();t.forEach(u=>{u._type=this.type,u._name=this.name,u._theme=this.theme,u._size=this.size,u._shape=this.shape,u.checked=n.includes(u.value),this.disabled&&(u.disabled=!0)})}_handleSlotChange(){this._syncChildButtons()}render(){const t=["selection-button-group__legend",this.legendHidden?"selection-button-group__legend--hidden":""].filter(Boolean).join(" ");return y`
      <fieldset
  ...
  `;let k=_;b([h({type:String,reflect:!0})],k.prototype,"type");b([h({type:String})],k.prototype,"legend");b([h({type:Boolean,attribute:"legend-hidden"})],k.prototype,"legendHidden");b([h({type:String,reflect:!0})],k.prototype,"theme");b([h({type:String,reflect:!0})],k.prototype,"size");b([h({type:String,reflect:!0})],k.prototype,"shape");b([h({type:String})],k.prototype,"value");b([h({type:Array})],k.prototype,"values");b([h({type:Boolean,reflect:!0})],k.prototype,"disabled");b([h({type:Boolean,reflect:!0})],k.prototype,"required");b([h({attribute:!1})],k.prototype,"validationMessages");b([h({attribute:!1})],k.prototype,"onSelectionChange");b([T()],k.prototype,"_internalSelectedValues");customElements.get("ag-selection-button-group")||customElements.define("ag-selection-button-group",k);const N=["type","name","legend","legend-hidden","theme","size","shape","value","values",".disabled",".required",".validationMessages"],g=x({__name:"VueSelectionButtonGroup",props:{type:{default:"radio"},name:{default:""},legend:{default:""},legendHidden:{type:Boolean,default:!1},theme:{default:""},size:{default:"md"},shape:{default:""},value:{default:""},values:{default:()=>[]},disabled:{type:Boolean,default:!1},required:{type:Boolean,default:!1},validationMessages:{}},emits:["selection-change","update:value","update:values"],setup(r,{emit:t}){const n=t,u=p=>{const c=p.detail;n("selection-change",c),c.selectedValues.length<=1&&n("update:value",c.selectedValues[0]||""),n("update:values",c.selectedValues)};return(p,c)=>(S(),B("ag-selection-button-group",z({type:r.type,name:r.name,legend:r.legend,"legend-hidden":r.legendHidden,theme:r.theme,size:r.size,shape:r.shape,value:r.value,values:r.values,".disabled":r.disabled,".required":r.required,".validationMessages":r.validationMessages,onSelectionChange:u},p.$attrs),[R(p.$slots,"default")],48,N))}});var W=Object.defineProperty,F=(r,t,n,u)=>{for(var p=void 0,c=r.length-1,e;c>=0;c--)(e=r[c])&&(p=e(t,n,p)||p);return p&&W(t,n,p),p};const q=class extends A{constructor(){super(),this.value="",this.label="",this.checked=!1,this.disabled=!1,this._type="radio",this._name="",this._theme="",this._size="md",this._shape=""}focus(){var t,n;(n=(t=this.shadowRoot)==null?void 0:t.querySelector(".selection-button"))==null||n.focus()}_handleClick(t){if(t.preventDefault(),this.disabled)return;const n=this._type==="radio"?!0:!this.checked;this.dispatchEvent(new CustomEvent("selection-button-change",{detail:{value:this.value,checked:n},bubbles:!0,composed:!0}))}_handleKeyDown(t){this.disabled||(t.key===" "||t.key==="Enter")&&(t.preventDefault(),this._handleClick(t))}_renderIndicator(){return this._type==="checkbox"?y`
    ...
    `}render(){const t=this._theme||"default",n=this._size||"md",u=this._shape||"default",p=["selection-button",`selection-button--${t}`,`selection-button--${n}`,`selection-button--shape-${u}`,this.checked?"selection-button--checked":"",this.disabled?"selection-button--disabled":""].filter(Boolean).join(" ");return y`
      <label
        class="${p}"
  ...
  `;let m=q;F([h({type:String,reflect:!0})],m.prototype,"value");F([h({type:String})],m.prototype,"label");F([h({type:Boolean,reflect:!0})],m.prototype,"checked");F([h({type:Boolean,reflect:!0})],m.prototype,"disabled");F([h({type:String,attribute:!1})],m.prototype,"_type");F([h({type:String,attribute:!1})],m.prototype,"_name");F([h({type:String,attribute:!1})],m.prototype,"_theme");F([h({type:String,attribute:!1})],m.prototype,"_size");F([h({type:String,attribute:!1})],m.prototype,"_shape");customElements.get("ag-selection-button")||customElements.define("ag-selection-button",m);const j=["value","label",".checked",".disabled"],d=x({__name:"VueSelectionButton",props:{value:{default:""},label:{default:""},checked:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1}},setup(r){return(t,n)=>(S(),B("ag-selection-button",z({value:r.value,label:r.label,".checked":r.checked,".disabled":r.disabled},t.$attrs),[R(t.$slots,"default")],48,j))}}),U={class:"examples-container"},K={class:"example-section"},Y={class:"selection-output"},J={class:"example-section"},Z={class:"selection-output"},Q={class:"example-section"},X={class:"theme-grid"},ee={class:"example-section"},te={class:"size-grid"},ne={class:"example-section"},ie={class:"shape-grid"},ae={class:"example-section"},se={class:"example-section"},le=x({__name:"SelectionButtonGroupExamples",setup(r){const t=E(""),n=E([]),u=c=>{t.value=c.detail.selectedValues[0]||""},p=c=>{n.value=c.detail.selectedValues};return(c,e)=>(S(),B("div",U,[l("section",K,[e[3]||(e[3]=l("h3",null,"Radio Group (Single Selection)",-1)),i(a(g),{type:"radio",name:"payment-method",legend:"Select payment method",shape:"rounded",onSelectionChange:u},{default:s(()=>[i(a(d),{value:"card",label:"Credit Card"},{default:s(()=>[...e[0]||(e[0]=[o(" Credit Card ",-1)])]),_:1}),i(a(d),{value:"paypal",label:"PayPal"},{default:s(()=>[...e[1]||(e[1]=[o(" PayPal ",-1)])]),_:1}),i(a(d),{value:"bank",label:"Bank Transfer"},{default:s(()=>[...e[2]||(e[2]=[o(" Bank Transfer ",-1)])]),_:1})]),_:1}),l("p",Y,"Selected: "+D(t.value),1)]),l("section",J,[e[8]||(e[8]=l("h3",null,"Checkbox Group (Multiple Selection)",-1)),i(a(g),{type:"checkbox",name:"toppings",legend:"Select toppings",shape:"rounded",onSelectionChange:p},{default:s(()=>[i(a(d),{value:"cheese",label:"Extra Cheese"},{default:s(()=>[...e[4]||(e[4]=[o(" Extra Cheese ",-1)])]),_:1}),i(a(d),{value:"pepperoni",label:"Pepperoni"},{default:s(()=>[...e[5]||(e[5]=[o(" Pepperoni ",-1)])]),_:1}),i(a(d),{value:"mushrooms",label:"Mushrooms"},{default:s(()=>[...e[6]||(e[6]=[o(" Mushrooms ",-1)])]),_:1}),i(a(d),{value:"olives",label:"Olives"},{default:s(()=>[...e[7]||(e[7]=[o(" Olives ",-1)])]),_:1})]),_:1}),l("p",Z,"Selected: "+D(n.value.join(", ")||"None"),1)]),l("section",Q,[e[27]||(e[27]=l("h3",null,"Theme Variants",-1)),l("div",X,[l("div",null,[e[11]||(e[11]=l("p",{class:"theme-label"},"Default (Primary)",-1)),i(a(g),{type:"radio",name:"theme-default",legend:"Default theme","legend-hidden":"",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[9]||(e[9]=[o("A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[10]||(e[10]=[o("B",-1)])]),_:1})]),_:1})]),l("div",null,[e[14]||(e[14]=l("p",{class:"theme-label"},"Success",-1)),i(a(g),{type:"radio",name:"theme-success",legend:"Success theme","legend-hidden":"",theme:"success",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[12]||(e[12]=[o("A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[13]||(e[13]=[o("B",-1)])]),_:1})]),_:1})]),l("div",null,[e[17]||(e[17]=l("p",{class:"theme-label"},"Info",-1)),i(a(g),{type:"radio",name:"theme-info",legend:"Info theme","legend-hidden":"",theme:"info",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[15]||(e[15]=[o("A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[16]||(e[16]=[o("B",-1)])]),_:1})]),_:1})]),l("div",null,[e[20]||(e[20]=l("p",{class:"theme-label"},"Warning",-1)),i(a(g),{type:"radio",name:"theme-warning",legend:"Warning theme","legend-hidden":"",theme:"warning",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[18]||(e[18]=[o("A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[19]||(e[19]=[o("B",-1)])]),_:1})]),_:1})]),l("div",null,[e[23]||(e[23]=l("p",{class:"theme-label"},"Error",-1)),i(a(g),{type:"radio",name:"theme-error",legend:"Error theme","legend-hidden":"",theme:"error",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[21]||(e[21]=[o("A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[22]||(e[22]=[o("B",-1)])]),_:1})]),_:1})]),l("div",null,[e[26]||(e[26]=l("p",{class:"theme-label"},"Monochrome",-1)),i(a(g),{type:"radio",name:"theme-monochrome",legend:"Monochrome theme","legend-hidden":"",theme:"monochrome",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[24]||(e[24]=[o("A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[25]||(e[25]=[o("B",-1)])]),_:1})]),_:1})])])]),l("section",ee,[e[37]||(e[37]=l("h3",null,"Size Variants",-1)),l("div",te,[l("div",null,[e[30]||(e[30]=l("p",{class:"size-label"},"Small (sm)",-1)),i(a(g),{type:"radio",name:"size-sm",legend:"Small size","legend-hidden":"",size:"sm",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[28]||(e[28]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[29]||(e[29]=[o("Option B",-1)])]),_:1})]),_:1})]),l("div",null,[e[33]||(e[33]=l("p",{class:"size-label"},"Medium (md) - Default",-1)),i(a(g),{type:"radio",name:"size-md",legend:"Medium size","legend-hidden":"",size:"md",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[31]||(e[31]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[32]||(e[32]=[o("Option B",-1)])]),_:1})]),_:1})]),l("div",null,[e[36]||(e[36]=l("p",{class:"size-label"},"Large (lg)",-1)),i(a(g),{type:"radio",name:"size-lg",legend:"Large size","legend-hidden":"",size:"lg",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[34]||(e[34]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[35]||(e[35]=[o("Option B",-1)])]),_:1})]),_:1})])])]),l("section",ne,[e[47]||(e[47]=l("h3",null,"Shape Variants",-1)),l("div",ie,[l("div",null,[e[40]||(e[40]=l("p",{class:"shape-label"},"Default (rectangular)",-1)),i(a(g),{type:"radio",name:"shape-default",legend:"Default shape","legend-hidden":""},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[38]||(e[38]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[39]||(e[39]=[o("Option B",-1)])]),_:1})]),_:1})]),l("div",null,[e[43]||(e[43]=l("p",{class:"shape-label"},"Rounded",-1)),i(a(g),{type:"radio",name:"shape-rounded",legend:"Rounded shape","legend-hidden":"",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[41]||(e[41]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[42]||(e[42]=[o("Option B",-1)])]),_:1})]),_:1})]),l("div",null,[e[46]||(e[46]=l("p",{class:"shape-label"},"Capsule (pill)",-1)),i(a(g),{type:"radio",name:"shape-capsule",legend:"Capsule shape","legend-hidden":"",shape:"capsule"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[44]||(e[44]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[45]||(e[45]=[o("Option B",-1)])]),_:1})]),_:1})])])]),l("section",ae,[e[51]||(e[51]=l("h3",null,"Disabled State",-1)),i(a(g),{type:"radio",name:"disabled-example",legend:"Disabled group",shape:"rounded",disabled:""},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[48]||(e[48]=[o("Option A",-1)])]),_:1}),i(a(d),{value:"b",label:"Option B"},{default:s(()=>[...e[49]||(e[49]=[o("Option B",-1)])]),_:1}),i(a(d),{value:"c",label:"Option C"},{default:s(()=>[...e[50]||(e[50]=[o("Option C",-1)])]),_:1})]),_:1})]),l("section",se,[e[57]||(e[57]=l("h3",null,"Disabled Individual Button State",-1)),i(a(g),{type:"radio",name:"disabled-button-example",legend:"Disabled individual",shape:"rounded"},{default:s(()=>[i(a(d),{value:"a",label:"Option A"},{default:s(()=>[...e[52]||(e[52]=[o("Option A",-1)])]),_:1}),i(a(d),{disabled:"",value:"b",label:"Option B"},{default:s(()=>[...e[53]||(e[53]=[o("Option B",-1)])]),_:1}),i(a(d),{value:"c",label:"Option C"},{default:s(()=>[...e[54]||(e[54]=[o("Option C",-1)])]),_:1}),i(a(d),{disabled:"",value:"d",label:"Option D"},{default:s(()=>[...e[55]||(e[55]=[o("Option D",-1)])]),_:1}),i(a(d),{value:"e",label:"Option E"},{default:s(()=>[...e[56]||(e[56]=[o("Option E",-1)])]),_:1})]),_:1})])]))}}),oe=I(le,[["__scopeId","data-v-2e5ad41e"]]);class C extends A{constructor(){super(),this.radioSelection="",this.checkboxSelection=[]}_handleRadioChange(t){this.radioSelection=t.detail.selectedValues[0]||""}_handleCheckboxChange(t){this.checkboxSelection=[...t.detail.selectedValues]}render(){return y`
  ...
  `),f(C,"properties",{radioSelection:{type:String},checkboxSelection:{type:Array}});customElements.define("selection-button-group-lit-examples",C);const de=`<template>
  <div class="examples-container">
    <!-- Radio Group -->
    <section class="example-section">
      <h3>Radio Group (Single Selection)</h3>
...
`,re=`import { LitElement, html, css } from 'lit';
...
`,Ce=JSON.parse('{"title":"SelectionButtonGroup","description":"","frontmatter":{},"headers":[],"relativePath":"components/selection-button-group.md","filePath":"components/selection-button-group.md"}'),ce={name:"components/selection-button-group.md"},Ae=Object.assign(ce,{setup(r){return(t,n)=>(S(),B("div",null,[n[1]||(n[1]=l("h1",{id:"selectionbuttongroup",tabindex:"-1"},[o("SelectionButtonGroup "),l("a",{class:"header-anchor",href:"#selectionbuttongroup","aria-label":'Permalink to "SelectionButtonGroup"'},"​")],-1)),i(P),n[2]||(n[2]=l("p",null,"A button-styled selection UI for single (radio) or multiple (checkbox) selection. Ideal for compact option toggles, filter controls, and inline selections.",-1)),n[3]||(n[3]=l("h2",{id:"examples",tabindex:"-1"},[o("Examples "),l("a",{class:"header-anchor",href:"#examples","aria-label":'Permalink to "Examples"'},"​")],-1)),i(H,{component:"selection-button-group","vue-code":a(de),"lit-code":a(re),"react-code":a(pe)},{vue:s(()=>[i(oe)]),lit:s(()=>[...n[0]||(n[0]=[l("selection-button-group-lit-examples",null,null,-1)])]),_:1},8,["vue-code","lit-code","react-code"]),n[4]||(n[4]=$(`<h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>The framework examples below <code>import</code> AgnosticUI as an <code>npm</code> package. Alternatively, you can use the <strong>CLI for complete control, AI/LLM visibility, and full code ownership</strong>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light-high-contrast github-dark-high-contrast vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#702C00;--shiki-dark:#FFB757;">npx</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> ag</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> init</span><span style="--shiki-light:#023B95;--shiki-dark:#91CBFF;"> --framework</span><span style="--shiki-light:#032563;--shiki-dark:#ADDCFF;"> FRAMEWORK</span><span style="--shiki-light:#66707B;--shiki-dark:#BDC4CC;"> # react, vue, lit, svelte, etc.</span></span>
