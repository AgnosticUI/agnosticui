...
class IconComponent {
    ...
    ngOnInit() {
        ...
        svg === null || svg === void 0 ? void 0 : svg.classList.add('icon-svg');
        if (this.size)
            svg === null || svg === void 0 ? void 0 : svg.classList.add(`icon-svg-${this.size}`);
        if (this.type)
            svg === null || svg === void 0 ? void 0 : svg.classList.add(`icon-svg-${this.type}`);
    }
    get iconClasses() {
        return [
            'icon',
...
class MenuItemDirective {
    ...
    get disabled() {
        var _a, _b;
        return (_b = (_a = this.el.nativeElement) === null || _a === void 0 ? void 0 : _a.disabled) !== null && _b !== void 0 ? _b : false;
    }
    onClick() {
...
class MenuComponent {
    ...
    onTriggerClick(event) {
        ...
        this.ngZone.onStable
            .pipe(take(1))
            .subscribe(() => { var _a; return this.focusMenuItem((_a = this.getSelectedMenuItemIndex()) !== null && _a !== void 0 ? _a : 0); });
    }
    handleItemClick() {
    ...
    onTriggerKeyUp(ev) {
        var _a;
        const index = (_a = this.getSelectedMenuItemIndex()) !== null && _a !== void 0 ? _a : 0;
        switch (ev.key) {
            case 'Up':
            case 'ArrowUp':
            ...
            case 'ArrowEnd':
                ...
                break;
            case 'Space':
                this.focusMenuItem(index !== null && index !== void 0 ? index : 0);
                break;
            case 'Escape':
                break;
            default:
    ...
    handleOutsideClicks(e) {
        ...
        if (this.isExpanded && this.closeOnClickOutside === false) {
            const targetIsMenuItem = this.menuItemEls
                ...
                .includes(e.target);
            if (!targetIsMenuItem) {
                this.focusMenuItem((_a = this.getSelectedMenuItemIndex()) !== null && _a !== void 0 ? _a : 0);
            }
            return;
        }
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: MenuComponent, decorators: [{
  ...
  `, encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, providers: [{ provide: AG_MENU, useExisting: MenuComponent }], host: {
        ...
        return [{ type: i0.NgZone }, { type: i0.ElementRef }, { type: Document, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [DOCUMENT]
