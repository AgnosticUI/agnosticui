(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    InputComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({
      minVersion: '12.0.0',
      version: '12.2.8',
      type: InputComponent,
      selector: 'ag-input',
      inputs: {
        ...
        isUnderlinedWithBackground: 'isUnderlinedWithBackground',
        name: 'name',
        label: 'label',
        labelCss: 'labelCss',
        css: 'css',
      ...
      host: { properties: { 'attr.id': 'this.externalId' } },
