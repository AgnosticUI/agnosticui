(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    ProgressComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.8", type: ProgressComponent, selector: "ag-progress", inputs: { value: "value", max: "max", css: "css" }, ngImport: i0__namespace, template: "<progress [ngClass]=\"classes\" [attr.value]=\"value\" [attr.max]=\"max\"></progress>", isInline: true, styles: [".progress{-webkit-appearance:none;height:var(--agnostic-progress-height, 10px);width:100%;border:none;background-color:var(--agnostic-progress-background, #ededed);border-radius:var(--agnostic-progress-radius, 10px)}.progress[value]::-webkit-progress-bar{background-color:var(--agnostic-progress-background, #ededed);border-radius:var(--agnostic-progress-radius, 10px)}.progress[value]::-webkit-progress-value{background-color:var(--agnostic-progress-fill-color, #077acb);border-radius:var(--agnostic-progress-radius, 10px)}.progress[value]::-moz-progress-bar{background-color:var(--agnostic-progress-fill-color, #077acb);border-radius:var(--agnostic-progress-radius, 10px)}.progress[value]::-ms-fill{background-color:var(--agnostic-progress-fill-color, #077acb);border-radius:var(--agnostic-progress-radius, 10px)}\n"], directives: [{ type: i1__namespace.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }], changeDetection: i0__namespace.ChangeDetectionStrategy.OnPush });
