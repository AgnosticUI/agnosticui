...
const avatarSvelte = fs.readFileSync("./src/lib/components/Avatar/Avatar.svelte", "utf8");
const avatarSvelteSynchronized = avatarSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Avatar/Avatar.svelte', avatarSvelteSynchronized, 'utf8');
...
const avatarGroupSvelte= fs.readFileSync("./src/lib/components/Avatar/AvatarGroup.svelte", "utf8");
const avatarGroupSvelteSynchronized = avatarGroupSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Avatar/AvatarGroup.svelte', avatarGroupSvelteSynchronized, 'utf8');

/**
* Breadcrumb
*/
css = fs.readFileSync('../agnostic-css/src/components/breadcrumb/breadcrumb.css', 'utf8');
const breadcrumbSvelte = fs.readFileSync("./src/lib/components/Breadcrumb/Breadcrumb.svelte", "utf8");
const breadcrumbSvelteSynchronized = breadcrumbSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Breadcrumb/Breadcrumb.svelte', breadcrumbSvelteSynchronized, 'utf8');
...
const cardSvelte = fs.readFileSync("./src/lib/components/Card/Card.svelte", "utf8");
const cardSvelteSynchronized = cardSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync("./src/lib/components/Card/Card.svelte", cardSvelteSynchronized, "utf8");
...
const closeSvelte = fs.readFileSync("./src/lib/components/Close/Close.svelte", "utf8");
const closesvelteSynchronized = closeSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Close/Close.svelte', closesvelteSynchronized, 'utf8');
...
const discloseSvelte = fs.readFileSync("./src/lib/components/Disclose/Disclose.svelte", "utf8");
const disclosesvelteSynchronized = discloseSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Disclose/Disclose.svelte', disclosesvelteSynchronized, 'utf8');

/**
* Divider
*/
css = fs.readFileSync('../agnostic-css/src/components/divider/divider.css', 'utf8');
const dividerSvelte = fs.readFileSync("./src/lib/components/Divider/Divider.svelte", "utf8");
const dividerSvelteSynchronized = dividerSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Divider/Divider.svelte', dividerSvelteSynchronized, 'utf8');
...
const emptyStateSvelte = fs.readFileSync("./src/lib/components/EmptyState/EmptyState.svelte", "utf8");
...
const headerSvelte = fs.readFileSync("./src/lib/components/Header/Header.svelte", "utf8");
const headerSynchronized = headerSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync("./src/lib/components/Header/Header.svelte", headerSynchronized, "utf8");
...
const inputSvelte = fs.readFileSync("./src/lib/components/Input/Input.svelte", "utf8");
const inputSynchronized = inputSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync("./src/lib/components/Input/Input.svelte", inputSynchronized, "utf8");
...
const loaderSvelte = fs.readFileSync("./src/lib/components/Loader/Loader.svelte", "utf8");
...
const paginationSvelte = fs.readFileSync("./src/lib/components/Pagination/Pagination.svelte", "utf8");
...
const progressSvelte = fs.readFileSync("./src/lib/components/Progress/Progress.svelte", "utf8");
...
const selectSvelte = fs.readFileSync("./src/lib/components/Select/Select.svelte", "utf8");
const selectSynchronized = selectSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync("./src/lib/components/Select/Select.svelte", selectSynchronized, "utf8");
...
const spinnerSvelte = fs.readFileSync("./src/lib/components/Spinner/Spinner.svelte", "utf8");
const spinnerSynchronized = spinnerSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync("./src/lib/components/Spinner/Spinner.svelte", spinnerSynchronized, "utf8");

/**
 * Switch
 */
 css = fs.readFileSync("../agnostic-css/src/components/switch/switch.css", "utf8");
 const switchSvelte = fs.readFileSync("./src/lib/components/Switch/Switch.svelte", "utf8");
 const switchSynchronized = switchSvelte.replace(
   styleRegex,
   `<style>\n${css}\n</style>`
 );
 fs.writeFileSync("./src/lib/components/Switch/Switch.svelte", switchSynchronized, "utf8");
 
/**
 * Tabs
 */
css = fs.readFileSync("../agnostic-css/src/components/tabs/tabs.css", "utf8");
const tabsSvelte = fs.readFileSync("./src/lib/components/Tabs/Tabs.svelte", "utf8");
const tabsSvelteSynchronized = tabsSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync("./src/lib/components/Tabs/Tabs.svelte", tabsSvelteSynchronized, "utf8");

/**
 * Tables
 */
 css = fs.readFileSync('../agnostic-css/src/components/table/table.css', 'utf8');
 const tableSvelte = fs.readFileSync("./src/lib/components/Table/Table.svelte", "utf8");
 const tableSynchronized = tableSvelte.replace(
  styleRegex,
   `<style>\n${css}\n</style>`
 );
 fs.writeFileSync('./src/lib/components/Table/Table.svelte', tableSynchronized, 'utf8');

 /**
* Tags
*/
css = fs.readFileSync('../agnostic-css/src/components/tag/tag.css', 'utf8');
const tagSvelte = fs.readFileSync("./src/lib/components/Tag/Tag.svelte", "utf8");
const tagSvelteSynchronized = tagSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync('./src/lib/components/Tag/Tag.svelte', tagSvelteSynchronized, 'utf8');
