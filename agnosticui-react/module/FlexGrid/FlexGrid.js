...
var FlexGrid = function FlexGrid(props) {
  var containerClass = getClass('flexgrid-container');
  var classNames = [props.className, containerClass];
  var gridPropsCreated = createProps(propTypes, props, classNames); // We're essentially taking the props passed in and:
  ...
  return /*#__PURE__*/React.createElement(props.tagName || 'div', gridPropsCreated);
};
