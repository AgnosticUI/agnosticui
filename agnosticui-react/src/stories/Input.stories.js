...
export const AllInputs = () => (
  <>
    ...
    <Input uniqueId="myUniqueId5" label="Large input" size="large"
      onChange={action('change')} onFocus={action('focus')} onBlur={action('blur')} />
    <Input uniqueId="myUniqueId6" label="Small input" size="small"
      onChange={action('change')} onFocus={action('focus')} onBlur={action('blur')} />
...
export const ErrorAndHelpText = () => (
  <>
    ...
    <Input uniqueId="myUniqueId2" label="Invalid input" invalidText="This field has errors." isInvalid={true} />
    <Input size="small" uniqueId="myUniqueId3" label="Invalid small input" invalidText="This field has errors." isInvalid={true} />
    <Input size="large" uniqueId="myUniqueId4" label="Invalid large input" invalidText="This field has errors." isInvalid={true} />
  </>
);
