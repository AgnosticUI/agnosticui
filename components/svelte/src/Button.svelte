...
.btn-raised.btn-primary {
  border-color: var(--agnostic-btn-primary-raised-to, var(--agnostic-default-btn-primary-raised-to));
  background: -webkit-gradient(linear, left top, left bottom, from(var(--agnostic-default-btn-primary-raised-from, var(--agnostic-default-btn-primary-raised-from))), to(var(--agnostic-btn-primary-raised-to, var(--agnostic-default-btn-primary-raised-to))));
  background: linear-gradient(var(--agnostic-default-btn-primary-raised-from, var(--agnostic-default-btn-primary-raised-from)), var(--agnostic-btn-primary-raised-to, var(--agnostic-default-btn-primary-raised-to)));
}
/* .btn-raised.btn-primary:hover, .btn-raised.btn-primary:focus {
  background: -webkit-gradient(linear, left top, left bottom, from(#42abf8), to(#0888e6));
  background: linear-gradient(to bottom, #42abf8, #0888e6);
