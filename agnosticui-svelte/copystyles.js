...
const gridSvelte = fs.readFileSync(
  "./src/stories/FlexGrid/FlexGrid.svelte",
  "utf8"
);
const gridSynchronized = gridSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync(
...
const rowSvelte = fs.readFileSync(
  "./src/stories/FlexGrid/FlexRow.svelte",
  "utf8"
);
const rowSynchronized = rowSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync(
...
const colSvelte = fs.readFileSync(
  "./src/stories/FlexGrid/FlexCol.svelte",
  "utf8"
);
const colSynchronized = colSvelte.replace(
  styleRegex,
  `<style>\n${css}\n</style>`
);
fs.writeFileSync(
