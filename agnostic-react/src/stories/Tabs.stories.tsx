...
const customButtons = [
  <TabButtonCustom controlsPanelId="panel1" key={1}>
    {/* Note the text here is a requirement for screenreaders */}
    Tab 1
  </TabButtonCustom>,
  <TabButtonCustom controlsPanelId="panel2" key={2}>
    Tab 2
  </TabButtonCustom>,
  <TabButtonCustom controlsPanelId="panel3" key={3}>
    Tab 3
  </TabButtonCustom>,
];
...
const customExpandedButtons = [
  <TabButtonCustom controlsPanelId="panel1" index={1} key={1} css={styles.reactButton}>
  ...
  <TabButtonCustom controlsPanelId="panel2" index={2} key={2} css={styles.vueButton}>
  ...
  <TabButtonCustom controlsPanelId="panel3" index={3} key={3} css={styles.angularButton}>
  ...
  <TabButtonCustom controlsPanelId="panel4" index={4} key={4} css={styles.svelteButton}>
