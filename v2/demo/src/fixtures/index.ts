...
export const fixtureBank: Record<string, AgNode[][]> = {
  'contact-form': [
    // variation 1 — minimal
    [
      { id: 'cf1-name',         component: 'AgInput',  label: 'Full name',    type: 'text',     placeholder: 'Jane Smith',          required: true },
      { id: 'cf1-email',        component: 'AgInput',  label: 'Email',        type: 'email',    placeholder: 'jane@example.com',    required: true },
      { id: 'cf1-msg',          component: 'AgInput',  label: 'Message',      type: 'text',     placeholder: 'How can we help?',    rows: 4 },
      { id: 'cf1-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   children: ['cf1-submit-label'] },
      { id: 'cf1-submit-label', component: 'AgText',   text: 'Send message' },
    ],
    // variation 2 — with phone + subject
    [
      { id: 'cf2-name',         component: 'AgInput',  label: 'Full name',    type: 'text',     placeholder: 'Jane Smith',          required: true },
      { id: 'cf2-email',        component: 'AgInput',  label: 'Email',        type: 'email',    placeholder: 'jane@example.com',    required: true },
      { id: 'cf2-phone',        component: 'AgInput',  label: 'Phone',        type: 'tel',      placeholder: '+1 555 000 0000' },
      { id: 'cf2-subject',      component: 'AgInput',  label: 'Subject',      type: 'text',     placeholder: 'How can we help?',    required: true },
      { id: 'cf2-msg',          component: 'AgInput',  label: 'Message',      type: 'text',     placeholder: 'Tell us more...',     rows: 5 },
      { id: 'cf2-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   children: ['cf2-submit-label'] },
      { id: 'cf2-submit-label', component: 'AgText',   text: 'Submit' },
    ],
    // variation 3 — with newsletter opt-in
    [
      { id: 'cf3-name',         component: 'AgInput',  label: 'Full name',    type: 'text',     placeholder: 'Jane Smith',          required: true },
      { id: 'cf3-email',        component: 'AgInput',  label: 'Email',        type: 'email',    placeholder: 'jane@example.com',    required: true },
      { id: 'cf3-msg',          component: 'AgInput',  label: 'Message',      type: 'text',     placeholder: 'How can we help?',    rows: 4 },
      { id: 'cf3-newsletter',   component: 'AgToggle', label: 'Send me updates and news' },
      { id: 'cf3-divider',      component: 'AgDivider' },
      { id: 'cf3-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   children: ['cf3-submit-label'] },
      { id: 'cf3-submit-label', component: 'AgText',   text: 'Get in touch' },
    ],
    // variation 4 — with company + priority
    [
      { id: 'cf4-name',         component: 'AgInput',  label: 'Full name',    type: 'text',     placeholder: 'Jane Smith',          required: true },
      { id: 'cf4-company',      component: 'AgInput',  label: 'Company',      type: 'text',     placeholder: 'Acme Corp' },
      { id: 'cf4-email',        component: 'AgInput',  label: 'Work email',   type: 'email',    placeholder: 'jane@acme.com',       required: true },
      { id: 'cf4-msg',          component: 'AgInput',  label: 'Message',      type: 'text',     placeholder: 'Describe your issue', rows: 4 },
      { id: 'cf4-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   children: ['cf4-submit-label'] },
    ...
    [
      ...
      { id: 'cf5-name',         component: 'AgInput',  label: 'Full name',    type: 'text',     placeholder: 'Jane Smith',          required: true },
      { id: 'cf5-email',        component: 'AgInput',  label: 'Email',        type: 'email',    placeholder: 'jane@example.com',    required: true },
      { id: 'cf5-msg',          component: 'AgInput',  label: 'Message',      type: 'text',     placeholder: 'How can we help?',    rows: 4 },
      { id: 'cf5-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   fullWidth: true, children: ['cf5-submit-label'] },
  ...
  'login-form': [
    // variation 1 — minimal
    [
      { id: 'lf1-email',        component: 'AgInput',  label: 'Email',        type: 'email',    placeholder: 'you@example.com',  required: true },
      { id: 'lf1-password',     component: 'AgInput',  label: 'Password',     type: 'password', required: true },
      { id: 'lf1-remember',     component: 'AgToggle', label: 'Remember me' },
      { id: 'lf1-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   children: ['lf1-submit-label'] },
    ...
    [
      ...
      { id: 'lf2-email',        component: 'AgInput',  label: 'Email',        type: 'email',    placeholder: 'you@example.com',  required: true },
      { id: 'lf2-password',     component: 'AgInput',  label: 'Password',     type: 'password', required: true },
      { id: 'lf2-forgot',       component: 'AgLink',   href: '#',             children: ['lf2-forgot-text'] },
      { id: 'lf2-forgot-text',  component: 'AgText',   text: 'Forgot password?' },
      { id: 'lf2-submit',       component: 'AgButton', variant: 'primary',    type: 'submit',   fullWidth: true, children: ['lf2-submit-label'] },
      { id: 'lf2-submit-label', component: 'AgText',   text: 'Sign in' },
    ],
    // variation 3 — with divider and alternate copy
    [
      { id: 'lf3-email',        component: 'AgInput',  label: 'Email address', type: 'email',   placeholder: 'you@example.com',  required: true },
      { id: 'lf3-password',     component: 'AgInput',  label: 'Password',      type: 'password', required: true },
      { id: 'lf3-divider',      component: 'AgDivider' },
      { id: 'lf3-submit',       component: 'AgButton', variant: 'primary',     type: 'submit',  children: ['lf3-submit-label'] },
      { id: 'lf3-submit-label', component: 'AgText',   text: 'Log in to your account' },
    ],
    // variation 4 — with terms checkbox
    [
      { id: 'lf4-email',        component: 'AgInput',    label: 'Email',    type: 'email',    placeholder: 'you@example.com',           required: true },
      { id: 'lf4-password',     component: 'AgInput',    label: 'Password', type: 'password', required: true },
      { id: 'lf4-terms',        component: 'AgCheckbox', name: 'terms',     value: 'agreed',  labelText: 'I agree to the terms of service', required: true },
      { id: 'lf4-submit',       component: 'AgButton',   variant: 'primary', type: 'submit',  children: ['lf4-submit-label'] },
    ...
    [
      ...
      { id: 'lf5-email',        component: 'AgInput',  label: 'Email',      type: 'email',    placeholder: 'you@example.com', required: true },
      { id: 'lf5-password',     component: 'AgInput',  label: 'Password',   type: 'password', required: true },
      { id: 'lf5-remember',     component: 'AgToggle', label: 'Stay signed in' },
      { id: 'lf5-submit',       component: 'AgButton', variant: 'primary',  type: 'submit',   fullWidth: true, children: ['lf5-submit-label'] },
  ...
  'pricing-card': [
    ...
    [
      ...
      { id: 'pc1-cta',         component: 'AgButton',  variant: 'primary',  fullWidth: true, children: ['pc1-cta-label'] },
    ...
    [
      ...
      { id: 'pc2-cta',         component: 'AgButton',  bordered: true,      fullWidth: true, children: ['pc2-cta-label'] },
    ...
    [
      ...
      { id: 'pc3-cta',         component: 'AgButton',  variant: 'primary',  fullWidth: true, children: ['pc3-cta-label'] },
    ...
    [
      ...
      { id: 'pc4-cta',         component: 'AgButton',  variant: 'primary',    fullWidth: true, children: ['pc4-cta-label'] },
    ...
    [
      ...
      { id: 'pc5-cta-primary',    component: 'AgButton', variant: 'primary',  fullWidth: true, children: ['pc5-cta-primary-label'] },
      { id: 'pc5-cta-primary-label', component: 'AgText', text: 'Start team trial' },
      { id: 'pc5-cta-secondary',   component: 'AgButton', bordered: true,      fullWidth: true, children: ['pc5-cta-secondary-label'] },
