...
└── login/                     # Login form playbook
    ...
    ├── design/
    │   ├── Desktop.png           # Design mockup
    │   ├── Tablet.png            # Design mockup
    │   ├── Phone.png             # Design mockup
    │   ├── logo.svg              # Logo for single-framework examples
    │   ├── logo-3-frameworks.svg # Logo for 3-frameworks examples
    │   ├── google-icon.svg       # Social login icon
    │   ├── apple-icon.svg        # Social login icon (single-framework)
    │   ├── facebook-icon.svg     # Social login icon (3-frameworks)
    │   ├── login-bg.jpg          # Background image (single-framework)
    │   └── login-bg-3-frameworks.jpg # Background image (3-frameworks)
    │
