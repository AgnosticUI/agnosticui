...
| [Onboarding](onboarding/) | Alert, Button, Icon, SelectionButtonGroup, SelectionCardGroup, Timeline                                                                                       | New user setup wizard     |
...
| [Data Grid](grid/)        | Button, Checkbox, Dialog, EmptyState, Header, IconButton, Input, IntlFormatter, Menu, Pagination, ProgressRing, Select, Spinner, Tag                          | Complex data manipulation |
| [Form Association](form-association/) | Button, Checkbox, Divider, Input, Radio, Toggle | Contact form demonstrating FACE — native FormData, form.reset(), constraint validation |
| [Blog / Article Reader](blog/) | AspectRatio, Avatar, Badge, Button, Divider, Input, Loader, Mark, ScrollProgress, ScrollToButton, Tabs, Tag | Editorial reading experience |
| [Landing / Marketing Page](landing/) | Accordion, Avatar, Badge, BadgeFx, Button, ButtonFx, Card, Divider, Header, IconButtonFx, Tabs, Tag | Marketing page with animated Lab components |
...
v2/playbooks/
├── README.md                  # This file
├── COVERAGE-ROADMAP.md        # Component coverage tracking
├── CREATING-VARIANTS.md       # Guide for deriving new design variants from existing playbooks
├── login/                     # Login form playbook (V1 + V2 variant)
├── onboarding/                # Onboarding wizard playbook (V1 + V2 variant)
├── dashboard/                 # Discovery dashboard playbook
├── support/                   # Support center playbook
├── grid/                      # Data Grid playbook (V1 + V2 variant)
├── form-association/          # FACE contact form playbook
├── blog/                      # Blog / Article Reader playbook
└── landing/                   # Landing / Marketing Page playbook
```

Each playbook directory follows this structure:
...
├── PROMPT-REACT.md        # Builds React only → react/  (login only)
