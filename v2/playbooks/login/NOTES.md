...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Input label/placeholder font size inconsistent with buttons | `ag-input::part(ag-input-label), ag-input::part(ag-input) { font-size: var(--ag-font-size-sm); }` | Change input default from `--ag-font-size-base` (16px) to `--ag-font-size-sm` (14px) to match button sizing. Update all size variants accordingly: small=xs, medium=sm, large=base |
| Checkbox label font size inconsistent with inputs/buttons   | `ag-checkbox::part(ag-checkbox-label) { font-size: var(--ag-font-size-sm); }`                     | Change checkbox label default to `--ag-font-size-sm` (14px) to match input/button sizing                                                                                           |
