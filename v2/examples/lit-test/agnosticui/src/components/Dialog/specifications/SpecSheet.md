...
- **`noCloseOnEscape`** (boolean, default: false) - Disable escape key closing (false means Escape closes by default)
- **`noCloseOnBackdrop`** (boolean, default: false) - Disable backdrop click closing (false means backdrop clicks close by default)
...
- ✅ Minimalist and themeable styling (functional CSS only)
