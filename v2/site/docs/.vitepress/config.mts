...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'AgnosticUI - Local Components for React, Vue, Svelte & More' }],
    ...
    ['meta', { name: 'twitter:title', content: 'AgnosticUI - Local Components for React, Vue, Svelte & More' }],
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: 'AI Playbooks',
        items: [
          { text: 'Agentic Intent', link: '/agentic-intent' },
          ...
          { text: 'Contact Form (FACE)', link: '/playbooks/form-association' },
        ]
      },
      getComponents(),
      {
