...
<ag-button on:click={() => isOpen = true}>Open Drawer</ag-button>
<ag-drawer bind:open={isOpen} position="top" heading="Top Drawer">
  <p>Drawer content</p>
  <ag-button on:click={() => isOpen = false}>Close</ag-button>
</ag-drawer>`}
        />
...
<ag-button on:click={() => isOpen = true}>Open Drawer</ag-button>
<ag-drawer bind:open={isOpen} position="start" heading="Start Drawer">
  <p>Drawer content</p>
  <ag-button on:click={() => isOpen = false}>Close</ag-button>
</ag-drawer>`}
        />
...
<ag-button on:click={() => isOpen = true}>Open Drawer</ag-button>
<ag-drawer bind:open={isOpen} position="end" heading="End Drawer">
  <p>Drawer content</p>
  <ag-button on:click={() => isOpen = false}>Close</ag-button>
</ag-drawer>`}
        />
