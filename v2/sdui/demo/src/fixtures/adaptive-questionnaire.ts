...
export const step1Nodes: AgNode[] = [
  ...
  { id: 'aq-btn-routine',  component: 'AgSelectionButton', value: 'routine',  label: 'Annual checkup' },
  { id: 'aq-btn-symptoms', component: 'AgSelectionButton', value: 'symptoms', label: 'New symptoms' },
  { id: 'aq-btn-followup', component: 'AgSelectionButton', value: 'followup', label: 'Follow-up visit' },
...
const step2SymptomsNodes: AgNode[] = [
  ...
  { id: 'aq-sev-mild',        component: 'AgSelectionButton', value: 'mild',     label: 'Mild' },
  { id: 'aq-sev-moderate',    component: 'AgSelectionButton', value: 'moderate', label: 'Moderate' },
  { id: 'aq-sev-severe',      component: 'AgSelectionButton', value: 'severe',   label: 'Severe' },
