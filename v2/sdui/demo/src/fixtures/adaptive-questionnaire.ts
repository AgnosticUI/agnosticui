...
const step2FollowupNodes: AgNode[] = [
  ...
  { id: 'aq-followup-reason',  component: 'AgInput',  label: 'Reason for follow-up', type: 'text', rounded: true, required: true, on_change: 'ANSWER_CHANGE' },
  { id: 'aq-last-visit',       component: 'AgInput',  label: 'Date of last visit',   type: 'date', rounded: true, max: (() => { const d = new Date(); return `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, '0')}-${String(d.getDate()).padStart(2, '0')}`; })(), on_change: 'ANSWER_CHANGE' },
