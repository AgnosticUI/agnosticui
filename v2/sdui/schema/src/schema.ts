...
export const AgComboboxSchema = z.object({
  id: z.string(),
  component: z.literal('AgCombobox'),
  ...
  helpText: z.string().optional(),
  errorMessage: z.string().optional(),
  autocomplete: z.enum(['list', 'none']).optional(),
  filterMode: z.enum(['none', 'startsWith', 'contains']).optional(),
  ...
  variant: z.enum(['default', 'monochrome']).optional(),
  multiple: z.boolean().optional(),
  maxOptionsVisible: z.number().optional(),
  loading: z.boolean().optional(),
...
export const AgImageSchema = z.object({
  ...
  fit: z.enum(['none', 'cover', 'contain', 'fill', 'scale-down']).optional(),
