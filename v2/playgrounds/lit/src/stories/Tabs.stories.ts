  ...
  render: () => {
    ...
    return html`
      ...
      >
        ...
        <ag-tab slot="tab" panel="panel-3">Tab 3</ag-tab>
        <ag-tab-panel slot="panel" panel="panel-1"
          >Content for Tab 1. Check Actions tab for tab index.</ag-tab-panel
        >
        <ag-tab-panel slot="panel" panel="panel-2"
          >Content for Tab 2. Check Actions tab for tab index.</ag-tab-panel
        >
        <ag-tab-panel slot="panel" panel="panel-3"
          >Content for Tab 3. Check Actions tab for tab index.</ag-tab-panel
        >
      </ag-tabs>
    `;
  },
