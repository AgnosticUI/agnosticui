...
export const Default: Story = {
  ...
  render: ({ label, icon, unicode, size, variant, type, disabled, pressed, loading, ariaDescribedby, onIconButtonClick, onIconButtonActivate }) => html`
...
export const TypeSubmit: Story = {
  ...
  render: ({ label, unicode, size, variant, type }) => html`
    <form @submit=${(e: Event) => { e.preventDefault(); alert('Form submitted!'); }}>
      <div style="display: flex; justify-content: center; padding: 50px; gap: 1rem;">
...
export const TypeReset: Story = {
  ...
  render: ({ label, unicode, size, variant, type }) => html`
    <form @reset=${() => { console.log('Form reset'); alert('Form reset!'); }}>
      <div style="display: flex; flex-direction: column; align-items: center; padding: 50px; gap: 1rem;">
...
export const AllSizes: Story = {
  render: () => html`
    <div style="display: flex; align-items: center; justify-content: center; gap: 1rem; padding: 50px;">
      <ag-icon-button label="Extra small" unicode="×" size="xs"></ag-icon-button>
      ...
      <ag-icon-button label="Extra large" unicode="×" size="xl"></ag-icon-button>
    </div>
  `,
};
...
export const AllVariants: Story = {
  render: () => html`
    <div style="display: flex; align-items: center; justify-content: center; gap: 1rem; padding: 50px;">
      <ag-icon-button label="Ghost" unicode="○" variant="ghost"></ag-icon-button>
      <ag-icon-button label="Primary" unicode="✓" variant="primary"></ag-icon-button>
      <ag-icon-button label="Secondary" unicode="☰" variant="secondary"></ag-icon-button>
      <ag-icon-button label="Danger" unicode="×" variant="danger"></ag-icon-button>
    </div>
  `,
};
