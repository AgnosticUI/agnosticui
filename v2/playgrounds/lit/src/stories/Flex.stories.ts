...
export const FlexContainer: Story = {
  render: ({ direction, wrap, justify, align, alignContent, inline, reverse, stretchChildren }) => html`
    <ag-flex-container
      direction=${direction}
      wrap=${wrap}
      justify=${justify}
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 2rem;">
      ...
      <div>
        ...
        <ag-flex-row style="--flex-gap: 1rem" justify="center">
          <div style="padding: 1rem; background: #fef3c7; border: 1px solid #f59e0b;">Column 1</div>
          <div style="padding: 1rem; background: #fed7aa; border: 1px solid #ea580c;">Column 2</div>
          <div style="padding: 1rem; background: #fecaca; border: 1px solid #ef4444;">Column 3</div>
        </ag-flex-row>
  ...
  render: () => html`
    <div style="display: flex; gap: 2rem;">
      <div>
        ...
        <ag-flex-col style="--flex-gap: 1rem; min-height: 200px;">
      ...
      <div>
        ...
        <ag-flex-col style="--flex-gap: 1rem; min-height: 200px;" justify="center">
          <div style="padding: 1rem; background: #dcfce7; border: 1px solid #22c55e;">Row 1</div>
          <div style="padding: 1rem; background: #d1fae5; border: 1px solid #10b981;">Row 2</div>
          <div style="padding: 1rem; background: #ccfbf1; border: 1px solid #14b8a6;">Row 3</div>
        </ag-flex-col>
      ...
      <div>
        ...
        <ag-flex-col style="--flex-gap: 1rem; min-height: 200px;" reverse>
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 2rem;">
      <div>
        ...
        <ag-flex-inline style="--flex-gap: 0.5rem; background: #f3f4f6; padding: 0.5rem;">
      ...
      <div>
        ...
        <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
          <ag-flex-inline style="--flex-gap: 0.5rem; background: #e0e7ff; padding: 0.5rem;">
          ...
          <ag-flex-inline style="--flex-gap: 0.5rem; background: #dbeafe; padding: 0.5rem;">
          ...
          <ag-flex-inline style="--flex-gap: 0.5rem; background: #ddd6fe; padding: 0.5rem;">
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 2rem;">
      ...
      <div>
        ...
        <ag-flex-row style="--flex-gap: 0.5rem">
          <div style="padding: 1rem; background: #e0e7ff; border: 1px solid #6366f1;">Item 1</div>
          <div style="padding: 1rem; background: #dbeafe; border: 1px solid #3b82f6;">Item 2</div>
          <div style="padding: 1rem; background: #ddd6fe; border: 1px solid #8b5cf6;">Item 3</div>
        </ag-flex-row>
      ...
      <div>
        ...
        <ag-flex-row style="--flex-gap: 2rem">
          <div style="padding: 1rem; background: #e0e7ff; border: 1px solid #6366f1;">Item 1</div>
          <div style="padding: 1rem; background: #dbeafe; border: 1px solid #3b82f6;">Item 2</div>
          <div style="padding: 1rem; background: #ddd6fe; border: 1px solid #8b5cf6;">Item 3</div>
        </ag-flex-row>
      ...
      <div>
        ...
        <ag-flex-row style="--flex-gap: 2rem 0.5rem; max-width: 500px;" wrap="wrap">
          <div style="padding: 1rem; background: #e0e7ff; border: 1px solid #6366f1;">Item 1</div>
          <div style="padding: 1rem; background: #dbeafe; border: 1px solid #3b82f6;">Item 2</div>
          <div style="padding: 1rem; background: #ddd6fe; border: 1px solid #8b5cf6;">Item 3</div>
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 2rem;">
      <div>
        ...
        <ag-flex-row style="--flex-gap: 1rem; max-width: 400px; background: #f3f4f6; padding: 1rem;">
      ...
      <div>
        ...
        <ag-flex-row style="--flex-gap: 1rem; max-width: 400px; background: #f3f4f6; padding: 1rem;" wrap="wrap">
          <div style="padding: 1rem; background: #e0e7ff; border: 1px solid #6366f1; min-width: 150px;">Item 1</div>
          <div style="padding: 1rem; background: #dbeafe; border: 1px solid #3b82f6; min-width: 150px;">Item 2</div>
          <div style="padding: 1rem; background: #ddd6fe; border: 1px solid #8b5cf6; min-width: 150px;">Item 3</div>
      ...
      <div>
        ...
        <ag-flex-row style="--flex-gap: 1rem; max-width: 400px; background: #f3f4f6; padding: 1rem;" wrap="wrap-reverse">
          <div style="padding: 1rem; background: #e0e7ff; border: 1px solid #6366f1; min-width: 150px;">Item 1</div>
          <div style="padding: 1rem; background: #dbeafe; border: 1px solid #3b82f6; min-width: 150px;">Item 2</div>
          <div style="padding: 1rem; background: #ddd6fe; border: 1px solid #8b5cf6; min-width: 150px;">Item 3</div>
          <div style="padding: 1rem; background: #fef3c7; border: 1px solid #f59e0b; min-width: 150px;">Item 4</div>
...
export const NestedFlexContainers: Story = {
  render: () => html`
    <ag-flex-col style="--flex-gap: 1rem; padding: 1rem; background: #f9fafb;">
      ...
      <ag-flex-row style="--flex-gap: 1rem; flex: 1;">
        <ag-flex-col style="--flex-gap: 0.5rem; flex: 1; background: #dbeafe; padding: 1rem;">
  ...
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 2rem;">
      <div>
        ...
        <ag-flex-col style="--flex-gap: 1rem; max-width: 300px;">
