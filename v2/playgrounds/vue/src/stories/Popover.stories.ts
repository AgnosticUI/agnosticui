...
export const MatchTriggerWidth: Story = {
  render: () => ({
    components: { VuePopover },
    template: `
      <VuePopover :match-trigger-width="true">
...
export const EventHandling: Story = {
  render: () => ({
    ...
    setup() {
      ...
      return { showCount, hideCount, handleShow, handleHide };
    },
    template: `
      <div>
