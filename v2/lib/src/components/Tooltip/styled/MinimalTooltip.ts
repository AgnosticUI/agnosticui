/**
 * AgnosticUI v2 Minimal Tooltip - Self-contained styled component
 *
 * A clean, minimal tooltip with subtle styling and smooth animations.
 * Based on the canonical Tooltip implementation with embedded styling.
 */
...
export class MinimalTooltip extends LitElement {
  static styles = css`
    :host {
...
customElements.define('minimal-tooltip', MinimalTooltip);