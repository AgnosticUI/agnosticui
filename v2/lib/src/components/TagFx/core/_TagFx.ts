...
import { AgTag, type TagProps } from '../../Tag/core/_Tag.js';
import { motionStyles } from '../../../styles/motion.styles.js';
import type { FxProps } from '../../../types/fx.js';

// Combined props interface
export interface TagFxProps extends TagProps, FxProps { }

/**
 * TagFx - Tag with CSS animation effects
 *
 * Extends AgTag to add optional CSS-only animation effects.
 * Inherits all Tag functionality and styling.
 *
 * Features:
 * - CSS-only FX effects
 * - Automatic reduced-motion support
 */
export class TagFx extends AgTag implements TagFxProps {
  ...
  private _updateTheme() {
    ...
    const targetEl = this.shadowRoot?.querySelector('.tag-wrapper');
