import { z as ae, E as me, A as W, B as $, C as ne, U as we, F as le, G as Y, H as ie, b as S, e as Ce, I as oe, J as ke, K as Le, M as Z, s as te, N as Ee, O, Q as se, R as ye, T as Se, V as Ae, W as Ie, X as Me, Y as Te, a as xe, q as De, r as G, Z as n, _ as V, v as y, w as U, x as Ne, y as ze, $ as E, a0 as p, d as F } from "../../../lifecycle-DsPBORQy.js";
...
function Re(i, a, e = !1) {
  ...
  const l = (d, t) => {
    if (f !== (f = d)) {
      var v = le(), c = u;
      if (v && (g = document.createDocumentFragment(), g.append(c = W())), f ? o ??= t && $(() => t(c)) : s ??= t && $(() => t(c)), v) {
        var w = (
          /** @type {Batch} */
          ne
        ), _ = f ? o : s, r = f ? s : o;
...
function Pe(i, a, e, u, o, s = null) {
  ...
  function v() {
    Xe(
      ...
      u,
      e
    ), s !== null && (d.length === 0 ? h ? Y(h) : h = $(() => s(f)) : h !== null && ie(h, () => {
      h = null;
    }));
  }
  ae(() => {
    ...
    if (!(g && c === 0)) {
      ...
      if (le()) {
        ...
        for (const [N, L] of C.items)
          A.has(N) || T.skipped_effects.add(L.e);
        T.add_callback(v);
      } else
        v();
      S(l);
...
function Xe(i, a, e, u, o, s, f, C, k) {
  ...
  for (m = 0; m < h; m += 1) {
    if (w = a[m], _ = C(w, m), r = g.get(_), r === void 0) {
      var A = u.get(_);
      if (A !== void 0) {
        u.delete(_), g.set(_, A);
        var T = t ? t.next : l;
        M(e, t, A), M(e, A, T), Q(A, T, o), t = A;
      } else {
        var B = l ? (
          /** @type {TemplateNode} */
          l.e.nodes_start
...
function ce(i, a, e, u, o, s, f, C, k, h, g) {
  var b = (k & ye) !== 0, l = (k & Se) === 0, d = b ? l ? Z(o, !1, !1) : te(o) : o, t = (k & Ee) === 0 ? f : te(f), v = {
    i: t,
    v: d,
    k: s,
    a: null,
...
function Ke(i, a) {
  ...
  function b(I) {
    F(s, [
      `${(/* @__PURE__ */ new Date()).toLocaleTimeString()}: ${I}`,
      ...S(
        s
  ...
  var H = p(D, 2);
  n(H, "label", "Extra large"), n(H, "unicode", "×"), n(H, "size", "xl");
  var P = p(B, 2), J = p(E(P), 2), R = E(J);
  n(R, "label", "Save"), n(R, "unicode", "💾"), V(() => n(R, "loading", S(o))), V(() => n(R, "disabled", S(o))), n(R, "variant", "primary");
  ...
  var ve = p(j, 2), de = p(E(ve), 2), K = E(de), fe = p(K, 2);
  {
    var _e = (I) => {
      ...
      Pe(q, 5, () => S(s), Ve, (ge, pe) => {
        var ee = Ue(), he = E(ee);
        V(() => He(he, S(pe))), U(ge, ee);
      }), U(I, q);
    };
    Re(fe, (I) => {
      S(s).length === 0 ? I(_e) : I(be, !1);
    });
  }
  V(() => K.disabled = S(s).length === 0), y("icon-button-click", c, f), y("icon-button-click", w, C), y("icon-button-click", _, h), y("icon-button-click", r, g), y("icon-button-click", T, () => b("Settings opened")), y("icon-button-click", L, () => b("XS button clicked")), y("icon-button-click", z, () => b("Small button clicked")), y("icon-button-click", x, () => b("Medium button clicked")), y("icon-button-click", D, () => b("Large button clicked")), y("icon-button-click", H, () => b("XL button clicked")), y("icon-button-click", R, k), y("icon-button-click", X, () => b("This should not fire")), y("click", K, l), U(i, d), Ne();
}
export {
  Ke as default
};
