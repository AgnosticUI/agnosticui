import { AgnosticDialog as r } from "./_dialog.js";
import { j as p } from "../../../index-CaXWYOAP.js";
import { g as t, d as s, b as u, a as h, i as a, v as c } from "../../../vi.bdSIJ99Y-kNDF-H_t.js";
t.extend(p.toHaveNoViolations);
s("AgnosticDialog", () => {
  let e;
  u(() => {
    e = new r(), document.body.appendChild(e);
  }), h(() => {
    ...
    a("should move focus to first focusable element when opened", async () => {
      ...
      const l = document.activeElement, d = e.shadowRoot?.querySelector(".dialog-container");
      t(d?.contains(l) || e.contains(l)).toBe(!0);
    });
    ...
    a("should render default slot content", async () => {
      ...
      const d = e.shadowRoot?.querySelector('slot[name="footer"]');
      t(d).toBeTruthy();
      const i = d.assignedElements();
      ...
      d.textContent = "New content", e.appendChild(d), await e.updateComplete, l = n.assignedElements(), t(l.length).toBe(2), t(l[1].textContent).toBe("New content"), e.removeChild(o), await e.updateComplete, l = n.assignedElements(), t(l.length).toBe(1), t(l[0].textContent).toBe("New content");
    });
  }), s("Close Button", () => {
    ...
    a("should apply base CSS classes", async () => {
      await e.updateComplete;
      const o = e.shadowRoot?.querySelector(".dialog-backdrop"), n = e.shadowRoot?.querySelector(".dialog-container"), l = e.shadowRoot?.querySelector(".dialog-header"), d = e.shadowRoot?.querySelector(".dialog-content"), i = e.shadowRoot?.querySelector(".dialog-footer");
      t(o).toBeTruthy(), t(n).toBeTruthy(), t(l).toBeTruthy(), t(d).toBeTruthy(), t(i).toBeTruthy(), t(o?.classList.contains("dialog-backdrop")).toBe(!0), t(n?.classList.contains("dialog-container")).toBe(!0), t(l?.classList.contains("dialog-header")).toBe(!0), t(d?.classList.contains("dialog-content")).toBe(!0), t(i?.classList.contains("dialog-footer")).toBe(!0);
    ...
    }), a("should handle browser-specific focus quirks", async () => {
