import{a as s,i as l,x as m}from"./lit-element.DMCH56eX.js";const h=e=>Array.from(e.children).filter(o=>"disabled"in o&&"focus"in o&&typeof o.focus=="function"&&!o.disabled),p=(e,o)=>{const d=e,t=h(o);if(t.length===0)return;const{key:n,accordionItem:i}=d.detail,a=t.indexOf(i);if(a===-1)return;let r=a;switch(n){case"ArrowDown":r=(a+1)%t.length;break;case"ArrowUp":r=(a-1+t.length)%t.length;break;case"Home":r=0;break;case"End":r=t.length-1;break;default:return}r!==a&&t[r].focus()},g=e=>{e.addEventListener("accordion-keydown",o=>p(o,e))},f=s`
  :host {
    display: block;
