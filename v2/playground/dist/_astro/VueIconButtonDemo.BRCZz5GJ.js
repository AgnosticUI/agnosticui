 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N=({name:s,iconNode:t,absoluteStrokeWidth:i,"absolute-stroke-width":e,strokeWidth:l,"stroke-width":d,size:v=b.width,color:n=b.stroke,...u},{slots:g})=>B("svg",{...b,...u,width:v,height:v,stroke:n,"stroke-width":C(i)||C(e)||i===!0||e===!0?Number(l||d||b["stroke-width"])*24/Number(v):l||d||b["stroke-width"],class:j("lucide",u.class,...s?[`lucide-${w(U(s))}-icon`,`lucide-${w(s)}`]:["lucide-icon"])},[...t.map(y=>B(...y)),...g.default?[g.default()]:[]]);/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
