import{d as p,t as b}from"./_Accordion.BcZ0uma0.js";import{a as y,x as f}from"./lit-element.CG82Vx-p.js";import{X as g}from"./lit-html-Bm_EwbrZ.BUqNPNwy.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const l=Symbol.for(""),$=e=>{if(e?.r===l)return e?._$litStatic$},v=e=>({_$litStatic$:e,r:l}),h=new Map,z=e=>(t,...n)=>{const o=n.length;let c,s;const a=[],d=[];let r,i=0,m=!1;for(;i<o;){for(r=t[i];i<o&&(s=n[i],(c=$(s))!==void 0);)r+=c+t[++i],m=!0;i!==o&&d.push(s),a.push(r),i++}if(i===o&&a.push(t[o]),m){const u=a.join("$$lit$$");(t=h.get(u))===void 0&&(a.raw=a,h.set(u,t=a)),n=d}return e(t,...n)},M=z(g);class D extends p{static properties={...p.properties,animationDuration:{type:Number,attribute:"animation-duration"},animationType:{type:String,attribute:"animation-type"},respectReducedMotion:{type:Boolean,attribute:"respect-reduced-motion"}};_animatedId=b("animated-accordion-item");constructor(){super(),this.animationDuration=300,this.animationType="slide",this.respectReducedMotion=!0}static get styles(){return[...super.styles,y`
        .content {
          overflow: hidden;
