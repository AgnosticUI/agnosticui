...
export var Input = function (_a) {
    ...
    var renderInput = function () { return (_jsx("input", __assign({ id: uniqueId, name: uniqueId, defaultValue: defaultValue, type: type, disabled: isDisabled, className: inputClassesJoined, placeholder: placeholder, onChange: onChange, onFocus: onFocus, onBlur: onBlur }, rest), void 0)); };
